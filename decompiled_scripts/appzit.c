...
void func_6()
{
	if (SYSTEM::TIMERA() > 2200)
	{
		if (Global_21054)
		{
			func_7(Global_21047, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201", 0, 0, 0, 0);
		}
		else
		{
	...
	if (Global_21044 == 0)
	{
		if (func_5(2, Global_21035, 0))
		{
			if ((iLocal_58 && iLocal_60 == 0) && iLocal_59 == 0)
			{
				...
				if (Global_21054)
				{
					func_7(Global_21047, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201", 0, 0, 0, 0);
					func_7(Global_21047, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213", 0, 0, 0, 0);
				}
				else
				{
