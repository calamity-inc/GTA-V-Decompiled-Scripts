...
void func_64(var uParam0, bool bParam1)
{
	...
	Global_1027415.f_33[iVar3 /*88*/].f_56 = { func_107(sVar2) };
	if (DATAFILE::DATADICT_GET_TYPE(sVar2, "cam") == 5)
	{
		Global_1027415.f_33[iVar3 /*88*/].f_59 = { func_106(sVar2, "cam") };
	}
	else if (DATAFILE::DATADICT_GET_TYPE(sVar2, "cam") == 6)
	{
		...
		{
			Global_1027415.f_33[iVar3 /*88*/].f_59 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(sVar95, "x"));
		}
		else
		{
			Global_1027415.f_33[iVar3 /*88*/].f_59 = DATAFILE::DATADICT_GET_FLOAT(sVar95, "x");
		}
		if (DATAFILE::DATADICT_GET_TYPE(sVar95, "y") == 2)
		{
			Global_1027415.f_33[iVar3 /*88*/].f_59.f_1 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(sVar95, "y"));
		}
		else
		{
			Global_1027415.f_33[iVar3 /*88*/].f_59.f_1 = DATAFILE::DATADICT_GET_FLOAT(sVar95, "y");
		}
		if (DATAFILE::DATADICT_GET_TYPE(sVar95, "z") == 2)
		{
			Global_1027415.f_33[iVar3 /*88*/].f_59.f_2 = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(sVar95, "z"));
		}
		else
		{
			Global_1027415.f_33[iVar3 /*88*/].f_59.f_2 = DATAFILE::DATADICT_GET_FLOAT(sVar95, "z");
		}
	}
	Global_1027415.f_33[iVar3 /*88*/].f_62 = { func_105(sVar2) };
	Global_1027415.f_33[iVar3 /*88*/].f_69 = DATAFILE::DATADICT_GET_INT(sVar2, "min");
	Global_1027415.f_33[iVar3 /*88*/].f_71 = DATAFILE::DATADICT_GET_INT(sVar2, "num");
	...
	Global_1027415.f_33[iVar3 /*88*/].f_68 = DATAFILE::DATADICT_GET_INT(sVar2, "subtype");
	Global_1027415.f_33[iVar3 /*88*/].f_80 = DATAFILE::DATADICT_GET_INT(sVar2, "adverm");
	Global_1027415.f_33[iVar3 /*88*/].f_70 = DATAFILE::DATADICT_GET_INT(sVar2, "rank");
	...
	Global_1027415.f_33[iVar3 /*88*/].f_75 = DATAFILE::DATADICT_GET_INT(sVar2, "charcon");
	Global_1027415.f_33[iVar3 /*88*/].f_72 = DATAFILE::DATADICT_GET_INT(sVar2, "tnum");
	...
	Global_1027415.f_33[iVar3 /*88*/].f_76 = DATAFILE::DATADICT_GET_INT(sVar2, "optbs");
...
void func_123(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_128(struct<16> Param0)
{
	int iVar0;
...
int func_131(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
...
void func_181(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	if (iParam4 || bParam1)
	{
...
void func_200(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10)
{
	int iVar0;
...
var func_209(var uParam0, int iParam1)
{
	var uVar0;
...
int func_215(var uParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	struct<88> Var0;
	char* sVar88;
	char* sVar89;
...
int func_218(struct<3> Param0, int iParam3, float fParam4)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
...
void func_219(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4)
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
	...
	uParam0->f_1804[iVar3 /*88*/].f_56 = { func_107(sVar2) };
	uParam0->f_1804[iVar3 /*88*/].f_59 = { func_106(sVar2, "cam") };
	uParam0->f_1804[iVar3 /*88*/].f_62 = { func_105(sVar2) };
...
void func_231(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_235(var uParam0, bool bParam1)
{
	...
	if ((DATAFILE::DATADICT_GET_INT(sVar2, "type") == 0 && DATAFILE::DATADICT_GET_INT(sVar2, "subtype") == 7) && uParam0->f_9 < 1800)
	{
		if (DATAFILE::DATAFILE_GET_FILE_DICT(0) != 0)
		{
			DATAFILE::DATAFILE_DELETE(0);
	...
	{
		Global_794709.f_159989[uParam0->f_9 /*13*/].f_8 = DATAFILE::DATADICT_GET_INT(sVar2, "mgrk");
	}
	if (DATAFILE::DATADICT_GET_TYPE(sVar2, "mght") == 2)
	{
		Global_794709.f_159989[uParam0->f_9 /*13*/].f_9 = DATAFILE::DATADICT_GET_INT(sVar2, "mght");
	}
	Global_794709.f_159989[uParam0->f_9 /*13*/].f_11 = DATAFILE::DATADICT_GET_INT(sVar2, "cncmbs");
	...
	Global_794709.f_159989[uParam0->f_9 /*13*/] = DATAFILE::DATADICT_GET_INT(sVar2, "tnum");
	if (!func_312())
	{
	...
	if (Global_794709.f_4[uParam0->f_9 /*88*/].f_65 == 6 && !bParam1)
	{
		if (Global_1030213.f_684 < 85)
		{
			...
			Global_1030213[Global_1030213.f_684 /*3*/] = { func_106(sVar2, "area") };
			if (DATAFILE::DATADICT_GET_TYPE(sVar2, "rad") == 2)
			{
				Global_1030213.f_512[Global_1030213.f_684] = SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(sVar2, "rad"));
			}
			else
			{
				Global_1030213.f_512[Global_1030213.f_684] = DATAFILE::DATADICT_GET_FLOAT(sVar2, "rad");
			}
...
int func_238(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4)
{
	int iVar0;
...
int func_270(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var* uParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	switch (iParam0)
	{
		case 0:
...
void func_276(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	struct<88> Var1;
...
void func_277(var uParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	struct<88> Var1;
...
void func_278(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	struct<88> Var1;
...
int func_292(struct<2> Param0, var uParam2, struct<3> Param3, float fParam6)
{
	if (!func_65(Param3))
	{
...
bool func_298(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
