			...
			if (fVar32 < (10f * 10f))
			{
				...
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_143, false))
					{
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_143, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 0.25f, 0, 40000f);
						}
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_144, false))
					{
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_144, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 0.25f, 0, 40000f);
						}
