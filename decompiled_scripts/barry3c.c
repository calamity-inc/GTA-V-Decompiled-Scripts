...
int func_81(int iParam0, int iParam1, int iParam2)
{
	...
	Global_78472[1 /*14*/] = { func_134(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_78472[1 /*14*/] = { func_134(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1 /*14*/] = { func_134(iVar10, iParam1, iParam2, -1) };
		if (!func_124(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78472[1 /*14*/] = { func_134(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78472[1 /*14*/] = { func_134(iVar10, 14, uVar28[iVar1], -1) };
			...
			{
				Global_78472[1 /*14*/] = { func_134(iVar10, iVar0, func_90(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78472[1 /*14*/] = { func_134(iVar10, 14, uVar69[iVar1], -1) };
			func_100(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_116(14);
			if (Global_78470 == 1)
			{
...
{
	Global_78472[1 /*14*/] = { func_134(iParam0, iParam1, iParam2, -1) };
...
void func_136(int iParam0)
{
	...
	func_137(&(Global_78472[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_143(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_137(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78670)
		{
			...
			func_137(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_198(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_198(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_198(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_78472[2 /*14*/] = { func_134(iVar0, 14, iVar4, -1) };
					...
					else
					{
						...
						Global_78472[2 /*14*/] = { func_134(iVar0, iVar2, iVar1, -1) };
	...
	else if (Global_78472[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_126(iParam1)) && Global_78472[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_126(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_205(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_206(&sVar32, Var0.f_3, Global_100870, bParam1, bParam2);
	}
}
...
void func_254(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_330(&(Global_100833.f_3));
				if (iVar10 > -1)
				{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104373.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104373.f_4, false))
		{
			if (func_378(24) != Global_104373.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_375(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_351(Global_104373.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_464()
{
	...
	iLocal_140 = func_477();
	iLocal_183[0] = PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, false, true, true, true);
	iLocal_183[1] = PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, false, true, true, true);
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_467(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_467(iParam0) };
