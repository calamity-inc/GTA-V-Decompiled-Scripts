...
void func_62(var uParam0, var uParam1)
{
	...
	if (uParam0->f_281.f_5 == 7)
	{
		...
		else if ((((((((((((((((((((((func_34(&(uParam0->f_281), 13) || !Global_1574965) || (!BitTest(Global_1969892, 23) && !func_91())) || Global_2766478) || Global_2766481) || BitTest(Global_1962996, 13)) || BitTest(Global_1969892, 14)) || BitTest(Global_1962996, 9)) || BitTest(Global_2764620, 0)) || BitTest(Global_1969892, 6)) || BitTest(Global_1969892, 7)) || BitTest(Global_1969892, 8)) || BitTest(Global_1969892, 9)) || BitTest(Global_1969892, 2)) || BitTest(Global_1969892, 3)) || BitTest(Global_1969892, 4)) || BitTest(Global_1969892, 5)) || func_22(PLAYER::PLAYER_ID())) || func_50()) || PAD::IS_DISABLED_CONTROL_PRESSED(2, 19)) || !CAM::IS_SCREEN_FADED_IN()) || func_88(PLAYER::PLAYER_ID())) || Global_2764641 != 0)
		{
			func_25(uParam0, 1);
			...
			if ((((((((!HUD::IS_PAUSE_MENU_ACTIVE() && !Global_1935176) && !func_34(&(uParam0->f_281), 0)) && !func_34(&(uParam0->f_281), 4)) && !func_82()) && !func_80(1)) && uParam0->f_281.f_9.f_2 != 3) && !HUD::IS_WARNING_MESSAGE_ACTIVE()) && !func_79())
			{
				...
				if (uParam0->f_281.f_5 == 7)
				{
					...
					else
					{
						...
						{
							if (MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_26645, false, false, true, -1, 0) || BitTest(Global_2764620, 3))
							{
								func_25(uParam0, 1);
								Global_2766481 = 1;
								Global_2766478 = 1;
