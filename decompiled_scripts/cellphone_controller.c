...
void func_24()
{
	...
	switch (Global_20813.f_1)
	{
		case 6:
			...
			if (Global_20801)
			{
				func_32(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
				func_32(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_21026 == 1)
				{
					if (Global_20801)
					{
						func_32(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
					}
					else
					{
				...
				{
					func_32(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
				}
				else
				{
		...
		case 10:
			...
			{
				func_32(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202", 0, 0, 0, 0);
				if (Global_20756)
				{
		...
		case 9:
			if (Global_20812 == 1)
			{
				...
				{
					func_32(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_7998 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_32(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2139[Global_7998 /*29*/].f_3), &(Global_2139[Global_7998 /*29*/].f_7), "CELL_217", &(Global_2139[Global_7998 /*29*/].f_3), 0);
				}
				func_35(Global_20794, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_22166 == 4 || Global_22166 == 3)
			{
				...
				else
				{
					...
					if (func_27(Global_7998, Global_20813) == 0)
					{
						...
						func_32(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_7998 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_35(Global_20794, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_25()
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20794))
	{
		...
		if (Global_20812 == 1)
		{
			if (Global_20801)
			{
				func_32(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203", 0, 0, 0, 0);
			}
			else
			{
			...
			{
				func_32(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204", 0, 0, 0, 0);
			}
			else
			{
				func_32(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
...
void func_81(int iParam0, char* sParam1)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
int func_99(int iParam0)
{
	...
	if (SYSTEM::VDIST2(Var0, 1081.951f, -1976.762f, 30.47218f) < 6f && func_107(26))
	{
		return 9;
	}
	if (!iLocal_25)
...
void func_100(var uParam0)
{
	...
	Global_113327 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-76.6618f, 6222.191f, 32.2412f, "V_factory1");
	Global_113326 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-98.2637f, 6210.022f, 31.924f, "V_factory2");
	Global_113328 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-115.8956f, 6179.749f, 32.4102f, "V_factory3");
	Global_113329 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-149.8199f, 6144.978f, 31.3353f, "V_factory4");
	Global_113330 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(16.3605f, -1100.259f, 28.797f, "v_gun");
	Global_113331 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(125.1948f, -1284.13f, 28.2847f, "v_strip3");
	Global_113337 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-545.5717f, 1987.145f, 126.0262f, "cs6_08_mine_int");
	Global_113338 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(2330.598f, 2571.935f, 45.6802f, "ch3_01_trlr_int");
...
var func_130(int iParam0, var uParam1)
{
	return unk_0xD69CE161FE614531(0, iParam0, func_131(uParam1));
}
...
void func_133()
{
	if (Global_79248 == 0)
	{
		...
		if (Global_2695946)
		{
			if (func_34(14))
			{
				func_134(2, "CELL_2", 2, "appInternet", 6, 1, 1, 0, 0);
				func_134(14, "CELL_29", 7, "appMPJobListNEW", 12, 1, 1, 0, 0);
			}
			else
			{
				func_134(14, "CELL_29", 2, "appMPJobListNEW", 12, 1, 1, 0, 0);
			}
		}
		else
		{
			func_134(4, "CELL_23", 2, "appChecklist", 39, 1, 1, 0, 0);
		}
	}
}

void func_134(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
...
void func_135()
{
	...
	if (Global_79248 == 0)
	{
		...
		func_134(7, "CELL_5", 0, "appEmail", 4, 1, 1, 0, 0);
		func_134(1, "CELL_1", 1, "appTextMessage", 2, 1, 1, 0, 0);
		func_134(4, "CELL_23", 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_43922 == 15 && func_123(0) == 0) && Global_8688 == 0)
		{
			func_134(20, "CELL_32", 3, "appSettings", 43, 1, 1, 0, 0);
			Global_21028 = 0;
			Global_8689 = 255;
		}
		else
		...
		if (iVar1 == 1)
		{
			func_134(0, "CELL_0", 4, "appContacts", 27, 1, 1, 0, 0);
		}
		else
		{
			func_134(0, "CELL_0", 4, "appContacts", 5, 1, 1, 0, 0);
		}
		func_134(10, "CELL_16", 5, "appSettings", 24, 1, 1, 0, 0);
		func_134(3, "CELL_7", 6, "appCamera", 1, 1, 1, 0, 0);
		func_134(2, "CELL_2", 7, "appInternet", 6, 1, 1, 0, 0);
		if (Global_114370.f_14054.f_89 == 1)
		{
			func_134(17, "CELL_28", 8, "appTrackify", 42, 1, 1, 0, 0);
		}
		if (Global_114370.f_14054.f_88 == 1)
		{
			func_134(16, "CELL_25", 0, "appContacts", 40, 2, 1, 0, 0);
		}
		func_134(25, "CELL_14", -99, "appContacts", 17, 2, 1, 0, 0);
		func_134(9, "CELL_13", -99, "appContacts", 13, 2, 1, 0, 0);
		func_134(11, "CELL_14", -99, "appContacts", 8, 2, 1, 0, 0);
		func_134(27, "CELL_15", -99, "appContacts", 17, 2, 1, 0, 0);
		func_134(28, "CELL_15", -99, "appContacts", 17, 2, 1, 0, 0);
		func_134(29, "CELL_15", -99, "appSettings", 17, 2, 1, 0, 0);
		func_134(30, "CELL_15", -99, "appContacts", 17, 2, 1, 0, 0);
		func_134(31, "CELL_15", -99, "appContacts", 17, 2, 1, 0, 0);
		func_134(32, "CELL_15", -99, "appSettings", 17, 2, 1, 0, 0);
	}
	else
	{
		func_134(7, "CELL_5", 0, "appMPEmail", 4, 1, 1, 0, 0);
		func_134(10, "CELL_16", 5, "appSettings", 24, 1, 1, 0, 0);
		func_134(1, "CELL_1", 1, "appTextMessage", 2, 1, 1, 0, 0);
		func_134(3, "CELL_7", 6, "appCamera", 1, 1, 1, 0, 0);
		func_134(2, "CELL_2", 7, "appInternet", 6, 1, 1, 0, 0);
		func_134(14, "CELL_29", 4, "appMPJobListNEW", 12, 1, 1, 0, 0);
		func_134(0, "CELL_0", 2, "appContacts", 5, 1, 1, 0, 0);
		func_134(21, "CELL_37", 3, "AppJIPMP", 14, 1, 1, 0, 0);
		if (BitTest(Global_4542983, 4) == 1)
		{
			func_134(17, "CELL_28", 8, "appTrackify", 42, 1, 1, 0, 0);
		}
		func_134(13, "CELL_35", -99, "appMPCopBackup", 39, 1, 1, 0, 0);
		func_134(13, "CELL_20", -99, "appMPCopBackup", 16, 1, 1, 0, 0);
		func_134(15, "CELL_18", -99, "appContacts", 8, 1, 1, 0, 0);
		func_134(9, "CELL_13", -99, "appContacts", 13, 2, 1, 0, 0);
		func_134(5, "CELL_4", -99, "appContacts", 12, 2, 1, 0, 0);
		func_134(23, "CELL_15", 0, "appContacts", 17, 2, 1, 0, 0);
		func_134(24, "CELL_15", 1, "appContacts", 17, 2, 1, 0, 0);
		func_134(25, "CELL_15", 2, "appContacts", 17, 2, 1, 0, 0);
		func_134(26, "CELL_15", 3, "appContacts", 17, 2, 1, 0, 0);
		func_134(27, "CELL_15", 4, "appContacts", 17, 2, 1, 0, 0);
		func_134(28, "CELL_15", 5, "appContacts", 17, 2, 1, 0, 0);
		func_134(29, "CELL_15", 6, "appContacts", 17, 2, 1, 0, 0);
		func_134(30, "CELL_15", 7, "appContacts", 17, 2, 1, 0, 0);
		func_134(31, "CELL_15", 8, "appContacts", 17, 2, 1, 0, 0);
		func_134(32, "CELL_15", 9, "appContacts", 17, 2, 1, 0, 0);
		func_134(33, "CELL_15", 10, "appContacts", 17, 2, 1, 0, 0);
		if (!BitTest(Global_4542983, 4) == 1)
		{
			if (Global_1836171)
			{
				func_134(23, "CELL_CIRCBREAK", 8, "AppVLSI", 54, 1, 1, 0, 0);
			}
			else if (BitTest(Global_4542983, 20) == 1)
			{
				func_134(23, "CELL_SIGHTS", 8, "AppSettings", 59, 1, 1, 0, 0);
			}
			else if (BitTest(Global_4542983, 22) == 1)
			{
				func_134(23, "CELL_EXTRACT", 8, "AppExtraction", 58, 1, 1, 0, 0);
			}
			else if (BitTest(Global_4542983, 26) == 1)
			{
				if (func_136())
				{
					func_134(23, "CELL_0", -99, "appContacts", 5, 1, 1, 0, 0);
				}
				else
				{
					func_134(23, "CELL_SECHACK", 8, "AppSecuroHack", 57, 1, 1, 0, 0);
				}
			}
		}
		if ((((BitTest(Global_4542983, 4) == 0 && Global_1836171 == 0) && BitTest(Global_4542983, 20) == 0) && BitTest(Global_4542983, 22) == 0) && BitTest(Global_4542983, 26) == 0)
		{
			...
			{
				func_134(23, "CELL_BOSSAGE", 8, "appMPBossAgency", 57, 1, 1, 0, 0);
			}
		}
	}
}
