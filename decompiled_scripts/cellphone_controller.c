...
void func_1()
{
	iLocal_70 = GRAPHICS::GET_LOAD_HIGH_QUALITY_PHOTO_STATUS(Global_22644);
	switch (iLocal_70)
	{
		case 0:
			Global_22640 = 4;
...
int func_16()
{
	...
	if ((func_22(2, Global_20233, 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19)) && !MISC::IS_STUNT_JUMP_IN_PROGRESS())
	{
		...
		if (HUD::THEFEED_GET_LAST_SHOWN_PHONE_ACTIVATABLE_FEED_ID() == Global_22662 && HUD::THEFEED_GET_LAST_SHOWN_PHONE_ACTIVATABLE_FEED_ID() != -1)
		{
			...
			iLocal_76 = 0;
			iLocal_77 = 0;
			while (((func_20(2, Global_20233) && iLocal_76 < 250) && Global_20472 == 0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19))
			{
				if (Global_8840 > 0)
				{
					func_17();
		...
		case 4:
			...
			else
			{
				...
				else
				{
					...
					if (((Global_113386.f_14051[Global_20266 /*20*/].f_18 == 1 || Global_113386.f_14051[Global_20266 /*20*/].f_17 == 1) || bLocal_82 == 1) || Global_22664 != 0)
					{
						while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20247) && Global_20249 == 0)
						{
							SYSTEM::WAIT(0);
...
void func_53()
{
	...
	if (((((((Global_4539964[Global_4541213 /*104*/].f_32 == 4 || Global_4539964[Global_4541213 /*104*/].f_32 == 5) || Global_4539964[Global_4541213 /*104*/].f_32 == 6) || Global_4539964[Global_4541213 /*104*/].f_32 == 7) || Global_4539964[Global_4541213 /*104*/].f_32 == 8) || Global_4539964[Global_4541213 /*104*/].f_32 == 9) || Global_4539964[Global_4541213 /*104*/].f_32 == 10) || Global_4539964[Global_4541213 /*104*/].f_32 == 11)
	{
		...
		while (iVar16 < Global_4539964[Global_4541213 /*104*/].f_49)
		{
			switch (Global_4539964[Global_4541213 /*104*/].f_32)
			{
				case 4:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_2815059.f_1725[iVar16 /*4*/]));
					break;
				
				case 5:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931438[iVar16 /*4*/]));
					break;
				
				case 6:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931479[iVar16 /*4*/]));
					break;
				
				case 7:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931500[iVar16 /*4*/]));
					break;
				
				case 8:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931517[iVar16 /*4*/]));
					break;
				
				case 9:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931530[iVar16 /*4*/]));
					break;
				
				case 10:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931543[iVar16 /*4*/]));
					break;
				
				case 11:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931556[iVar16 /*4*/]));
					break;
			}
			iVar16++;
		}
	...
	else
	{
		...
		{
			StringCopy(&cVar49, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_1998[Global_4539964[Global_4541213 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	Global_4539964[Global_4541213 /*104*/].f_16 = iLocal_64;
}
...
void func_55()
{
	if (BitTest(Global_8136, 1))
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_53[Global_20266] = NETWORK::GET_NETWORK_TIME();
			iLocal_43[Global_20266] = 1;
		}
		else if (!BitTest(Global_8136, 10))
		{
			iLocal_48[Global_20266] = MISC::GET_GAME_TIMER();
			iLocal_43[Global_20266] = 1;
		}
		else
		{
...
void func_58()
{
	...
	{
		iVar16 = 0;
		iVar17 = func_59(9, Global_113386.f_14141[Global_22672 /*104*/].f_49);
		switch (iVar17)
		{
			case 1:
				HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("CELL_CL01");
		...
		while (iVar16 < iVar17)
		{
			switch (Global_113386.f_14141[Global_22672 /*104*/].f_32)
			{
				...
				case 12:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1931569[iVar16 /*4*/]));
					break;
			}
			iVar16++;
		}
		StringCopy(&cVar18, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_1998[Global_113386.f_14141[Global_22672 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	else
	{
		...
		if (Global_113386.f_14141[Global_22672 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar34, &Global_8824, 64);
		...
		{
			StringCopy(&cVar50, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_1998[Global_113386.f_14141[Global_22672 /*104*/].f_17 /*29*/].f_3)), 64);
	...
	Global_113386.f_14141[Global_22672 /*104*/].f_16 = iLocal_64;
}
...
void func_61()
{
	if (iLocal_43[Global_20266] == 1)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_63 = NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_53[Global_20266]);
		}
		else
		{
			iLocal_58[Global_20266] = MISC::GET_GAME_TIMER();
			iLocal_63 = (iLocal_58[Global_20266] - iLocal_48[Global_20266]);
		}
		if (iLocal_63 > 300000)
		{
...
void func_68(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	if (!func_69())
	{
		return;
...
int func_99(int iParam0)
{
	...
	else if ((iVar3 == Global_112349 || iVar3 == Global_112350) || iVar3 == Global_112351)
	{
		return 9;
	}
	else if (iVar3 == Global_112340)
	{
		return 9;
	}
	else if (iVar3 == Global_112341)
	{
		return 9;
	}
	else if (iVar3 == Global_112344)
	{
		return 9;
	}
	else if (iVar3 == Global_112343)
	{
		return 9;
	}
	else if (iVar3 == Global_112345)
	{
		return 9;
	}
	else if (iVar3 == Global_112346)
	{
		return 9;
	}
	else if (iVar3 == Global_112347)
	{
		return 9;
	}
	else if (iVar3 == Global_112348)
	{
		return 9;
	}
	else if (iVar3 == Global_112352)
	{
		return 9;
	}
	else if (iVar3 == Global_112353)
	{
		return 9;
	}
	else if (iVar3 == Global_112354)
	{
		return 9;
	}
	else if (iVar3 == Global_112355)
	{
		return 9;
	}
	else if (iVar3 == Global_112356)
	{
		return 9;
	}
	else if ((iVar3 == Global_112357 || iVar3 == Global_112358) && func_107(67))
	{
		return 9;
	}
	iVar4 = 0;
