		...
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_112))
		{
			if (iLocal_949 != 0)
			{
				...
				if (iLocal_58)
				{
					Local_814 = { func_79() };
					func_77(&uLocal_113);
					func_76(0, 75, "TXM_EXIT", &uLocal_113, 0, 363);
					if (iLocal_91 > 1)
					{
						func_76(2, 218, "TXM_CDES", &uLocal_113, 0, 363);
					}
					if (!bLocal_60)
					{
						if (iLocal_91 > 0)
						{
							func_76(2, 176, "TXM_SLCT", &uLocal_113, 0, 363);
						}
					}
					else if (iLocal_949 == 2)
					{
						func_76(2, 177, "TXM_STOP", &uLocal_113, 0, 363);
						if (bLocal_59)
						{
							func_76(2, 176, "TXM_SLCT", &uLocal_113, 0, 363);
						}
						if (func_75())
						{
							func_76(2, 176, "TXM_SKIP", &uLocal_113, 0, 363);
						}
						if (!bLocal_64)
						{
							func_76(2, 179, "TXM_HURY", &uLocal_113, 0, 363);
						}
					}
					else if (iLocal_949 == 3)
					{
						func_76(2, 177, "TXM_STRT", &uLocal_113, 0, 363);
						if (bLocal_59)
						{
							func_76(2, 176, "TXM_SLCT", &uLocal_113, 0, 363);
						}
	...
	switch (iLocal_824)
	{
		case 92:
			...
			if (fVar3 < 100f)
			{
				...
				PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var0, &Global_112848, &Global_112854, 1, 3f, 0);
				ENTITY::SET_ENTITY_COORDS(Global_112841, Global_112848, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(Global_112841, Global_112854);
			}
			break;
