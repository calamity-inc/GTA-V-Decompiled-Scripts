...
var func_127(int iParam0, var uParam1)
{
	return unk_0xD69CE161FE614531(0, iParam0, func_128(uParam1));
}
...
int func_211(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_216(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
bool func_223(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
void func_239()
{
	...
	switch (iLocal_69)
	{
		...
		case 4:
			...
			iLocal_251 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f), Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), false, true, true, true);
...
void func_241(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
...
int func_251(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
...
int func_257(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_264()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_256) && STREAMING::HAS_MODEL_LOADED(iLocal_258)) && STREAMING::HAS_MODEL_LOADED(iLocal_257)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_259)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_260)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_263)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_264)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_262)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		iLocal_251 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f), Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), false, true, true, true);
		iLocal_51 = 1;
	}
}
...
int func_266(float fParam0, bool bParam1)
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_267(int iParam0, var uParam1)
{
	switch (iParam0)
	{
		...
		case 5:
			func_268(uParam1, "Barry3A", func_270(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_269(iParam0), 0, 1);
			break;
		...
		case 8:
			func_268(uParam1, "Dreyfuss1", func_270(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_269(iParam0), 0, 0);
			break;
		...
		case 38:
			func_268(uParam1, "Nigel1A", func_270(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_269(iParam0), 1, 1);
			break;
		...
		case 49:
			func_268(uParam1, "Paparazzo3A", func_270(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_269(iParam0), 0, 1);
			break;
		...
		case 58:
			func_268(uParam1, "Tonya1", func_270(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_269(iParam0), 0, 1);
			break;
...
int func_282(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_283(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
void func_287(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	func_288(func_298(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_288(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<16> func_332(var uParam0)
{
	struct<16> Var0;
	int iVar16;
...
void func_334(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
