	...
	switch (Local_78.f_1.f_2)
	{
		...
		case 2:
			...
			else
			{
				...
				{
					if (func_4(&(Local_78.f_1.f_15), Global_262145.f_11283, 0))
					{
						func_61(3);
					}
				}
		...
		if (func_39(Local_78.f_1.f_3[1 /*2*/].f_1) && func_39(iVar0))
		{
			if (!func_12(Local_78.f_1))
			{
				if (func_36(&(Local_78.f_1), Local_78.f_1.f_1, Local_78.f_1.f_8, 0f, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0))
				{
					...
					ENTITY::SET_ENTITY_HEALTH(iVar1, Global_262145.f_11284, 0, 0);
...
void func_101(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_86();
