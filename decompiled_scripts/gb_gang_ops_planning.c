...
void func_153(int iParam0)
{
	...
	if (iParam0 && Global_262145.f_29738)
	{
		...
		{
			MISC::CLEAR_BIT(&(Global_2684799.f_1.f_2809), false);
		}
	}
}
...
void func_634(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	bVar1 = (iParam0 % 32);
	MISC::SET_BIT(&(Global_2793044.f_5225.f_23[iVar0]), bVar1);
}
...
void func_635(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	bVar1 = (iParam0 % 32);
	MISC::CLEAR_BIT(&(Global_2793044.f_5225.f_23[iVar0]), bVar1);
}
		...
		if (func_678(PLAYER::PLAYER_ID()))
		{
			if (!BitTest(Global_1890444[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*129*/].f_38.f_26, 14))
			{
				if (!BitTest(Global_2793044.f_1835, 1))
				{
					...
					MISC::SET_BIT(&(Global_2793044.f_1835), true);
				}
			}
		}
	}
...
void func_740()
{
	...
	{
		MISC::CLEAR_BIT(&(Global_2793044.f_1836), false);
	}
	if (BitTest(Global_2793044.f_1836, 1))
	{
		MISC::CLEAR_BIT(&(Global_2793044.f_1836), true);
	}
