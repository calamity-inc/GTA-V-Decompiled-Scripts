...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_506)
		{
			...
			StringIntConCat(&cVar44, Global_113331[iLocal_251], 64);
			...
			StringIntConCat(&cVar44, iLocal_255[Global_113331[iLocal_251]], 64);
		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (!func_63())
				{
					...
					if (iLocal_297 < iLocal_255[Global_113331[iLocal_251]] && iVar39)
					{
						func_64();
						iLocal_250 = 7;
					}
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_53(Global_113331[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_113331[iLocal_251]);
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_505)
					{
						Global_113331[iLocal_251] = uLocal_504;
					}
					else
					{
						Global_113331[iLocal_251]++;
					}
					if (!Global_113331[iLocal_251] < iLocal_252)
					{
						Global_113331[iLocal_251] = 0;
					}
					func_102(0, 1);
					iLocal_250 = 0;
				}
...
int func_8()
{
	if (Global_113331[iLocal_251] == 3 && (iLocal_297 >= 4 && iLocal_297 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_55()
{
	...
	func_58(Global_113331[iLocal_251] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_240, false, false);
	func_56(Global_113331[iLocal_251]);
}
...
int func_59()
{
	...
	Var0 = { Local_308 };
	StringIntConCat(&Var0, Global_113331[iLocal_251] + 1, 16);
	func_50(&uLocal_37, 3, iLocal_240, &Local_236, 0, 1);
	if (bLocal_437)
	{
		iVar4 = 1;
...
void func_67(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_113331[iLocal_251] + 1, 16);
}
