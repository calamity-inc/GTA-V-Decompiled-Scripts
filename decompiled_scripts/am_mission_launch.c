					...
					if (func_9(Local_90.f_12[0]))
					{
						if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_90.f_12[0]))
						{
							if (func_8(&(Local_90.f_9[0]), Local_90.f_12[0], 26, iVar0, -1, 1, 1, 1))
							{
								...
								ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(NETWORK::NET_TO_PED(Local_90.f_9[0]), true, 0f);
								ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(Local_90.f_9[0]), SYSTEM::ROUND((200f * Global_262145.f_156)), 0, 0);
								Local_90.f_16 = 1;
							}
						}
					}
	...
	if (BitTest(Local_90.f_0, 1))
	{
		...
		if (bLocal_237 < 5)
		{
			...
			if (iLocal_114 == 32)
			{
				if (BitTest(uLocal_229, 1))
				{
					MISC::SET_BIT(&(Local_90.f_4), bLocal_237);
				}
			}
		}
		else
...
void func_42()
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_113 >= 32)
		{
			iLocal_113 = 0;
			iLocal_236 = 0;
			MISC::CLEAR_BIT(&uLocal_229, false);
	...
	if (NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(Local_90.f_9[0]))
	{
		if (!func_41(Local_90.f_9[0]))
		{
			...
			if (HUD::DOES_BLIP_EXIST(Local_241.f_0))
			{
				...
				{
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_241.f_0, "FM_GDM_BLP");
			...
			if (HUD::DOES_BLIP_EXIST(Local_241.f_1))
			{
				...
				{
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_241.f_1, "FM_GDM_BLP");
		...
		if (!BitTest(Local_130[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], 1))
		{
			...
			{
				MISC::SET_BIT(&(Local_130[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]), true);
...
int func_93(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_363(PLAYER::PLAYER_ID()) || (func_136() && func_135())) && !BitTest(Global_2738935.f_4712, 31)) && !bParam4)
	{
		iVar1 = func_134();
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
...
int func_172(int iParam0, int iParam1)
{
	if (NETWORK::NETWORK_CLAN_SERVICE_IS_VALID())
	{
		Global_2707308 = { func_158(iParam0) };
		Global_2707321 = { func_158(iParam1) };
...
void func_218(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_368(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15)
{
...
int func_371(char* sParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iParam1) || iParam3)
	{
		if (func_20(iParam1))
		{
			...
			{
				Global_2707308 = { func_158(iParam1) };
	...
	if (func_393(PLAYER::PLAYER_ID(), 0, 1))
	{
		if (!BitTest(Local_130[iVar0 /*3*/], 0))
		{
			if (Local_130[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 0)
			{
				if (func_366() == 0)
				{
					MISC::SET_BIT(&(Local_130[iVar0 /*3*/]), false);
				}
			}
		}
		else if (BitTest(Local_130[iVar0 /*3*/], 0))
		{
			...
			{
				func_43(&uLocal_230);
				MISC::CLEAR_BIT(&(Local_130[iVar0 /*3*/]), false);
			}
...
void func_383(int iParam0, int* iParam1, float fParam2, bool bParam3, bool bParam4, bool bParam5, char* sParam6, int iParam7, int iParam8, bool bParam9, int iParam10, int iParam11)
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
		if (func_385(0))
...
int func_384(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, var uParam11, var uParam12)
{
	bool bVar0;
...
void func_391()
{
	...
	func_362(11, 0);
	func_207(12, 116);
	MISC::CLEAR_BIT(&(Global_2672855.f_3604), false);
	MISC::CLEAR_BIT(&(Global_2672855.f_3604), true);
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_403(struct<21> Param0)
{
	...
	MISC::SET_BIT(&(Global_2672855.f_3604), false);
	MISC::CLEAR_BIT(&(Global_2672855.f_3604), true);
}
