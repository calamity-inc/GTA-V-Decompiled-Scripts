...
void func_11()
{
	...
	if (Global_1845118 == PLAYER::PLAYER_ID() && !BitTest(Global_1882632[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*146*/].f_43.f_27, 5))
	{
		...
		if (func_18(&Local_45, 0, 0))
		{
			...
			if ((((((iLocal_482 == 0 && !BitTest(Global_1882632[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*146*/].f_43.f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_45);
			}
		}
