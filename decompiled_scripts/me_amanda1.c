...
void func_533(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_537(struct<3> Param0, float fParam3)
{
	return func_538(&(Global_107514.f_2890), Param0, fParam3, 0);
}

int func_538(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_540(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_541(iParam0, uVar1[iVar6], 1) && func_470(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
float func_566(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
