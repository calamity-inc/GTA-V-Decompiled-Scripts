...
int func_119(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
void func_160(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_170(struct<3> Param0, float fParam3)
{
	return func_171(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_171(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_173(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_175(iParam0, uVar1[iVar6], 1) && func_174(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_209(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
...
int func_210(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_217(struct<16> Param0, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22)
{
	if (func_4(iLocal_176))
	{
...
int func_219(struct<15> Param0, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22)
{
	if (func_4(iLocal_176))
	{
...
void func_220(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam8, bool bParam9, float fParam10)
{
	if (func_4(*iParam0))
	{
		switch (*iParam2)
...
int func_240(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)
{
...
void func_273(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_285(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
...
int func_291(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_292(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
...
struct<10> func_309(int iParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_301(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_301(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_301(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_301(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_323(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_325(iParam0, iParam1, &iVar2, &bVar1, bParam2, bParam3))
	{
...
bool func_325(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
int func_326(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_328(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_392();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_331(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
...
bool func_332(int iParam0, int iParam1, var uParam2)
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_335(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
{
	MISC::SET_BIT(&Global_96536, bParam0);
}
...
void func_398(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_412(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_168(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_422(int iParam0, bool bParam1)
{
	...
	{
		iVar0 = SYSTEM::FLOOR((SYSTEM::TO_FLOAT(iVar0) * Global_262145.f_12029));
		if (iVar0 > SYSTEM::FLOOR((4f * Global_262145.f_12029)))
		{
...
bool func_432(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
int func_438(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_472(int iParam0, struct<3> Param1, float fParam4)
{
	if (func_435(iParam0))
	{
...
void func_475()
{
	Local_96 = { func_476(1616809629, -440.0352f, -2172.502f, 9.39933f, -440.1235f, -2166.841f, 12.3181f, -440.1479f, -2166.364f, 9.3181f, -439.9046f, -2174.041f, 12.39933f, -442.2598f, -2169.643f, 9.31843f, -438.0615f, -2173.349f, 13.31699f) };
	Local_119 = { func_476(-1380475172, -445.3699f, -2172.47f, 9.39933f, -445.3286f, -2166.688f, 12.31802f, -445.492f, -2166.232f, 9.31686f, -445.2189f, -2174.173f, 12.39933f, -447.3654f, -2169.836f, 9.30682f, -443.38f, -2173.165f, 12.31856f) };
}

struct<23> func_476(int iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, struct<3> Param13, struct<3> Param16)
{
	struct<23> Var0;
...
void func_477()
{
	switch (func_41())
	{
		...
		case 82:
			Local_178 = { func_478(307.123f, -1084.801f, 28.3597f, 299.7018f, joaat("gauntlet"), 0) };
			Local_157 = { -442.189f, -2183.603f, 9.31981f };
			break;
	}
	iLocal_189[0] = 0;
...
struct<7> func_478(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	struct<7> Var0;
...
void func_480(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	bool bVar0;
	int iVar1;
