...
Vector3 func_135(struct<3> Param0)
{
...
Vector3 func_140(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_258()
{
	if (Global_114372.f_24989.f_1 == 0)
	{
		...
		{
			MISC::CLEAR_BIT(&(Global_114372.f_24989), false);
			MISC::CLEAR_BIT(&(Global_114372.f_24989), true);
