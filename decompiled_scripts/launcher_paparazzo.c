...
int func_207(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
void func_208(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_209(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_210(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_251(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_255(&(uParam0->f_28[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_255(&(uParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
...
void func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_217(iParam0);
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_256(iParam0);
