...
int func_246(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				func_250(&(uParam0->f_28[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_250(&(uParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_251(iParam0);
