...
int func_199(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
void func_204(int iParam0, var uParam1, char* sParam2)
{
...
int func_264(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_265(&(uParam0->f_35[0]), iVar0[1], -1584.013f, 5158.539f, 18.6057f, 210.5309f);
