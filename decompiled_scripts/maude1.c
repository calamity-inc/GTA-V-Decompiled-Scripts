...
int func_58(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_110(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_110(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_110(iVar10, 14, uVar69[iVar1], -1) };
			func_77(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_93(14);
			if (Global_78128 == 1)
			{
...
void func_94(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_98(iParam0, iParam1, &iVar2, &bVar1, bParam2, bParam3))
	{
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_112(int iParam0)
{
	...
	func_113(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_113(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_113(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_180(char* sParam0, var uParam1)
{
...
void func_186(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_187(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_188(&sVar32, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_188(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
...
int func_228(char* sParam0, int iParam1)
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
bool func_241(char* sParam0, int iParam1, char* sParam2)
{
...
int func_242(struct<3> Param0, struct<3> Param3, int iParam6, float fParam7)
{
...
void func_279()
{
	...
	{
		func_329(Var0, Var3, fVar9, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_328(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_325(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_281(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_281(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_315(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_312(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_325(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
bool func_335(struct<3> Param0, int iParam3)
{
	return func_336(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_336(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_338(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
int func_350(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_364()
{
	if (Global_94618)
	{
		func_378(&iLocal_328, 2662.644f, 4284.535f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	else
	{
		...
		{
			func_378(&iLocal_328, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		}
...
int func_367(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_368(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_370(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_4(iParam0);
...
void func_378(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
...
int func_422(var uParam0, int iParam1, int iParam2)
{
	if (!func_423() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_426(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
{
	return func_431(&(Global_106934.f_2890), Param0, fParam3, 0);
}
...
void func_478(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
