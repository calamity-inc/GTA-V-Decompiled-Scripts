...
int func_273(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (!func_275(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
void func_281(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_315(char* sParam0, var uParam1)
{
...
void func_318(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_320(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
