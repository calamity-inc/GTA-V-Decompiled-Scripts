...
void __EntryFunction__()
{
	...
	Local_336 = { 262.9207f, -1002.98f, -100.0086f };
	Local_339 = { 261.0173f, -1002.98f, -98.0086f };
	...
	Local_342 = { 261.8297f, -1002.928f, -99.0062f };
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		case 0:
			...
			else if (func_54(8))
			{
				if ((((func_50(Local_342, Var0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS(Local_342)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_336, Local_339, 2f, false, true, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID()))
				{
					if (iLocal_331 == -1)
					{
						func_45(&iLocal_331, 3, "SA_BED_IN", 0, 0, 0, 0);
					}
					iLocal_325 = 1;
				}
			}
