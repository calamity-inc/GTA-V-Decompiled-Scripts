...
void __EntryFunction__()
{
	...
	if (func_453())
	{
		...
		{
			case 0:
				func_451(Local_145, Local_145.f_3, 1, 0);
				func_449(1);
				break;
			
			case 1:
				func_451(Local_161, 298.7f, 1, 0);
				func_448(1);
				break;
	...
	{
		func_426(&(Local_186[0 /*29*/]), &(Local_81.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_28[0]))
	{
		func_425(&(Local_186[0 /*29*/].f_1), &(Local_81.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_28[1]))
	{
		func_425(&(Local_186[0 /*29*/].f_2), &(Local_81.f_28[1]));
	}
	func_423();
	while (true)
	{
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_GRTP", 0);
		func_407(Local_81.f_9, 0, 0, 1, 0, 0);
		func_402();
		if (iLocal_142 == 9)
		{
			func_395();
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_83(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_83(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_83(iVar10, 14, uVar69[iVar1], -1) };
			func_50(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_66(14);
			if (Global_78128 == 1)
			{
...
void func_85(int iParam0)
{
	...
	func_86(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_86(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_86(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_161(&sVar32, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}
...
bool func_210(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
int func_216(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
bool func_221(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
int func_243(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_251(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
...
void func_261(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_331(&(Global_100441.f_3));
				if (iVar10 > -1)
				{
...
void func_281(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_365(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_362(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_339(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_339(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_358(iParam5, &Var0, Param1, fParam4, func_270(iParam0));
		func_340(iParam5, iParam0, 0);
	}
}
...
void func_358(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_357(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
	...
	switch (Local_186[iParam0 /*29*/].f_24)
	{
		...
		case 1:
			if (func_210(PLAYER::PLAYER_PED_ID(), Local_186[iParam0 /*29*/].f_3, 275f, 1))
			{
				...
				else if ((func_388(Local_186[iParam0 /*29*/]) || func_375(Local_186[iParam0 /*29*/].f_1)) || func_375(Local_186[iParam0 /*29*/].f_2))
				{
					func_373(iParam0, 0);
				}
				else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			...
			{
				if ((func_375(Local_186[iParam0 /*29*/].f_1) || func_375(Local_186[iParam0 /*29*/].f_2)) || func_388(Local_186[iParam0 /*29*/]))
				{
					func_373(iParam0, 0);
				}
			}
		...
		case 2:
			...
			else if ((func_375(Local_186[iParam0 /*29*/].f_1) || func_375(Local_186[iParam0 /*29*/].f_2)) || func_388(Local_186[iParam0 /*29*/]))
			{
				func_373(iParam0, 0);
			}
			break;
		...
		case 3:
			if (!func_210(PLAYER::PLAYER_PED_ID(), Local_186[iParam0 /*29*/].f_3, 275f, 1))
			{
				if (!Local_186[iParam0 /*29*/].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
				{
					func_371(&(Local_186[iParam0 /*29*/].f_1), 1, 0, 1);
					Local_186[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_2))
				{
...
Vector3 func_384(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
void func_396(bool bParam0)
{
	if (bParam0)
	{
		...
		while (iLocal_250 <= 1)
		{
			func_372(&(Local_186[iLocal_250 /*29*/].f_1));
			func_372(&(Local_186[iLocal_250 /*29*/].f_2));
			iLocal_250++;
		}
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
	...
	{
		func_397(&iLocal_155, 0);
		func_374(&(Local_145.f_4));
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_371(&(Local_186[iLocal_250 /*29*/].f_1), 1, 0, 1);
			func_371(&(Local_186[iLocal_250 /*29*/].f_2), 1, 0, 1);
			func_374(&(Local_186[iLocal_250 /*29*/]));
			iLocal_250++;
		}
	}
	if (iLocal_245)
...
void func_403(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)
{
	int iVar0;
	int iVar1;
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_409(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_432(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_438(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_445(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		func_446(PLAYER::PLAYER_PED_ID(), Local_145.f_4, -1, 0);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_145.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_145.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_145.f_4, true);
...
void func_449(bool bParam0)
{
	...
	if (bParam0)
	{
		...
		{
			func_445(Local_145, Local_145.f_3, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_445(Local_145, Local_145.f_3, 1);
	}
	iLocal_439 = 1;
	iLocal_442 = 1;
}
...
void func_463()
{
	Local_167[0 /*3*/] = { func_464("B3ADELV", 1) };
	Local_167[1 /*3*/] = { func_464("B3AGETIN", 1) };
	Local_167[2 /*3*/] = { func_464("B3AWAN1", -1) };
	Local_167[3 /*3*/] = { func_464("B3ARTV", 1) };
	Local_167[4 /*3*/] = { func_464("B3AEXIT", 1) };
	Local_167[5 /*3*/] = { func_464("B3ALEAVE", 1) };
}
