...
void __EntryFunction__()
{
	...
	if (func_456())
	{
		...
		switch (iVar0)
		{
			...
			case 2:
				func_454(-1243.316f, -1041.637f, 7.5121f, 28.2f, 1, 0);
				func_443(1);
				break;
...
void func_341(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	struct<3> Var0;
	var uVar3;
...
void func_342(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_361(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_360(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_365(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
int func_366(struct<3> Param0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_380(int iParam0, float fParam1)
{
...
Vector3 func_387(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
void func_406(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)
{
	int iVar0;
	int iVar1;
...
void func_410(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_412(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
...
int func_421(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_435(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_441(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_448(struct<3> Param0, float fParam3, bool bParam4)
{
...
Vector3 func_467(char* sParam0, int iParam1)
{
	struct<3> Var0;
