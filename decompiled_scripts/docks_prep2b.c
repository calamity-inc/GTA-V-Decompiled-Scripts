			...
			while (iLocal_176 <= 12)
			{
				if (iLocal_275[iLocal_176] == 0)
				{
					if (!PED::IS_PED_INJURED(iLocal_33[iLocal_176]))
					{
						...
						func_114(iLocal_33[iLocal_176], 595);
						func_113(iLocal_33[iLocal_176], 0);
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, false))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, false))
			{
				...
				if (iLocal_28 == 4)
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_62))
					{
						iLocal_62 = func_138(Local_314, 0);
					}
					if (iLocal_199 == 0)
					{
				...
				if (iLocal_28 == 3)
				{
					...
					{
						uLocal_63[0] = func_135(iLocal_31[0], 1, 0);
					}
				}
			}
			else if (iLocal_28 != 5)
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_61))
				{
					iLocal_61 = func_132(iLocal_48, 0, 0);
				}
				if (iLocal_28 == 3 || iLocal_28 == 4)
				{
					if (iLocal_300 == 0)
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_311, true) > 800f)
						{
							if (iLocal_304 == 0 && iLocal_199 == 1)
							{
								if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
								{
									if (!func_137() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
									{
										func_160(&uLocal_403, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_161(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_227(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
void func_181(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_183(Var11.f_1)) && iVar72 < 51)
			{
...
void func_240()
{
	if (iLocal_175 > 0)
	{
		...
		while (iLocal_176 <= 12)
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, false))
			{
				func_243(iLocal_33[iLocal_176], &(Local_70[iLocal_176 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0);
			}
			else
			{
				func_130(&(Local_70[iLocal_176 /*8*/]));
...
int func_243(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11)
{
	bool bVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_265(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_262(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_257(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_259(iParam5, &Var0, Param1, fParam4, func_63(iParam0));
...
void func_259(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_73(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, false))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, false))
				{
					...
					{
						if (func_273(PLAYER::PLAYER_PED_ID(), iLocal_48) == -1)
						{
...
void func_274()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (func_247(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 200, 0) || iLocal_211 == 1)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_33[iLocal_185]))
				{
					if (PED::CAN_PED_SEE_HATED_PED(iLocal_33[iLocal_185], PLAYER::PLAYER_PED_ID()))
					{
						...
						if (func_2(iLocal_33[iLocal_185], PLAYER::PLAYER_PED_ID(), 1) < 25f)
						{
							if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed"))
							{
								if (func_281(iLocal_33[iLocal_185], 6))
								{
									iLocal_289 = 1;
								}
							}
											...
											if (func_252(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed"))
											{
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_33[0]))
												{
													if (!PED::IS_PED_INJURED(iLocal_33[0]))
													{
														...
														{
															func_160(&uLocal_403, 4, iLocal_33[0], "ARMY_Guard01", 0, 1);
														}
													}
												}
												if (ENTITY::DOES_ENTITY_EXIST(iLocal_33[1]))
												{
													if (!PED::IS_PED_INJURED(iLocal_33[1]))
													{
														...
														{
															func_160(&uLocal_403, 4, iLocal_33[1], "ARMY_Guard01", 0, 1);
														}
													}
												}
