	...
	while (true)
	{
		...
		switch (iLocal_25)
		{
			case 0:
				if (uLocal_16[0])
				{
					StringCopy(&(Global_23285[1 /*42*/]), "CL_C1A", 16);
					StringCopy(&(Global_23285[1 /*42*/].f_4), "CL_C1A_BR", 16);
					Global_23285[1 /*42*/].f_8 = 0;
					Global_23285[1 /*42*/].f_9 = 2;
					StringCopy(&(Global_23285[1 /*42*/].f_10[1 /*4*/]), "CL_C1A_J1", 16);
					Global_23285[1 /*42*/].f_37[1] = 0;
					Global_23285[1 /*42*/].f_32[1] = 3;
					Global_23285[1 /*42*/].f_27[1] = 0;
					StringCopy(&(Global_23285[1 /*42*/].f_10[2 /*4*/]), "CL_C1A_J2", 16);
							...
							if (PED::IS_PED_INJURED(uLocal_21[iLocal_20]))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_21[iLocal_20], PLAYER::PLAYER_PED_ID(), true))
								{
									if (!Global_32879[iLocal_20])
									{
										...
										func_2("CL_C1A_J1", Global_23285[1 /*42*/].f_27[1], Global_23285[1 /*42*/].f_32[1], 2000, 1);
									...
									if (ENTITY::IS_ENTITY_DEAD(uLocal_21[iLocal_20], false))
									{
										if (!Global_32883[iLocal_20])
										{
											if (MOBILE::CELL_CAM_IS_CHAR_VISIBLE_NO_FACE_CHECK(uLocal_21[iLocal_20]) && func_1())
											{
												...
												func_2("CL_C1A_J2", Global_23285[1 /*42*/].f_27[2], Global_23285[1 /*42*/].f_32[2], 2000, 1);
		...
		switch (iLocal_26)
		{
			case 0:
				if (uLocal_16[1])
				{
					StringCopy(&(Global_23285[2 /*42*/]), "CL_C1B", 16);
					StringCopy(&(Global_23285[2 /*42*/].f_4), "CL_C1B_BR", 16);
					Global_23285[2 /*42*/].f_8 = 0;
					Global_23285[2 /*42*/].f_9 = 3;
					StringCopy(&(Global_23285[2 /*42*/].f_10[1 /*4*/]), "CL_C1B_J1", 16);
					Global_23285[2 /*42*/].f_37[1] = 0;
					Global_23285[2 /*42*/].f_32[1] = -1;
					Global_23285[2 /*42*/].f_27[1] = -1;
					StringCopy(&(Global_23285[2 /*42*/].f_10[2 /*4*/]), "CL_C1B_J2", 16);
					Global_23285[2 /*42*/].f_37[2] = 0;
					Global_23285[2 /*42*/].f_32[2] = -1;
					Global_23285[2 /*42*/].f_27[2] = -1;
					StringCopy(&(Global_23285[2 /*42*/].f_10[3 /*4*/]), "CL_C1B_J3", 16);
