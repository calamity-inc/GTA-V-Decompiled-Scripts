		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_43), 0)) && !func_32(&(uParam0->f_43), 4)) && !func_22()) && !func_20(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				...
				if (uParam0->f_43.f_4 == 6)
				{
					...
					if (((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar5) && !PAD::IS_CONTROL_JUST_PRESSED(2, 203)) && !Global_2766481) && !Global_2766478)
					{
						func_30(uParam0);
					}
					if (((((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 203) && !PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar5)) && func_26(func_27())) && func_25()) && func_24(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10, 4)) && func_23(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10))
					{
						Global_2766481 = 1;
						Global_2766478 = 1;
					}
