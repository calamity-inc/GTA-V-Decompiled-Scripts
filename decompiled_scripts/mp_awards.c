...
void func_125(int iParam0, int iParam1, int iParam2, char* sParam3, bool bParam4)
{
...
void func_145(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
