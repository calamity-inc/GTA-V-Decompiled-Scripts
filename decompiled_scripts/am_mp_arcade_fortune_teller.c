...
void func_56()
{
	...
	{
		MISC::SET_BIT(&Global_44449, true);
	}
...
void func_58(int iParam0)
{
	...
	if (!func_59(iParam0))
	{
		...
		if (bVar0 > 31)
		{
			...
			{
				bVar0 = (bVar0 - 32);
				MISC::SET_BIT(&(Global_2793046.f_6883), bVar0);
			}
			else if (bVar0 <= 95)
			{
				bVar0 = (bVar0 - 64);
				MISC::SET_BIT(&(Global_2793046.f_6884), bVar0);
			}
		}
		else
		{
			MISC::SET_BIT(&(Global_2793046.f_6882), bVar0);
		}
	}
}
