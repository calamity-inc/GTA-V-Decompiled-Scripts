...
void func_58()
{
	...
	{
		MISC::SET_BIT(&Global_44572, true);
	}
...
void func_60(int iParam0)
{
	...
	if (!func_61(iParam0))
	{
		...
		if (bVar0 > 31)
		{
			...
			{
				bVar0 = (bVar0 - 32);
				MISC::SET_BIT(&(Global_2794162.f_6888), bVar0);
			}
			else if (bVar0 <= 95)
			{
				bVar0 = (bVar0 - 64);
				MISC::SET_BIT(&(Global_2794162.f_6889), bVar0);
			}
		}
		else
		{
			MISC::SET_BIT(&(Global_2794162.f_6887), bVar0);
		}
	}
}
