...
void func_6()
{
	if (Global_113969.f_14144[iLocal_56 /*104*/].f_24 == 1)
	{
		if (Global_20908 == 0)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(2, Global_20901))
			{
				func_2();
				Global_20908 = 1;
				func_25();
	...
	{
		if (PAD::IS_CONTROL_PRESSED(2, Global_20902))
		{
			if (iLocal_58 == 1)
			{
				if (Global_20930.f_1 > 3)
...
void func_15(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_33(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	func_10(sParam2);
...
void func_37()
{
	...
	if (iLocal_59 == 0)
	{
		if (func_3(2, Global_20906, 0) || PAD::IS_CONTROL_JUST_PRESSED(2, 181))
		{
			if (iLocal_54 > 0)
			{
				iLocal_54 = (iLocal_54 - 1);
		...
		if (func_3(2, Global_20907, 0) || PAD::IS_CONTROL_JUST_PRESSED(2, 180))
		{
			iLocal_54++;
