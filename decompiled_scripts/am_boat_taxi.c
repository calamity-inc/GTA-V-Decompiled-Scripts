...
{
	if (Global_2672741.f_3690[bParam0] < iParam1)
	{
		Global_2672741.f_3690[bParam0] = iParam1;
	}
	MISC::SET_BIT(&(Global_2672741.f_3689), bParam0);
}
	...
	if ((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_62.f_3) && func_66(joaat("s_m_y_blackops_01"))) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_62.f_2))
	{
		if (func_74(Local_62.f_2))
		{
			if (func_42(&(Local_62.f_3), Local_62.f_2, 22, joaat("s_m_y_blackops_01"), -1, 1, 1, 1))
			{
				...
				ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(Local_62.f_3), SYSTEM::ROUND((200f * Global_262145.f_165)), 0, 0);
...
int func_56(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)
{
	int iVar0;
	int iVar1;
...
Vector3 func_64(struct<3> Param0, float fParam3, float fParam4, float fParam5)
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_65(struct<3> Param0, float fParam3)
{
	float fVar0;
			...
			if (((Local_84[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || Local_84[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || Local_84[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || Local_84[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				...
				if (Local_84[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_74(Local_62.f_2))
					{
						...
						{
							func_87(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 23, true), "BTX_ENTER", &uLocal_188, 0);
						}
					}
				}
				else
...
void func_78(int iParam0, var uParam1, var uParam2, int iParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_104(struct<2> Param0, Vector3 vParam2, struct<2> Param3, var uParam5)
{
