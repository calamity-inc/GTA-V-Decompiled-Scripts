...
int func_36(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_88(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_88(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_88(iVar10, 14, uVar69[iVar1], -1) };
			func_55(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_71(14);
			if (Global_78128 == 1)
			{
...
void func_72(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_76(iParam0, iParam1, &iVar2, &bVar1, bParam2, bParam3))
	{
...
bool func_76(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_152();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_90(int iParam0)
{
	...
	func_91(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_91(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_91(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_91(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_165(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_166(&sVar32, Var0.f_3, Global_100478, bParam1, bParam2);
	}
}

void func_166(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
...
void func_226(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (func_281(1, 1093140480, 0))
			{
				...
				func_328(0);
				func_278();
				func_270(Local_331[0 /*3*/], Local_331[1 /*3*/], fLocal_338, 2455.886f, 3432.445f, 49.2697f, 189.77f, 1, 1, 1, 0, 0);
...
int func_279(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
bool func_291(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_304(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_331(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_437(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_408(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
...
int func_332(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
{
	if (!func_396() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_401(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_408(struct<3> Param0, float fParam3)
{
	return func_409(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_409(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_411(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_413(iParam0, uVar1[iVar6], 1) && func_412(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_407(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
void func_414(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_419(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_443()
{
	...
	func_459(0);
	func_458(&uLocal_151, 1);
	func_458(&uLocal_151, 3);
	func_457(&(Local_81.f_28[0]), 1, 0, 1);
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
	{
...
void func_457(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_463(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_469())
	{
		...
		{
			iVar33 = func_464(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
