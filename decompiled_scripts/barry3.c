...
void __EntryFunction__()
{
	...
	if (func_356(Local_79.f_28[0]))
	{
		func_355(&iLocal_145, &(Local_79.f_28[0]));
	}
	func_354(1);
	while (true)
	{
		...
		func_338(Local_79.f_9, 0, 0, 0, 0, 0);
		if (iLocal_141 == 5)
		{
			func_332();
		}
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_208(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_208(iParam0) };
...
void func_215()
{
	switch (iLocal_142)
	{
		...
		case 1:
			...
			if (func_356(iLocal_147[0]) && func_356(iLocal_147[1]))
			{
...
int func_289(int iParam0, var uParam1)
{
	...
	iVar0 = func_290(iParam0, uParam1);
...
var func_290(int iParam0, var uParam1)
{
...
void func_293()
{
	...
	else if (iLocal_142 == 1)
	{
		...
		{
			if (!bLocal_159 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, false, true, 0) || func_294()))
			{
				bLocal_159 = true;
...
void func_295()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_356(iLocal_145))
	{
...
void func_304()
{
	...
	if (iLocal_142 == 0)
	{
		...
		func_312(&uLocal_177, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		func_312(&uLocal_177, 3, iLocal_145, "BARRY", 0, 1);
			...
			if (func_482())
			{
				switch (func_311())
				{
					case 0:
						...
						STREAMING::REQUEST_MODEL(iLocal_152);
						func_310(0, 0);
						func_309(iLocal_145, Local_349, fLocal_362, 1, 1);
						...
						func_266();
						func_308(Local_346, fLocal_361, 1, 0);
						func_306(0, -1, 1);
						func_253(2);
						break;
...
int func_313()
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_145))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_145, PLAYER::PLAYER_PED_ID(), true) || func_330(PLAYER::PLAYER_PED_ID(), iLocal_145, 1))
		{
		...
		else if (func_314(iLocal_145, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_330(PLAYER::PLAYER_PED_ID(), iLocal_145, 1))
		{
			if (!iLocal_155)
			{
...
bool func_317(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar4 = func_322(iParam0, iParam1);
	if (!func_356(iParam0) || !func_356(iParam1))
	{
		if (iVar4 != -1)
		{
			func_321(&(Local_35[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_318(&(Local_35[iVar4 /*4*/]), Var1, iParam1, &(Local_35[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar4 /*4*/].f_3) < iParam4);
}

int func_318(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_328(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_340(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_341(iVar2), 8);
					break;
			}
			break;
	...
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_384(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_383(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_417(iParam0) != 145) || func_416(iParam0)) || func_415(iParam0)) || func_365(iParam0)) || func_414(iParam0)) || !func_404(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_415(iParam0))
		{
		}
...
int func_421(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_393(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_424(*iParam0, ((*uParam1)[38] - 1)))
	{
...
{
	return func_440(&(Global_107357.f_2890), Param0, fParam3, 0);
}
...
int func_472(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (func_475(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			{
				func_473(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
...
int func_475(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_476(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_476(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_483()
{
	...
	func_495(&iLocal_150, 0);
	func_494(1);
	func_354(0);
	PED::SET_CREATE_RANDOM_COPS(true);
	func_484(&Local_79, 0, 0, 0);
...
void func_494(bool bParam0)
{
	...
	{
		func_493(&(iLocal_147[0]));
		func_493(&(iLocal_147[1]));
		func_489(&iLocal_146);
	}
}
