...
Vector3 func_284(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_321(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
float func_331(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_372(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_393()
{
	Local_353[0 /*29*/] = { func_394(joaat("habanero"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), Local_794) };
	Local_353[1 /*29*/] = { func_394(joaat("dubsta"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), Local_797) };
	Local_353[2 /*29*/] = { func_394(joaat("patriot"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), Local_797) };
	Local_353[3 /*29*/] = { func_394(joaat("rebel"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), Local_794) };
	Local_353[4 /*29*/] = { func_394(joaat("sadler"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), Local_797) };
}
...
bool func_404(char* sParam0, int iParam1, char* sParam2)
{
...
void func_422(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_428(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
int func_448(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_523(int* iParam0, struct<3> Param1, float fParam4, int iParam5)
{
...
void func_524(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_525(iParam0);
...
int func_526(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_527(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
