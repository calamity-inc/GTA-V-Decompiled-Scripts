...
void __EntryFunction__()
{
	...
	if (func_539())
	{
		Global_79494 = 1;
		iLocal_77 = 0;
		while (!func_528(&Local_90))
		{
			SYSTEM::WAIT(0);
		}
		func_527(&Local_90, 0, 1);
		Global_79494 = 0;
	}
	...
	func_526(25);
	func_525();
	func_524(&uLocal_151, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	func_524(&uLocal_151, 3, iLocal_732, "CLETUS", 0, 1);
	while (true)
	{
		RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_TP", 0);
		func_507(Local_90.f_9, 0, 0, 0, 0, 0);
		...
		if (bParam2)
		{
			if (!Global_79248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9342[iParam1 /*4*/] = { func_219(iParam0) };
					...
					{
						Global_9293[1 /*6*/] = { func_219(iParam0) };
...
void func_235(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_312(&(Global_101392.f_3));
				if (iVar10 > -1)
				{
...
{
	func_237(&Global_107917, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_261(int iParam0, bool bParam1)
{
	...
	if (func_161(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_262(iParam0, &(Global_114370.f_2366.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
Vector3 func_279(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_295(Global_103545);
			break;
		
		case 46:
			if (Global_1845093 != func_294())
			{
				if (func_293(Global_1845093))
				{
					return func_286(2, 2);
				}
				else if (func_285(Global_1845093))
				{
...
int func_313(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_314(Global_114370.f_9088.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_314(Global_114370.f_9088.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_314(Global_114370.f_9088.f_99.f_205[11]);
			break;
		
		case 90:
			return func_314(Global_114370.f_9088.f_99.f_205[7]);
			break;
		
		case 93:
			return func_314(Global_114370.f_9088.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
int func_325(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
{
	return Global_56289.f_37[iParam0];
}

int func_353()
{
	return Global_56289.f_36;
}

bool func_354()
{
	return Global_56289.f_36 > 0;
}
...
float func_383(int iParam0, int iParam1, bool bParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_397()
{
	Local_351[0 /*29*/] = { func_398(joaat("habanero"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), Local_792) };
	Local_351[1 /*29*/] = { func_398(joaat("dubsta"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), Local_795) };
	Local_351[2 /*29*/] = { func_398(joaat("patriot"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), Local_795) };
	Local_351[3 /*29*/] = { func_398(joaat("rebel"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), Local_792) };
	Local_351[4 /*29*/] = { func_398(joaat("sadler"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), Local_795) };
}

struct<29> func_398(int iParam0, struct<3> Param1, float fParam4, int iParam5, struct<3> Param6)
{
	struct<29> Var0;
...
bool func_408(char* sParam0, int iParam1, char* sParam2)
{
...
void func_423()
{
	...
	switch (iLocal_319)
	{
		case 0:
			if (func_418())
			{
				func_456("Cletus_MCS_1_concat", 1);
				iLocal_319 = 1;
			}
			break;
...
void func_426(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_433(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_435(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_439(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
...
int func_453(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
	func_455(bParam5, bParam6);
	func_454(iParam0);
...
void func_458()
{
	...
	if (func_539())
	{
		...
		{
			case 0:
				func_459(Local_808, fLocal_811, 1, 0);
				iLocal_316 = 3;
				break;
			
			case 1:
				func_459(Local_740, fLocal_688, 1, 0);
				iLocal_316 = 5;
				break;
			
			case 2:
				func_459(Local_746, fLocal_689, 1, 0);
				iLocal_316 = 12;
				break;
			
			case 3:
				func_459(Local_801, fLocal_804, 1, 0);
				iLocal_316 = 16;
				break;
			
			case 4:
				func_459(Local_911, fLocal_914, 1, 0);
				iLocal_316 = 20;
				break;
	...
	if (func_318(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_317)
		{
			...
			case 4:
				...
				{
					func_498(&uLocal_993, &uLocal_151, cLocal_737, &sLocal_994, &cLocal_1000);
				}
				break;
...
void func_470()
{
	...
	{
		iVar1 = 0;
		while (iVar1 < func_472())
		{
			if (ENTITY::DOES_ENTITY_EXIST(func_471(iVar1)))
			{
				iVar0 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_471(iVar1));
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_732, false) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_701)
			{
				if (!func_227())
				{
					if (!iLocal_657[8])
					{
						if (func_477(&uLocal_151, cLocal_737, "HUNT1_BANTER", &Local_980, 7, 0, 0))
						{
...
bool func_477(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_350(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
		...
		switch (iLocal_712)
		{
			case 0:
				switch (iParam0)
				{
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_732, Local_779, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_493(iLocal_732, fLocal_689, 30f))
						{
							iLocal_712 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_732, Local_786, 1.5f, 1.5f, 1.5f, false, true, 0) || !func_493(iLocal_732, fLocal_697, 30f))
						{
							iLocal_712 = 1;
						}
						break;
...
int func_493(int iParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
int func_496()
{
	if (func_318(PLAYER::PLAYER_PED_ID()))
	{
		if (WEAPON::GET_WEAPONTYPE_GROUP(func_497(PLAYER::PLAYER_PED_ID())) == joaat("GROUP_SNIPER"))
		{
			return 1;
		}
	}
...
void func_498(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_477(uParam1, sParam2, sParam3, sParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_477(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_503()
{
	if (!PED::IS_PED_INJURED(iLocal_732))
	{
		...
		if (!iLocal_617)
		{
			if (func_505() || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_732))
			{
				if (func_227())
				{
					func_326();
				}
				func_504(&uLocal_151, cLocal_737, "HUNT1_PTREAC", 6, 0, 0);
				iLocal_617 = 1;
			}
		}
		if (!bLocal_643)
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_509(Global_79504, Global_79506, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_521(0) || Global_79519) || Global_79507 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79503)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_520(0)) || func_519(1))
			{
			}
			else
			{
...
{
	return func_523(iParam0, Global_43922);
}
...
int func_528(var uParam0)
{
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_538(&(uParam0->f_48), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_77 = 1;
			break;
		
		case 1:
			if ((!func_537(&iVar0) || !func_535(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			...
			{
				if (func_532(&(uParam0->f_28[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
			...
			{
				func_529(&(uParam0->f_35[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
...
void func_529(int* iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	func_530(iParam0, iLocal_79, Param1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_530(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_531(iParam0);
...
int func_532(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_533(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_533(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_555()
{
	...
	iVar0 = func_315(&(Global_101392.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_557()
{
	...
	{
		if (func_312(&(Global_101392.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_574(&(uParam0->f_28));
	func_574(&(uParam0->f_35));
	func_574(&(uParam0->f_41));
}
