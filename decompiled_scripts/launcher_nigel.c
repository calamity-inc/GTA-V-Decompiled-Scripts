...
int func_183(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
bool func_201(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0, var uParam1, var uParam2)
{
	if (func_136(*uParam1))
	{
		switch (*iParam0)
...
int func_209(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
...
void func_219(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_262(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_264(&(uParam0->f_35[0]), iLocal_93, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_136(uParam0->f_35[0]))
				{
...
int func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_267(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_271(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_277(var uParam0, var uParam1)
{
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_280(uParam1);
			func_279(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_279(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_279(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_279(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_279(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_279(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_279(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_279(uParam1, -1328.153f, 192.0178f, 57.8136f);
...
void func_283(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_229(iParam0);
...
void func_284(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_285(iParam0);
...
struct<6> func_293(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
bool func_299(int iParam0, char* sParam1)
{
...
int func_305(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_306(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_307(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
