...
int func_182(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
bool func_200(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_208(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
...
int func_261(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_263(&(uParam0->f_35[0]), iLocal_93, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_136(uParam0->f_35[0]))
				{
...
void func_272(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				iLocal_105 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, false, true, true, true);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", false);
		...
		case 39:
			if (bParam1)
			{
				iLocal_105 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, false, true, true, true);
		...
		case 41:
			if (bParam1)
			{
				iLocal_105 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, false, true, true, true);
		...
		case 42:
			if (bParam1)
			{
				iLocal_105 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, false, true, true, true);
...
int func_304(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_305(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_306(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
