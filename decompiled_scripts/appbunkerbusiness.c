...
int func_238(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (func_25() < 7)
	{
		...
		switch (func_25())
		{
			case 0:
				...
				fVar56 = Global_262145.f_21792;
				break;
			
			case 1:
				fVar56 = Global_262145.f_21793;
				break;
			
			case 2:
				fVar56 = Global_262145.f_21794;
				break;
			
			case 3:
				fVar56 = Global_262145.f_21795;
				break;
			
			case 4:
				fVar56 = Global_262145.f_21796;
				break;
			
			case 5:
				fVar56 = Global_262145.f_21797;
				break;
			
			case 6:
				fVar56 = Global_262145.f_21798;
				break;
		}
...
int func_309(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_327(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
...
int func_329(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
bool func_332(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_337(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = func_292(iParam1, 0, bParam2, 0);
	iVar3 = func_338(iParam1, Var0, iParam0, bParam2);
	if (iVar3 < 0)
	{
		iVar3 = 0;
	}
...
int func_338(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_348(int iParam0)
{
	...
	iVar18 = func_46(iParam0, iLocal_121);
	iVar19 = iParam0;
	iVar20 = func_350(5, iVar19 + 1);
	iVar21 = MISC::GET_HASH_KEY(&sVar2);
	if (func_49())
	{
		bVar0 = false;
		while (!func_349(-103880010, 235173372, iVar21, 1, iVar18, &iLocal_110, iVar20, 3, 0, 0, 0))
		{
			SYSTEM::WAIT(0);
			func_494();
	...
	if (bVar0)
	{
		if (iVar18 > 0)
		{
			Var22.f_0 = MISC::GET_HASH_KEY(func_313(iLocal_121));
			Var22.f_1 = 5;
			Var22.f_2 = iParam0;
...
bool func_349(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
...
void func_356()
{
	...
	func_357(iVar2, iVar0, Var4, Var10, Var14, iVar1, iVar3);
}

void func_357(int iParam0, int iParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char* sParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char* sParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15, int iParam16, int iParam17)
{
...
void func_359()
{
	...
	iVar3 = func_13(PLAYER::PLAYER_ID(), iLocal_121);
	iVar4 = func_33(PLAYER::PLAYER_ID(), iLocal_121);
	iVar5 = Global_1640666[5];
	iVar6 = func_386(iLocal_121);
	sVar7 = func_313(iLocal_121);
	StringCopy(&cVar8, "UA_BUNKER_TXD_", 24);
	iVar14 = func_32(PLAYER::PLAYER_ID(), iLocal_121);
	StringIntConCat(&cVar8, (iLocal_121 - 21), 24);
	iVar15 = func_19();
	iVar16 = func_384(iVar15, 5);
	iVar17 = func_382(iVar15, 5);
	iVar18 = func_380(iVar15, 5);
	iVar19 = func_378(iVar15, 5);
	iVar20 = func_376(iVar15, 5);
	iVar21 = func_374(iVar15, 5);
	iVar22 = func_373(iVar17, iVar16);
	iVar23 = func_373(iVar19, iVar18);
	iVar24 = func_373(iVar20, iVar21);
	iVar25 = func_371(iLocal_121);
...
struct<13> func_364(int iParam0)
{
	struct<13> Var0;
...
void func_395(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	var uVar0;
...
int func_397(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_415(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, bool bParam6)
{
	struct<7> Var0;
	int iVar7;
	int iVar8;
	...
	Var0.f_2 = func_416(iVar9, bParam0, bParam2, bParam3, bParam4, iParam5, bParam6);
	if (iParam1 != -1)
	{
		Var0.f_3 = iParam1 + 1;
	}
...
void func_423(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
bool func_431(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<4> func_438(int iParam0, bool bParam1)
{
	struct<4> Var0;
...
struct<6> func_439(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
void func_457(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<7> Var0;
...
bool func_468(float fParam0, float fParam1, float fParam2, int iParam3)
{
	if (iParam3 <= 0)
	{
		return 0;
	...
	if (BitTest(uLocal_109, 11))
	{
		...
		else if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_305))
		{
			...
			else
			{
				...
				MemCopy(&sVar5, {func_439(iLocal_127, 0)}, 4);
				func_481(1);
...
void func_507(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_514(var uParam0, var uParam1, var uParam2)
{
	return func_515(uParam0, uParam1, uParam2) == 3;
}

int func_515(var uParam0, var uParam1, var uParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_523(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_524(char* sParam0, int iParam1, bool bParam2)
{
	Global_21606 = 0;
...
void func_542(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_552(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
