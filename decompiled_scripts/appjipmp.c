...
void __EntryFunction__()
{
	...
	fLocal_168 = 100f;
	fLocal_179 = 0.5f;
	StringCopy(&Local_187, "CELL_37", 16);
	StringCopy(&Local_191, "CELL_249", 16);
	StringCopy(&Local_195, "CELL_206", 16);
	StringCopy(&Local_199, "CELL_212", 16);
	StringCopy(&Local_203, "CELL_213", 16);
...
void func_187()
{
	...
	if (func_200(PLAYER::PLAYER_ID()))
	{
		if (!func_197(func_198(PLAYER::PLAYER_ID())))
		{
			if (func_193(1))
			{
				StringCopy(&Local_207, "PHINVQUITBBB", 24);
			}
			else
			{
				StringCopy(&Local_207, "PHINVQUITBB", 24);
			}
			bVar0 = true;
		}
	}
	...
	{
		StringCopy(&Local_207, "PHINVQUITB", 24);
		bVar0 = true;
	}
	if (func_189())
	{
		StringCopy(&Local_207, "PHINVQUIT", 24);
		bVar0 = true;
	}
	if (bVar0)
	{
...
void func_203()
{
	...
	func_220(Global_20911, "SET_DATA_SLOT", 18f, 0f, 0f, -1f, -1f, "CELL_208", 0, 0, 0, 0);
	bVar1 = true;
...
int func_249(int iParam0)
{
	...
	if (iParam0 == 0 && (Global_262145.f_4366 == 1 || iLocal_219 == 1))
	{
		return 0;
	}
	return 1;
	...
	switch (iParam0)
	{
		case 0:
			switch (iParam1)
			{
				...
				case 5:
					iVar0 = func_155(319);
					if ((((func_127() || func_174()) || iVar0 == -1) || Global_1836849.f_37[iVar0] == -1) || !Global_262145.f_34220)
					{
						return 0;
					}
					else
				...
				case 2:
					iVar0 = func_155(341);
					if ((((func_127() || func_174()) || iVar0 == -1) || Global_1836849.f_37[iVar0] == -1) || !Global_262145.f_35492)
					{
						return 0;
					}
					else
...
int func_281(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	int iVar0;
	struct<69> Var1;
	struct<69> Var70;
...
int func_285(var uParam0, var uParam1, var* uParam2, var* uParam3)
{
	switch (*uParam0)
	{
		case 0:
...
int func_336(var uParam0, int iParam1)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (((((((((((Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 14 || Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 15) || Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 13) || Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 6) || Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 5) || Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 32) || func_356()) || BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_879, 6)) || func_351(PLAYER::PLAYER_PED_ID(), 1215605247, 0, uParam0, 0, 500, 1, 0)) || func_350(PLAYER::PLAYER_ID(), 0)) || func_347(PLAYER::PLAYER_ID(), 1, 0)) || Global_1845281[PLAYER::PLAYER_ID() /*883*/] == 148)
		{
			return 9;
		}
...
int func_351(int iParam0, int iParam1, bool bParam2, var uParam3, float fParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
