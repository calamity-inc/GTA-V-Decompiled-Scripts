			...
			else if (Global_22286 == 4 || Global_22286 == 3)
			{
				...
				else
				{
					...
					if (func_49(Global_8115, Global_20930) == 0)
					{
						...
						func_120(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8115 /*10*/].f_4), "CELL_300", &cVar1, "CELL_195", 0);
					}
					else
					{
						func_50(Global_20911, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_15()
{
	...
	if (iLocal_233 == 0)
	{
		if (func_48(2, Global_20906, 0) || PAD::IS_CONTROL_JUST_PRESSED(2, 181))
		{
			func_19();
			iLocal_233 = 1;
			SYSTEM::SETTIMERA(0);
		}
		if (func_48(2, Global_20907, 0) || PAD::IS_CONTROL_JUST_PRESSED(2, 180))
		{
			func_16();
			iLocal_233 = 1;
			SYSTEM::SETTIMERA(0);
...
void func_21(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6)
{
...
void func_50(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
...
void func_69()
{
	...
	if (NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		...
		else if (func_72(Global_2746026.f_20))
		{
...
float func_107(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	struct<2> Var0;
	float fVar3;
	float fVar4;
...
Vector3 func_108(struct<3> Param0, struct<3> Param3, float fParam6)
{
