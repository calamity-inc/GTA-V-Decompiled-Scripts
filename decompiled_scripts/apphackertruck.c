...
int func_227(int iParam0)
{
	...
	else if (func_3(&(Global_2765972.f_146)) && !func_1(&(Global_2765972.f_146), Global_262145.f_19314, 1))
	{
		return 0;
	}
	return 1;
	...
	else
	{
		...
		else
		{
			...
			if (iVar28 <= 0)
			{
				if (!func_230())
				{
					iVar28 = (Global_262145.f_15555 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), Global_2765972.f_142)));
				}
			}
			if (iVar28 > 0)
			{
...
int func_230()
{
	if (func_3(&(Global_2765972.f_142)) && !func_1(&(Global_2765972.f_142), Global_262145.f_15555, 1))
	{
		return 0;
	}
	return 1;
...
int func_488(int iParam0)
{
	...
	{
		iVar0 = (Global_262145.f_19314 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), Global_2765972.f_146)));
		iVar0 = (iVar0 / 1000);
	}
	return iVar0;
}
		...
		case 2:
			...
			while (iVar0 < func_244())
			{
				...
				if (iVar1 <= 0)
				{
					if (!func_230())
					{
						iVar1 = (Global_262145.f_15555 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), Global_2765972.f_142)));
					}
				}
				if (iVar1 >= 0)
				{
				...
				else
				{
					...
					if (!bVar4)
					{
						...
						if (iVar3 <= 0)
						{
							if (!func_230())
							{
								iVar3 = (Global_262145.f_15555 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), Global_2765972.f_142)));
							}
						}
