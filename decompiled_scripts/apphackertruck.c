...
void __EntryFunction__()
{
	...
	while (func_531())
	{
		...
		if (func_3(&uLocal_309) && func_1(&uLocal_309, 1800, 0))
		{
...
void func_4()
{
	...
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_300))
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_300);
			switch (iVar0)
			{
				case 0:
					func_456();
...
void func_6()
{
	...
	while (iVar0 < 5)
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "ADD_JOB");
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "SHOW_JOB_OVERLAY");
...
void func_29()
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "CLEAR_JOBS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iVar0 = 0;
	while (iVar0 < 9)
	{
...
void func_37(int iParam0)
{
	...
	{
		iLocal_298 = func_220(PLAYER::PLAYER_ID(), iVar0);
		iVar1 = func_19(PLAYER::PLAYER_ID(), iLocal_298);
		if (!func_24(PLAYER::PLAYER_ID(), iLocal_298) && !func_23(iVar1))
		{
			func_219();
		}
		else if (func_16(PLAYER::PLAYER_ID(), iLocal_298))
		{
			func_219();
		}
		else if (Global_1640666[func_218(iLocal_298)] >= Global_262145.f_18433)
		{
			func_219();
		}
		else if (func_15(func_218(iLocal_298)))
		{
			func_219();
		}
		else if (!func_39(192))
...
void func_229(int iParam0)
{
	...
	{
		iLocal_294 = func_251(iParam0);
		if (!func_250(iLocal_295))
		{
			func_219();
		}
		else if (func_249(iLocal_294))
		{
			func_219();
		}
		else if (!func_39(167))
		...
		{
			Var0 = { func_246(iLocal_296, iLocal_295, func_248()) };
			func_359("HT_SC_P2", &Var0, "WHOUSE_CONF", "WHOUSE_CANC", 0, 1, 3, -1, -1, 0, 0);
		}
	}
	else
	{
		iLocal_295 = iParam0 + 1;
		if (!func_339(PLAYER::PLAYER_ID()))
		{
			func_359("HT_SC_P1", "HT_SC_P1_D1", "OR_OVRLY_OK", "", 1, 0, 0, -1, -1, 0, 0);
		}
		else if (!func_250(iLocal_295))
		{
...
void func_230()
{
	...
	while (iVar0 < 5)
	{
		...
		if (bVar11)
		{
			...
			StringCopy(&Var7, func_243(iVar2), 16);
			if (func_241(iVar2) < iLocal_295)
			{
				bVar11 = false;
				func_22(15, iVar0);
			}
	...
	else
	{
		...
		else
		{
			...
			StringIntConCat(&Var12, (iLocal_295 - 1), 16);
			cVar16 = { func_240(iLocal_296) };
			if (iLocal_295 == 1 && func_248())
			{
				StringCopy(&Var12, "HT_SCW_D3", 16);
				cVar16 = { func_238(func_239(iVar2)) };
			}
			else
			{
				Var22 = { func_238(func_239(iVar2)) };
			}
			iVar28 = func_232(iVar2);
			iVar29 = 0;
			if (iVar28 <= 0)
			{
				if (!func_231())
				{
					iVar28 = (Global_262145.f_15610 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), Global_2789228.f_142)));
				}
			}
			if (iVar28 > 0)
			{
...
struct<4> func_246(int iParam0, int iParam1, var uParam2)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
...
void func_252(int iParam0)
{
	...
	iLocal_297 = func_257(iParam0);
	if (func_256(PLAYER::PLAYER_ID()))
	{
		func_219();
	}
	else if (iLocal_297 != 8 && func_254(iLocal_297))
	{
		func_219();
	}
	else if (!func_39(229))
	...
	else
	{
		...
		if (iLocal_297 != 8)
		{
			...
			Var4 = { func_253(iLocal_297) };
		}
		func_359("HT_AF_P1", &Var0, "WHOUSE_CONF", "WHOUSE_CANC", 0, 1, 2, -1, -1, &Var4, 0);
	}
}
...
int func_263(int iParam0, int iParam1)
{
	...
	while (iVar22 < 32)
	{
		...
		{
			bVar33 = ((func_55(iVar26) != iVar25 || iVar25 == func_18()) && iVar26 != PLAYER::PLAYER_ID());
			iVar24 = 0;
			while (iVar24 < 10)
			{
				if (iVar0[iVar24] != -1)
				{
					Var27 = { func_324(iParam0, iVar24) };
					if (!func_323(Var27))
					{
						if (HUD::DOES_BLIP_EXIST(Global_2678393[iVar26]))
						{
							Var30 = { HUD::GET_BLIP_COORDS(Global_2678393[iVar26]) };
							Var30.f_2 = PATHFIND::GET_APPROX_FLOOR_FOR_POINT(Var30.f_0, Var30.f_1);
						}
						else
						{
							Var30 = { func_268(iVar26) };
						}
						if (!func_323(Var30))
						{
							if (SYSTEM::VDIST2(Var30, Var27) < (func_267(iParam0, bVar33) * func_267(iParam0, bVar33)))
							{
								iVar0[iVar24] = -1;
								if (!bVar33)
								{
	...
	while (iVar24 < 10)
	{
		...
		{
			if (!func_266(iParam0, iVar24))
			{
				if (!func_264(iParam0, iVar24))
				{
...
void func_316(struct<3> Param0, var uParam3)
{
	int iVar0;
	int iVar1;
...
int func_317(struct<3> Param0, int iParam3, float fParam4)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
	...
	else
	{
		...
		while (iVar0 <= 7)
		{
			if (func_317(Param0, iVar0, fParam4))
			{
				return 1;
			}
			iVar0++;
		...
		if (func_317(Param0, 8, fParam4))
		{
			return 1;
		}
		if (func_317(Param0, 17, fParam4))
		{
			return 1;
		}
	}
...
void func_331()
{
	...
	while (iVar0 < 3)
	{
		cVar1 = { func_240(iLocal_296) };
		iVar7 = iVar0 + 1;
		iVar8 = func_337(iVar7);
		iVar9 = -1;
		if (iVar7 == 1 && func_248())
		{
			iVar10 = func_247(iLocal_296);
			if (func_336(iVar10))
			{
				iVar9 = func_335(iVar10);
				iVar8 = func_334(iVar10);
			}
			else
			{
		...
		else if (func_333(iVar7))
		{
			iVar9 = iVar8;
			iVar8 = func_332(iVar7);
		}
		...
		bVar19 = func_339(PLAYER::PLAYER_ID());
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "ADD_JOB");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
...
void func_342()
{
	...
	while (iVar0 < 9)
	{
		...
		bVar13 = ((func_346(PLAYER::PLAYER_ID()) && func_344(PLAYER::PLAYER_ID())) && !func_256(PLAYER::PLAYER_ID()));
		iVar14 = 0;
		iVar15 = 0;
		iVar16 = func_257(iVar0);
		iVar17 = iVar16;
		if (iVar16 != 8 && func_254(iVar16))
		{
			iVar15 = func_343(Global_2789376[iVar17 /*2*/], Global_2789376.f_17[iVar17], 0);
		}
		if (iVar15 > 0)
		{
			iVar14 = 2;
...
int func_343(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
...
void func_359(char* sParam0, char* sParam1, char* sParam2, char* sParam3, bool bParam4, bool bParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "SHOW_OVERLAY");
	func_8(sParam0);
...
void func_362(int iParam0)
{
	...
	iLocal_116 = iParam0;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "SHOW_SCREEN");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
void func_363()
{
	...
	switch (func_455())
	{
		...
		case 3:
			if (func_428(iLocal_294, iLocal_295, func_248(), iLocal_296, 167))
			{
		...
		case 6:
			if (func_371(iLocal_298, 192))
			{
				Global_1946104 = iLocal_298;
				Global_1943947.f_53 = 1;
				func_442(192);
				func_364(func_218(iLocal_298), !Global_262145.f_17496);
				func_368(func_218(iLocal_298));
			}
			break;
...
void func_369(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
...
void func_381(struct<67> Param0, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, int iParam85)
{
	struct<3> Var0;
	int iVar36;
...
int func_386(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
...
int func_388(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int func_389(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_400(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_402(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<7> Var0;
...
void func_413(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
int func_414(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		iVar18 = func_227(func_112());
		if (iVar18 != 0)
		{
			iVar0 = 0;
			while (iVar0 < 4)
			{
				Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_332[iVar0] = func_419(iVar18);
				iVar0++;
			}
			bVar16 = true;
		}
	...
	if (iParam0 != 4)
	{
		if (bVar15)
		{
			...
			{
				uVar19 = 2;
				uVar22 = func_415(&iVar1, iVar17, &uVar19);
				iVar0 = 0;
				while (iVar0 < iParam1)
				{
		...
		else if (iVar17 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_332[iVar0] = func_415(&iVar1, iVar17, &uVar23);
				iVar0++;
			}
			bVar16 = true;
		}
...
int func_415(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_330(iVar17))
	{
		Var21 = { Global_1946250.f_533[func_418(func_227(iVar17)) /*3*/] };
		Var21.f_2 = 0f;
	}
	else
	{
	...
	if (iParam1 > 0)
	{
		...
		if (iVar16 > 0)
		{
			...
			func_416(uVar2[iVar32], &iVar25, &bVar26);
		...
		else
		{
			...
			if (iVar16 > 0)
			{
				...
				func_416(uVar2[iVar33], &iVar25, &bVar26);
				MISC::SET_BIT(uParam2[iVar25], bVar26);
				return uVar2[iVar33];
			}
			else
			{
				...
				func_416(uVar2[iVar34], &iVar25, &bVar26);
				MISC::SET_BIT(uParam2[iVar25], bVar26);
				return uVar2[iVar34];
			}
		}
...
void func_421()
{
	...
	while (iVar0 < 32)
	{
		...
		uVar38 = func_425(iVar4[iVar0], iVar37);
		...
		{
			iVar39 = func_422(iVar37, &(Global_1946187[iVar0]));
			if (func_423(PLAYER::PLAYER_ID(), Global_1946187[iVar0]))
			{
				func_422(iVar39, &(Global_1946187[iVar0]));
				if (func_423(PLAYER::PLAYER_ID(), Global_1946187[iVar0]))
				{
					Global_1946187[iVar0] = 0;
				}
...
int func_428(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	int iVar0;
	char cVar1[16];
	bool bVar5;
	...
	bVar5 = false;
	iVar6 = func_337(iParam1);
	if (uParam2 && iParam1 == 1)
	{
		iVar6 = func_335(func_247(iParam3));
		bVar5 = true;
	}
	if (iVar6 > 0)
	{
	...
	if (func_394())
	{
		iVar7 = func_437(1, iParam1, bVar5, func_247(iParam3));
		iVar8 = func_436(iVar0);
		iVar9 = -1;
		iVar10 = 0;
		iVar11 = 1;
		while (func_435(&iVar9, iVar6, iVar0, -1799524201, -1018905335, iVar7, iVar8, &iVar11, &iVar10))
		{
			func_466();
			SYSTEM::WAIT(0);
		}
	...
	if (iVar6 >= 0 && (iVar6 == 0 || (iVar6 > 0 && (func_394() || MONEY::NETWORK_CAN_SPEND_MONEY(iVar6, false, true, false, -1, 0)))))
	{
		if (iVar6 > 0)
		{
			func_429(joaat("mpply_ingamestore_moneyspent"), iVar6);
		}
		if (func_394())
		{
...
int func_435(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	if (*iParam7)
	{
		switch (*iParam8)
...
int func_437(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	char* sVar0;
...
void func_438(char* sParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	if (bParam1)
	{
		if (iParam2 == -1)
...
void func_442(int iParam0)
{
	...
	{
		iVar0 = 0;
		if (func_248() && iLocal_295 == 1)
		{
			iVar0 = 1;
		}
		func_451(iParam0, iLocal_294, iLocal_295, iLocal_296, iVar0);
	}
	else if (iParam0 == 229)
	{
		if (iLocal_297 == 8)
		{
			iLocal_297 = MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
			func_450(18);
		}
		else
		{
...
void func_451(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	func_452(uParam1, iParam2, iParam3, iParam4);
	func_401(iParam0, uParam1);
}

void func_452(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
void func_456()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_360(0);
...
void func_457()
{
	if (func_458())
	{
		if (!BitTest(uLocal_109, 3))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "GET_CURRENT_SELECTION");
			iLocal_300 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_459()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
	}
	func_464(2, 206, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
	}
	if (PAD::_IS_USING_KEYBOARD_2(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
		func_464(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
		}
		func_464(2, 187, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
		}
	}
	func_464(2, 189, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	func_464(2, 190, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
	func_464(2, 201, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	func_464(2, 202, 1);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	func_464(2, 204, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_299, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1f, -1f, -1f, -1f);
	}
	if (PAD::_IS_USING_KEYBOARD_2(2))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "SET_ANALOG_STICK_INPUT");
			iLocal_301 = iVar0;
			iLocal_302 = iVar1;
...
void func_461()
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "HIDE_JOB_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_466()
{
	...
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_299, 255, 255, 255, 255, 0);
	func_477();
	func_470(0);
	func_467(1);
}
...
void func_479(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_483(int iParam0)
{
	if (BitTest(uLocal_109, 4))
	{
		if (!func_463())
		{
			if (func_1(&uLocal_307, 1000, 0))
			{
				func_496(iParam0);
			}
			if (func_1(&uLocal_305, 500, 0))
			{
				func_494(iParam0);
			}
		}
...
void func_484(int iParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "UPDATE_MISSION");
	iVar0 = iParam0;
	iVar1 = 0;
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_299, "UPDATE_COOLDOWN");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
void func_521()
{
	...
	{
		if (!func_3(&uLocal_311))
		{
			func_2(&uLocal_311, 0, 0);
		}
		else if (func_1(&uLocal_311, iLocal_113, 0))
		{
...
{
	func_530();
	iLocal_299 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("hacker_truck_desktop");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_299))
	{
		SYSTEM::WAIT(0);
	}
	func_471(1);
...
int func_536(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_299);
	func_539(iParam0);
	func_541(0);
	func_544();
