...
void func_4(int iParam0)
{
	...
	if (iParam0 != 9 && !func_5(iParam0))
	{
		if (Global_262145.f_8754 > 0 && Global_262145.f_8754 <= 21)
		{
			...
			{
				iVar0 = 0;
				while (iVar0 < (Global_262145.f_8754 - 1))
				{
...
int func_15()
{
	...
	if (func_370(4))
	{
		...
		else if (func_16(&(Global_2698947.f_177), (Global_262145.f_45 * 120000), 0))
		{
			func_2(3);
			func_388(6);
		}
...
float func_149(float fParam0, float fParam1)
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
int func_167(int iParam0, int iParam1, int iParam2, struct<3> Param3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_168(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
Vector3 func_173(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4)
{
	switch (iParam1)
	{
		case 271:
...
Vector3 func_182(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
Vector3 func_201(int iParam0, var uParam1, var uParam2, int iParam3)
{
	switch (iParam0)
	{
		case 181:
...
void func_253(struct<3> Param0, var uParam3)
{
	int iVar0;
	int iVar1;
...
int func_254(struct<3> Param0, int iParam3, float fParam4)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
...
int func_260(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_264(char* sParam0, var uParam1, var uParam2)
{
...
bool func_267(var* uParam0, var uParam1, bool bParam2, var uParam3)
{
...
struct<16> func_269(var* uParam0, int iParam1, char* sParam2, bool bParam3)
{
	struct<16> Var0;
...
int func_270(var* uParam0, int iParam1, int iParam2, bool bParam3)
{
	if (bParam3 && iParam1 < DATAFILE::DATAARRAY_GET_COUNT(uParam0))
	{
...
float func_271(var* uParam0, int iParam1, float fParam2, bool bParam3)
{
	if (bParam3 && iParam1 < DATAFILE::DATAARRAY_GET_COUNT(uParam0))
	{
...
Vector3 func_272(var* uParam0, int iParam1, struct<3> Param2, bool bParam5)
{
...
int func_273(var* uParam0, int iParam1, int iParam2, bool bParam3)
{
	if (bParam3 && iParam1 < DATAFILE::DATAARRAY_GET_COUNT(uParam0))
	{
...
int func_274(int iParam0, char* sParam1, int iParam2)
{
...
float func_276(int iParam0, char* sParam1, float fParam2)
{
...
int func_277(int iParam0, char* sParam1, int iParam2)
{
...
int func_279(var* uParam0, int iParam1, int iParam2, bool bParam3)
{
	if (bParam3 && iParam1 < DATAFILE::DATAARRAY_GET_COUNT(uParam0))
	{
		return DATAFILE::DATAARRAY_GET_INT(uParam0, iParam1);
...
struct<16> func_280(int iParam0, char* sParam1, char* sParam2)
{
	struct<16> Var0;
...
int func_281(int iParam0, char* sParam1)
{
	if (!func_275(iParam0))
	{
		return 0;
...
void func_282(var uParam0, int iParam1, char* sParam2)
{
	if (!func_275(iParam1))
	{
		return;
...
char* func_284(int iParam0, var uParam1, int iParam2)
{
	char* sVar0;
...
int func_373(struct<2> Param0, var uParam2, var uParam3, var uParam4)
{
	int iVar0;
...
int func_386(int iParam0)
{
	...
	if (Global_262145.f_8754 > 0 && Global_262145.f_8754 <= 21)
	{
		...
		{
			iVar0 = 0;
			while (iVar0 < Global_262145.f_8754)
			{
...
int func_393()
{
	...
	{
		iVar1 = 0;
		while (iVar1 < Global_262145.f_8754)
		{
	...
	switch (Local_236[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_2)
	{
		case 0:
			if (Global_2698947.f_2 >= 4 && Global_2698947.f_2 != 8)
			{
				if (func_370(1))
				{
					MISC::SET_BIT(&(Local_236[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), false);
					MISC::CLEAR_BIT(&(Local_236[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), true);
				}
				...
				else
				{
					...
					{
						MISC::CLEAR_BIT(&uLocal_205, true);
						func_464(4);
		...
		case 4:
			if (func_465(PLAYER::PLAYER_ID(), 0))
			{
				...
				{
					func_464(8);
					MISC::CLEAR_BIT(&(Local_236[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), false);
			...
			else
			{
				...
				if (!func_465(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						MISC::SET_BIT(&uLocal_205, true);
					}
					func_464(0);
					MISC::SET_BIT(&(Local_236[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), true);
					MISC::CLEAR_BIT(&(Local_236[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 4);
				}
			}
			break;
		...
		case 5:
			...
			{
				MISC::CLEAR_BIT(&(Global_2738587.f_206.f_1), true);
...
int func_396(struct<17> Param0, var uParam17, var uParam18, var uParam19, var uParam20, bool bParam21)
{
	char cVar0[32];
	bool bVar8;
	int iVar9;
...
void func_402()
{
	if (Global_2650416.f_84.f_2 == 1)
	{
		...
		{
			if (((Global_262145.f_45 * 120000) - func_423(&(Global_2698947.f_177), 0, 0)) < 360000)
			{
				if (!BitTest(Global_2738587.f_206.f_1, 1))
				{
					if (func_409(31, 0, 0) && !func_408())
					{
						...
						{
							func_403("ACD_TSCH", Global_262145.f_45, 0);
						}
						else
						{
							func_403("ACD_TSCH", 3, 0);
						}
					}
					MISC::SET_BIT(&(Global_2738587.f_206.f_1), true);
				}
			}
			else if (((Global_262145.f_45 * 120000) - func_423(&(Global_2698947.f_177), 0, 0)) < 600000)
			{
				if (!BitTest(Global_2738587.f_206.f_1, 2))
				{
					if (func_409(31, 0, 0) && !func_408())
					{
						func_403("ACD_TSCH", 5, 0);
					}
					MISC::SET_BIT(&(Global_2738587.f_206.f_1), 2);
				}
			}
			else if (((Global_262145.f_45 * 120000) - func_423(&(Global_2698947.f_177), 0, 0)) < 1200000)
			{
				if (!BitTest(Global_2738587.f_206.f_1, 3))
				{
					if (func_409(31, 0, 0) && !func_408())
					{
						func_403("ACD_TSCH", 10, 0);
					}
...
void func_404(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	int iVar0;
...
int func_432(struct<3> Param0, struct<3> Param3)
{
	struct<3> Var0;
...
void func_482(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_481();
