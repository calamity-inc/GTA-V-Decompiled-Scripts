...
int func_49(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)
{
	int iVar0;
	int iVar1;
...
int func_50(int iParam0)
{
	...
	Global_2707308 = { func_54(iParam0) };
...
int func_55(int iParam0, int iParam1)
{
	...
	{
		Global_2707308 = { func_54(iParam0) };
		Global_2707321 = { func_54(iParam1) };
...
Vector3 func_56(struct<3> Param0, float fParam3, struct<2> Param4, float fParam6)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_116(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_98();
