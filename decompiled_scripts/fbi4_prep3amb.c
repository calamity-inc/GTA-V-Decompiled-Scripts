...
void func_1(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_112026) && !BitTest(uLocal_105, 15))
			{
				MISC::SET_BIT(&uLocal_105, 15);
				HUD::CLEAR_HELP(true);
			}
		}
		else if ((HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_112026) && !BitTest(uLocal_105, 15))
		{
			MISC::SET_BIT(&uLocal_105, 15);
			HUD::CLEAR_HELP(true);
		}
...
void func_177()
{
	if ((BitTest(uLocal_105, 0) && Global_43052 == 15) && !func_209())
	{
		if (iLocal_38 == 0)
		{
			if (!BitTest(uLocal_105, 1))
...
int func_190(struct<3> Param0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam3 || BitTest(Global_113386.f_7229.f_17[iVar0], 0))
			{
...
void func_224()
{
	...
	if (((((((Global_43052 == 15 && iLocal_37 != 3) && BitTest(uLocal_105, 5)) && !func_209()) && Global_78316 == -1) && !func_234()) && !func_86(9)) || func_105(35))
	{
		func_233();
		func_231();
		switch (iLocal_39)
