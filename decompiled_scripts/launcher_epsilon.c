...
int func_144(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
	...
	if (*iParam1)
	{
		switch (*uParam0)
		{
			case 15:
				...
				func_176("BADSUIT_HELP", "OUTFIT_P0_11", -1);
				*iParam1 = 0;
				break;
			
			case 16:
				func_498("Need robes and $ to launch Epsilon 8...");
				func_175("NOCASH_HELP", "OUTFIT_P0_11", 50000, -1);
				*iParam1 = 0;
				break;
...
void func_176(char* sParam0, char* sParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam1);
...
int func_180(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_323(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_342(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_353(char* sParam0, int iParam1, bool bParam2)
{
	Global_21726 = 0;
...
var func_357(int iParam0, int iParam1)
{
...
void func_364(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_368(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
...
void func_371(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_375(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
...
bool func_388(int iParam0, int iParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_390(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_392(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_393(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_394(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
int func_441(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			func_444(&(uParam0->f_35[1]), iVar0[1], -697.3215f, 39.0406f, 42.86736f, -66.98854f);
			...
			func_442(&(uParam0->f_28[0]), iVar0[2], -726.4555f, 33.33568f, 43.22695f, -147.8099f, 26);
			...
			func_442(&(uParam0->f_28[1]), iVar0[2], -666.5512f, 49.19759f, 42.07154f, -171.6803f, 26);
...
void func_442(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_443(iParam0);
...
int func_448(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			func_442(&(uParam0->f_28[0]), iVar0[1], -2881.755f, 3188.125f, 10.1136f, 254.1723f, 26);
...
int func_450(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_451(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_454(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
struct<6> func_466(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
bool func_473(int iParam0, char* sParam1)
{
...
int func_479(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_480(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
void func_487(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_496(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
