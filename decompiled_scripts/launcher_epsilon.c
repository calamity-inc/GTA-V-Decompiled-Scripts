...
void __EntryFunction__()
{
	...
	uLocal_92 = func_498(60);
	uLocal_93 = func_498(14);
	iLocal_96 = -1;
	...
	if (!func_476(&iVar65, &Var0, Var61, 5f))
	{
		func_475();
	...
	if (Var0.f_0 == 11)
	{
		func_433(&uLocal_98, 3, Var0.f_28[0], "MARNIE", 0, 1);
	}
	if (Var0.f_0 == 12)
	{
		func_433(&uLocal_98, 4, Var0.f_28[0], "MARNIE", 0, 1);
		func_433(&uLocal_98, 5, Var0.f_28[1], "JIMMYBOSTON", 0, 1);
	...
	if (Var0.f_0 == 16)
	{
		func_433(&uLocal_98, 4, Var0.f_28[0], "EPSGUARD5", 0, 1);
		func_433(&uLocal_98, 5, Var0.f_28[1], "EPSGUARD6", 0, 1);
	}
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		else if (Var0.f_0 == 11)
		{
			if (func_392(Var0.f_28[0]))
			{
				...
				{
					func_391(&Var0, Var61, "EPS3AUD", "EP3_AMB", 3, "MARNIE", 500, 1101004800);
				}
		...
		else if (Var0.f_0 == 13)
		{
			if (func_392(Var0.f_28[0]))
			{
				if (!PED::IS_PED_FLEEING(Var0.f_28[0]) && !PED::IS_PED_RAGDOLL(Var0.f_28[0]))
				{
					if (func_365(&Var0, Var61, "EPS5AUD", "EP5_AMB", 4, "MARNIE", 1500))
					{
		...
		func_347(Var0.f_0);
		func_339(&iLocal_96, &(Var0.f_9), Var61);
		func_338(&Var0, &iVar64);
		if (func_323(&Var0, 0))
		{
			if (!func_174(&Var0))
			{
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar28 = { func_238(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_256(iVar10, 14, uVar28[iVar1], -1) };
	...
	{
		uVar69 = { func_238(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_256(iVar10, 14, uVar69[iVar1], -1) };
			func_228(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_251(14);
			if (Global_78128 == 1)
			{
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_209(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar22 = { func_238(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
...
int func_235(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 12)
	{
		...
		while (iVar15 < iVar16)
		{
			...
			if (Var0.f_1 == iParam1)
			{
				return (func_236(iParam0) + iVar15);
			}
			iVar15++;
		}
	}
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
		{
			return (func_232(iParam0) + iVar17);
		}
	}
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_231(iParam0, func_218(iParam2)) + iVar18);
		}
	}
	return -99;
}
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_243(Var16.f_2)] = func_235(iParam1, Var16.f_0, func_243(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_258(int iParam0)
{
	...
	func_259(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_265(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_259(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_259(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_320(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (iVar0 == 1)
				{
					...
					while (iVar1 <= 14)
					{
						if ((uVar3[iVar1] != -99 && iVar1 != 12) && iVar1 != 14)
						{
							...
							{
								uVar20 = { func_238(iParam0, uVar3[iVar1]) };
								iVar2 = 0;
								while (iVar2 <= 8)
								{
									func_320(iParam0, 14, uVar20[iVar2], 1, 1);
									func_321(iParam0, 14, uVar20[iVar2], 1);
									iVar2++;
								}
							}
						}
					...
					switch (iParam1)
					{
						...
						case 11:
							if (iParam2 >= 9 && iParam2 <= 24)
							{
								...
								func_320(iParam0, 11, iVar30, 1, 0);
							}
							else if (iParam2 >= 25 && iParam2 <= 40)
							{
						...
						case 14:
							if (iParam2 >= 64 && iParam2 <= 79)
							{
								...
								func_320(iParam0, 14, iVar30, 1, 0);
							}
							break;
					}
					break;
...
int func_321(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	Global_78130[1 /*14*/] = { func_256(iParam0, iParam1, iParam2, -1) };
	if (BitTest(Global_78130[1 /*14*/].f_6, 0) && !BitTest(Global_78130[1 /*14*/].f_6, 6))
	{
...
void func_339(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
float func_343(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_348()
{
	switch (iLocal_97)
	{
		...
		case 1:
			...
			{
				if (func_349(&uLocal_98, "EPS8AU", "EPS8_AMB1", 7, 0, 0, 0))
				{
					iLocal_97 = 2;
				}
			}
			...
			{
				if (func_349(&uLocal_98, "EPS8AU", "EPS8_AMB2", 7, 0, 0, 0))
				{
					iLocal_97 = 2;
				}
			}
...
void func_361(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_362(int iParam0)
{
	if (func_392(iParam0->f_28[0]))
	{
		switch (iLocal_272)
		{
			...
			case 2:
				if (func_343(iParam0->f_28[0], Local_274[iLocal_273 /*3*/], 1) <= 1.2f)
				{
					iLocal_272 = 3;
...
int func_365(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_329(2))
	{
		if (!func_364())
		{
			if (((func_392(PLAYER::PLAYER_PED_ID()) && func_392(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_343(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_433(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				func_368(&uVar0, cParam4, sParam5, 7, 0, 0);
				uParam0->f_60 = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_366(sParam5))
		{
			if (func_392(PLAYER::PLAYER_PED_ID()))
			{
...
void func_368(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_369()
{
	switch (iLocal_97)
	{
		...
		case 1:
			if (func_343(PLAYER::PLAYER_PED_ID(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_264 == 0)
			{
				if (func_349(&uLocal_98, "EPS4AUD", "EPS4_AMBJ", 8, 0, 0, 0))
				{
					iLocal_97 = 2;
					iLocal_264 = 1;
				}
...
int func_372(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
...
int func_389(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_391(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_392(PLAYER::PLAYER_PED_ID()) && func_392(uParam0->f_28[0])) && !func_364()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_343(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_433(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_368(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_410()
{
	...
	{
		func_349(&uLocal_98, "EPS8AU", "EPS8_AMA1", 8, 0, 0, 0);
	}
	else
	{
		func_349(&uLocal_98, "EPS8AU", "EPS8_AMA2", 8, 0, 0, 0);
	}
}
...
int func_421(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_439(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_440(iParam0);
...
int func_445(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_443(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar5))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_447(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_448(iParam0, bParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_448(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_453(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_454(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_447(&(uParam0->f_28[0]), 60, Var3, fVar6, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
...
bool func_470(int iParam0, char* sParam1)
{
...
int func_476(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_477((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_477((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_477(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_478(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_478(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_493(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
