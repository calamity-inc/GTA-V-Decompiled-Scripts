...
int func_173(char* sParam0, int iParam1)
{
	int iVar0;
	char* sVar1;
	int iVar33;
	...
	if (*iParam1)
	{
		switch (*uParam0)
		{
			case 15:
				...
				func_181("BADSUIT_HELP", "OUTFIT_P0_11", -1);
				*iParam1 = 0;
				break;
			
			case 16:
				func_503("Need robes and $ to launch Epsilon 8...");
				func_180("NOCASH_HELP", "OUTFIT_P0_11", 50000, -1);
				*iParam1 = 0;
				break;
...
void func_180(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
...
void func_181(char* sParam0, char* sParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam1);
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_238(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_238(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_238(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("hat"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_238(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_347(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_369(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_373(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
...
void func_376(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_380(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
...
bool func_382(int iParam0, float fParam1)
{
...
int func_394(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_395(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_396(int iParam0, float fParam1)
{
	var uVar0;
	struct<3> Var1;
...
int func_397(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_398(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_399(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
int func_427(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_446(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			func_449(&(uParam0->f_35[1]), iVar0[1], -697.3215f, 39.0406f, 42.86736f, -66.98854f);
			...
			func_447(&(uParam0->f_28[0]), iVar0[2], -726.4555f, 33.33568f, 43.22695f, -147.8099f, 26);
			...
			func_447(&(uParam0->f_28[1]), iVar0[2], -666.5512f, 49.19759f, 42.07154f, -171.6803f, 26);
...
void func_447(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_448(iParam0);
...
void func_449(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_450(iParam0);
...
int func_453(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			func_447(&(uParam0->f_28[0]), iVar0[1], -2881.755f, 3188.125f, 10.1136f, 254.1723f, 26);
...
int func_455(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_456(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_461(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
struct<6> func_471(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
int func_484(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_485(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
