...
void func_6()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1949771, &Var0, 6131);
	}
	else
	{
		Global_1949771 = { Var0 };
...
void func_7()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1948833, &Var0, 886);
	}
	else
	{
		Global_1948833 = { Var0 };
...
void func_8()
{
	...
	else
	{
		...
		if (Global_2672854)
		{
			MISC::COPY_SCRIPT_STRUCT(&Global_1948680, &Var0, 151);
		}
		else
		{
			Global_1948680 = { Var0 };
...
void func_9()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2707358, &Var0, 91);
	}
	else
	{
		Global_2707358 = { Var0 };
...
void func_10()
{
	...
	Var0.f_5104.f_5 = -1;
	Var0.f_5110 = -1;
	uVar5111 = Global_1943520.f_3640;
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1943520, &Var0, 5111);
	}
	else
	{
		Global_1943520 = { Var0 };
	}
	Global_1943520.f_3640 = uVar5111;
}
...
void func_11()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2696626, &Var0, 3);
	}
	else
	{
		Global_2696626 = { Var0 };
...
void func_12()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2696212, &Var0, 328);
	}
	else
	{
		Global_2696212 = { Var0 };
...
void func_13()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2748997, &Var0, 182);
	}
	else
	{
		Global_2748997 = { Var0 };
...
void func_14()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2747127, &Var0, 1668);
	}
	else
	{
		Global_2747127 = { Var0 };
...
void func_15()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2657219, &Var0, 581);
	}
	else
	{
		Global_2657219 = { Var0 };
...
void func_16()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2656360, &Var0, 859);
	}
	else
	{
		Global_2656360 = { Var0 };
...
void func_17()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2656135, &Var0, 225);
	}
	else
	{
		Global_2656135 = { Var0 };
...
void func_18()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2655925, &Var0, 210);
	}
	else
	{
		Global_2655925 = { Var0 };
...
void func_19()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2655268, &Var0, 657);
	}
	else
	{
		Global_2655268 = { Var0 };
...
void func_20()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2657800, &Var0, 171);
	}
	else
	{
		Global_2657800 = { Var0 };
...
void func_21()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_4521801, &Var0, 982);
	}
	else
	{
		Global_4521801 = { Var0 };
...
void func_23()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2635563, &Var0, 3252);
	}
	else
	{
		Global_2635563 = { Var0 };
...
void func_24()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2647061, &Var0, 1877);
	}
	else
	{
		Global_2647061 = { Var0 };
...
void func_27()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2749864, &Var0, 1075);
	}
	else
	{
		Global_2749864 = { Var0 };
...
void func_28()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2749551, &Var0, 306);
	}
	else
	{
		Global_2749551 = { Var0 };
...
void func_29()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1668667, &Var0, 1557);
	}
	else
	{
		Global_1668667 = { Var0 };
...
void func_32()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1663588, &Var0, 188);
	}
	else
	{
		Global_1663588 = { Var0 };
...
void func_33()
{
	...
	StringCopy(&(Global_2738935.f_268), "", 24);
	StringCopy(&(Global_2738935.f_274), "", 24);
	StringCopy(&(Global_2738935.f_4716), "", 64);
	iVar0 = 0;
	while (iVar0 <= (21 - 1))
	{
		StringCopy(&(Global_2738935.f_4732[iVar0 /*16*/]), "", 64);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		StringCopy(&(Global_2738935.f_1777[iVar0 /*4*/]), "", 16);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 0)
	...
	while (iVar0 <= 2)
	{
		...
		while (iVar1 <= 2)
		{
			Global_2738935.f_1805[iVar0 /*4*/][iVar1] = 0;
			iVar1++;
		}
		iVar0++;
	}
	...
	while (iVar0 <= 15)
	{
		Global_2738935.f_820[iVar0] = 0;
		Global_2738935.f_837[iVar0] = 0;
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (8 - 1))
	{
		Global_2738935.f_896[iVar0] = 0;
		iVar0++;
	}
	...
	if (BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_370, 31))
	{
		MISC::CLEAR_BIT(&(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_370), 31);
	}
	if (BitTest(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_268.f_433.f_2, 17))
	{
	...
	while (iVar0 <= 31)
	{
		func_40(&(Global_2738935.f_388[iVar0 /*2*/]));
		func_40(&(Global_2738935.f_4521[iVar0 /*2*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 6)
	{
		func_40(&(Global_2738935.f_12[iVar0 /*2*/]));
		iVar0++;
	}
	func_39();
	func_38();
	...
	while (iVar0 < 32)
	{
		...
		while (iVar1 < 20)
		{
			Global_2738935.f_6105[iVar0 /*21*/][iVar1] = 0;
			iVar1++;
		}
		iVar0++;
	}
...
void func_34()
{
	...
	Var9.f_23 = -1;
	Var9.f_47 = 32;
	Global_2738935.f_28 = { Var9 };
	Var92.f_2 = -1;
	Var92.f_3 = -1;
	Global_2738935.f_198 = { Var92 };
	Var100.f_4.f_1 = -1;
	Var100.f_4.f_2 = -1;
	Var100.f_4.f_9 = -1;
	Var100.f_4.f_16 = -1;
	...
	Var100.f_4.f_20 = -1;
	Var100.f_25 = 2;
	Global_2738935.f_206 = { Var100 };
	Var132.f_7 = 10;
	Global_2738935.f_242 = { Var132 };
	Var150.f_6 = -1;
	Global_2738935.f_460 = { Var150 };
	Global_2738935.f_471 = uVar160;
	Global_2738935.f_481 = uVar161;
	Var162 = 12;
	Var162.f_65 = 1;
	MISC::COPY_SCRIPT_STRUCT(&(Global_2738935.f_6990), &Var162, 67);
	uVar229 = 1;
	MISC::COPY_SCRIPT_STRUCT(&(Global_2738935.f_6973), &uVar229, 2);
	Var231.f_1 = -1;
	Var231.f_2 = 1;
	MISC::COPY_SCRIPT_STRUCT(&(Global_2738935.f_7060), &Var231, 4);
	Var235 = -1;
	Var235.f_1 = 3;
	Var235.f_5 = 1;
	MISC::COPY_SCRIPT_STRUCT(&(Global_2738935.f_7078), &Var235, 7);
	Var242 = 1;
	Var242.f_1 = 1;
	MISC::COPY_SCRIPT_STRUCT(&(Global_2738935.f_7085), &Var242, 3);
}
...
void func_35()
{
	...
	Var1.f_766 = 1;
	Var1.f_767 = 1;
	uVar780 = Global_2738935.f_5249.f_369;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		uVar771[iVar0] = Global_2738935.f_5249.f_351[iVar0];
		iVar0++;
	}
	Global_2738935.f_5249 = { Var1 };
	Global_2738935.f_5249.f_369 = uVar780;
	iVar0 = 0;
	while (iVar0 < 8)
	{
		Global_2738935.f_5249.f_351[iVar0] = uVar771[iVar0];
		iVar0++;
	}
}
...
void func_36()
{
	...
	while (iVar0 <= 15)
	{
		Global_2738935.f_4085[iVar0 /*26*/] = { Var1 };
		iVar0++;
	}
}
...
void func_37()
{
	...
	while (iVar0 <= 4)
	{
		Global_2738935.f_111[iVar0 /*17*/] = { Var1 };
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 0)
	{
		Global_2738935.f_4623[iVar0 /*12*/] = { Var18 };
		iVar0++;
	}
	Var30.f_2 = -1;
	Var30.f_3 = -1;
	...
	while (iVar0 <= 0)
	{
		Global_2738935.f_1189[iVar0 /*51*/] = { Var30 };
		Global_2738935.f_1445[iVar0 /*51*/] = { Var81 };
		iVar0++;
	}
	Var132.f_1 = -1;
	Var132.f_2 = -1;
	...
	while (iVar0 <= 15)
	{
		Global_2738935.f_482[iVar0 /*21*/] = { Var132 };
		iVar0++;
	}
}
...
void func_38()
{
	...
	Global_2738935.f_2361 = { Var0 };
	Global_2738935.f_4080 = uVar1719;
}
...
void func_39()
{
	...
	Global_2738935.f_4586 = { Var0 };
	Var12.f_19 = 32;
	Global_2738935.f_1908 = { Var12 };
	Global_2738935.f_1971 = { Var73 };
	Var76 = 8;
	Global_2738935.f_1975 = { Var76 };
	Global_2738935.f_2333 = { Var434 };
	Global_2738935.f_2342 = { Var443 };
	Var462 = 1;
	Var462.f_3 = 1;
	Var462.f_6 = 1;
	Var462.f_8 = 1;
	...
	Var462.f_14 = 1;
	Var462.f_16 = 1;
	Global_2738935.f_4598 = { Var462 };
	Global_2738935.f_4617 = { Var481 };
	Var483.f_2 = -1;
	Var483.f_3 = -1;
	Var483.f_4 = -1;
	Var483.f_50 = -1;
	Global_2738935.f_1701 = { Var483 };
	Global_2738935.f_871 = uVar534;
	Var535 = 16;
	Global_2738935.f_1024 = { Var535 };
	Var700 = 5;
	Var700.f_6 = 5;
	Global_2738935.f_1758 = { Var700 };
}
...
void func_43()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1936863, &Var0, 464);
	}
	else
	{
		Global_1936863 = { Var0 };
...
void func_44()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1928958, &Var0, 35);
	}
	else
	{
		Global_1928958 = { Var0 };
...
void func_45()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_4535818, &Var0, 132);
	}
	else
	{
		Global_4535818 = { Var0 };
...
void func_53()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2652592, &Var0, 2676);
	}
	else
	{
		Global_2652592 = { Var0 };
...
void func_54()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2650436, &Var0, 2156);
	}
	else
	{
		Global_2650436 = { Var0 };
...
void func_55()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1877252, &Var0, 33);
	}
	else
	{
		Global_1877252 = { Var0 };
...
void func_57()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1680185, &Var0, 27);
	}
	else
	{
		Global_1680185 = { Var0 };
...
void func_58()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_1835505, &Var1, 643);
	}
	else
	{
		Global_1835505 = { Var1 };
...
void func_59()
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&Global_2648938, &Var0, 1498);
	}
	else
	{
		Global_2648938 = { Var0 };
...
void func_61(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1881511[iParam0 /*7*/]), &Var0, 7);
	}
	else
	{
...
void func_62(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1879750[iParam0 /*55*/]), &Var0, 55);
	}
	else
	{
...
void func_63(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1877285[iParam0 /*77*/]), &Var0, 77);
	}
	else
	{
...
void func_64(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1921352[iParam0 /*199*/]), &Var0, 199);
	}
	else
	{
...
void func_65(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1874051[iParam0 /*100*/]), &Var0, 100);
	}
	else
	{
...
void func_66(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1882632[iParam0 /*146*/]), &Var0, 146);
	}
	else
	{
...
void func_67(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1680392[iParam0 /*26*/]), &Var0, 26);
	}
	else
	{
...
void func_68(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1680242[iParam0]), &uVar0, 1);
	}
	else
	{
...
void func_69(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1845281[iParam0 /*883*/]), &Var0, 883);
	}
	else
	{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_1873538[iParam0 /*16*/]), &Var883, 16);
	}
	else
	{
		Global_1873538[iParam0 /*16*/] = { Var883 };
	}
}
...
void func_70(int iParam0)
{
	...
	if (Global_2672854)
	{
		MISC::COPY_SCRIPT_STRUCT(&(Global_2657971[iParam0 /*465*/]), &Var0, 465);
	}
	else
	{
