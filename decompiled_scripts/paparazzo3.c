...
void __EntryFunction__()
{
	...
	if (func_464())
	{
		...
		func_343(&iVar0, -257.08f, 285.27f, 90.43f, 12.52f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		func_342(&Local_83, 0, 1);
		Global_78935 = 0;
	}
	while (true)
	{
		...
		func_326(Local_83.f_9, 0, 0, 0, 0, 0);
		if (iLocal_81 == 2)
		{
			func_322();
		}
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_210(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_210(iParam0) };
...
void func_291(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar65;
...
void func_292(int iParam0, var uParam1, int iParam2)
{
	...
	func_293(iParam0, &Var2, 0, -1);
	func_293(iParam0, uParam1, iParam2, -1);
	iVar82 = 0;
	iVar83 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
...
void func_293(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
...
var func_295(int iParam0, var uParam1)
{
...
void func_310()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_146))
	{
		func_319(&iLocal_146, &(Local_83.f_41[0]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147[0]))
	{
		func_319(&(iLocal_147[0]), &(Local_83.f_41[1]));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_147[1]))
	{
		func_319(&(iLocal_147[1]), &(Local_83.f_41[2]));
	}
	func_318(&uLocal_161, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_318(&uLocal_161, 3, Local_83.f_28[0], "BEVERLY", 0, 1);
...
void func_311()
{
	...
	func_314();
	func_256(1);
	func_313(PLAYER::PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_312(1, 1, 1);
}
...
int func_313(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_318(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_324(char* sParam0, bool bParam1)
{
	func_325(sParam0);
	func_480(bParam1);
}
...
void func_326(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_328(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
int func_337(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (Global_78944)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_308(0)) || func_338(1))
			{
			}
			else
			{
...
void func_343(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_464() || !func_457())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_416(iParam12, 0);
			while (!func_344(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_344(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_407(iParam0, &(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_407(iParam0, &(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_345(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_350(*iParam1, 0, &uVar0))
		{
			func_349(iParam1, &(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113810.f_20121[iParam0 /*43*/].f_31 = func_348(*iParam1);
				...
				func_346(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113810.f_20121[iParam0 /*43*/].f_1));
				...
				func_346(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113810.f_20121[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_346(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_347(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_347(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_350(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_383(iVar0, bParam1, uParam2) && !func_382(PLAYER::PLAYER_ID())) && !func_363(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_359(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_356(iParam0)) && !bVar1) && !(func_355(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_352(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_351(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_352(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			...
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_357(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_358(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_359(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_360(int iParam0)
{
	...
	if ((((!func_362(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_361(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_364(int iParam0)
{
	...
	if (func_367(PLAYER::PLAYER_ID()) && ((((!func_360(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_365(int iParam0)
{
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_356(iParam0)) || func_366(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_367(int iParam0)
{
	...
	if (func_382(iParam0) && Global_2657704[iParam0 /*463*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
	...
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_370(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_369(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_380(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[iParam0 /*463*/].f_321.f_10 != func_224())
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_381(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[iParam0 /*463*/].f_321.f_10 != func_224())
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_382(int iParam0)
{
	if (iParam0 != func_224())
	{
		if (func_354(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_353(Global_2657704[iParam0 /*463*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_383(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_359(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
void func_385(int iParam0, int iParam1)
{
	...
	func_386(iParam0, &(Global_113810.f_32752.f_5510));
}
...
void func_386(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_349(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_77), func_387(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_403(iParam0) != 145) || func_402(iParam0)) || func_401(iParam0)) || func_351(iParam0)) || func_400(iParam0)) || !func_390(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_401(iParam0))
		{
		}
...
int func_407(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_412(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_379(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_410(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_410(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_409(iParam0);
	if (func_408(*iParam0))
	{
...
int func_410(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_411(iParam0, 38) + 1;
		iVar1 = func_411(iParam0, 24) + 1;
...
int func_411(int iParam0, int iParam1)
{
	...
	while (iVar0 >= 0 && func_412(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
{
	if (!func_413() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_416(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98144[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98144[iVar0]) == func_417(iParam0, iParam1))
				{
...
void func_418(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_423(&(Global_77479.f_555[0 /*21*/]), iVar0))
		{
...
int func_421(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_422(&(Global_113810.f_32752.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_391(Global_113810.f_32752.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_423(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_424(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_424(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_424(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_426(&(Global_107357.f_2890), Param0, fParam3, 0);
}
...
int func_428(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_430(iParam0, Global_77479.f_139[38], 0))
			{
				func_419(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_430(iParam0, Global_77479.f_139[43], 1))
			{
				func_419(43);
				return 1;
			}
...
void func_431(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_387(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_387(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_387(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_387(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_387(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_387(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_387(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_387(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_387(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_387(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_387(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_387(4)))
			{
			}
			else
			{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_387(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_387(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (bParam3)
		{
			func_407(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_387(iVar7 + 1)))
				{
		...
		if ((((func_432() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_361(1)))
		{
...
int func_450(var uParam0)
{
	...
	if (!func_391(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
...
int func_458(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 1:
			if (!func_463(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			...
			{
				if (func_460(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
			...
			if (func_233(uParam0->f_28[0]))
			{
				...
				{
					func_459(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
int func_460(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_461(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_461(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_465()
{
	...
	func_478(&(iLocal_147[0]), 0);
	func_478(&(iLocal_147[1]), 0);
	func_478(&iLocal_145, 0);
	func_478(&iLocal_146, 0);
	...
	HUD::CLEAR_PRINTS();
	func_476(&(Local_83.f_28[0]), 1, 0, 1);
	func_466(&Local_83, 1, 0, 0);
...
int func_484()
{
	...
	iVar0 = func_485(&(Global_100833.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
