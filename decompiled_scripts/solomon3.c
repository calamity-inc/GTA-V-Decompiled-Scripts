...
{
	MISC::SET_BIT(&Global_32988, bParam0);
...
int func_138(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_171(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_172(iParam0, uVar1[iVar6], 1) && func_138(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
var func_181(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_204(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
									...
									if (!PED::IS_PED_INJURED(iLocal_3220))
									{
										if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_3220, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											...
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_3206) > 0.85f)
											{
												...
												OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_3218, joaat("v_ilev_ss_door5_r"), -935.641f, -2927.185f, 14.0945f, true, true, false);
...
void func_286(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7, bool bParam8)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_330(int iParam0, int iParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_331(int iParam0, int iParam1, char* sParam2, int iParam3)
{
	struct<3> Var0;
...
void func_347(struct<3> Param0, struct<3> Param3, float fParam6)
{
	bool bVar0;
	int iVar1;
...
int func_348(struct<3> Param0, struct<3> Param3, float fParam6, float fParam7)
{
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
		if (!bLocal_86)
...
int func_377(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_381(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
void func_386(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_169(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
...
int func_433(struct<3> Param0, int iParam3, int iParam4, bool bParam5)
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
