...
{
	MISC::SET_BIT(&Global_33108, bParam0);
...
void func_242(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)
{
...
int func_250(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_288(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7, bool bParam8)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_332(int iParam0, int iParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_333(int iParam0, int iParam1, char* sParam2, int iParam3)
{
	struct<3> Var0;
...
float func_343(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
void func_349(struct<3> Param0, struct<3> Param3, float fParam6)
{
	bool bVar0;
	int iVar1;
...
int func_350(struct<3> Param0, struct<3> Param3, float fParam6, float fParam7)
{
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
		if (!bLocal_86)
...
void func_369(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_383(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
void func_386(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_388(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_169(&(Global_78179.f_555[0 /*21*/]), iParam0))
	{
...
int func_391(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
int func_435(struct<3> Param0, int iParam3, int iParam4, bool bParam5)
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
