...
void func_206(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_216(struct<3> Param0, float fParam3)
{
	return func_217(&(Global_107514.f_2890), Param0, fParam3, 0);
}

int func_217(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_219(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_220(iParam0, uVar1[iVar6], 1) && func_99(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
bool func_249(struct<3> Param0, int iParam3)
{
	return func_250(Global_107514.f_2890.f_12.f_66, Param0, iParam3);
}

int func_250(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_305(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_306())
	{
...
bool func_380(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
