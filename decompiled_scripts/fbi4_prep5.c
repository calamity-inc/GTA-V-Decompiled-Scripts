...
void __EntryFunction__()
{
	...
	if (func_298())
	{
		func_297(16.5342f, -1122.583f, 27.8635f, 354.7487f, 1, 0);
	}
	func_292();
	if (func_291(0))
	{
...
int func_183(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
void func_195(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
...
int func_208(struct<3> Param0, float fParam3)
{
	return func_209(&(Global_107917.f_2890), Param0, fParam3, 0);
}

int func_209(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_211(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_212(iParam0, uVar1[iVar6], 1) && func_99(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
var func_218(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_240(struct<3> Param0, int iParam3)
{
	return func_241(Global_107917.f_2890.f_12.f_66, Param0, iParam3);
}

int func_241(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_244(char* sParam0, bool bParam1)
{
	if (!*bParam1)
	{
		func_96(sParam0, 7500, 0);
...
void func_253(char* sParam0, char* sParam1, char* sParam2)
{
...
int func_259(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
...
void func_297(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_298())
	{
...
int func_301(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_302(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_367();
...
void func_305(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
...
int func_309(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_310(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
