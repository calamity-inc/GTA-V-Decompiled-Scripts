...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<14> Var0;
...
void func_109(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	if (iParam0 == iParam5)
	{
		return;
...
Vector3 func_129(struct<3> Param0, float fParam3)
{
	float fVar0;
