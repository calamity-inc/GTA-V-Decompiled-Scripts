...
int func_2()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			fVar3 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_97771);
			switch (iLocal_224)
			{
				case 0:
					if (fLocal_141 < 0f)
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar34, Var27, true, true, false);
			...
			if (func_6(iVar0, &sVar35, &cVar51, &iVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_97771, &sVar35, &sVar68, 1000f, -8f, iVar67, 1000f);
					}
				}
			}
