...
void func_2()
{
	...
	func_3(0);
	MISC::CLEAR_BIT(&uLocal_114, false);
}
...
int func_74(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		...
		{
			if (!Global_262145.f_21763 || func_62(PLAYER::PLAYER_ID()))
			{
				return 1;
			}
		}
	...
	if ((Global_1662900[iParam0] > 0 && !func_81(iParam1)) && (!Global_262145.f_19161 || func_75(PLAYER::PLAYER_ID())))
	{
		return 1;
	}
	return 0;
...
void func_148()
{
	...
	func_150(2, 202, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202) && !BitTest(uLocal_114, 2))
	{
		func_149();
	}
	func_150(2, 203, 1);
	...
	if (PAD::IS_USING_CURSOR(2))
	{
		...
		func_150(2, 238, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 238) && !BitTest(uLocal_114, 2))
		{
			func_149();
		}
	}
...
void func_169()
{
	...
	if (BitTest(uLocal_114, 10))
	{
		if (func_183(PLAYER::PLAYER_ID(), -2, 0, 0, 0) != 1)
		{
			...
			{
				sVar1 = func_171();
				func_170("GB_BECOMEB", sVar1, func_183(PLAYER::PLAYER_ID(), -2, 0, 0, 0), -1, 1);
			}
			else if (func_62(PLAYER::PLAYER_ID()))
			{
				...
				if (func_65(PLAYER::PLAYER_ID()))
				{
					func_170("GB_BECOMEC", sVar2, func_183(PLAYER::PLAYER_ID(), -2, 0, 0, 0), -1, 1);
				}
				else
				{
					func_170("GB_BECOME", sVar2, func_183(PLAYER::PLAYER_ID(), -2, 0, 0, 0), -1, 1);
				}
			}
...
int func_191(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		bVar1 = iVar5;
		if (((!func_52(bVar1, 1, 1) || func_193(bVar1, 0)) || BitTest(Global_2657921[bVar1 /*463*/].f_199, 2)) || func_192(bVar1))
		{
		}
...
int func_200(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			if (func_206())
			{
				iVar3 = func_205(bParam0);
				if (!iVar3 == -1)
				{
					return func_203(iVar3);
				}
			}
			if ((func_202(iParam1, bParam0, iVar0, 0) && !BitTest(Global_4718592.f_15, 18)) || ((func_190(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(bParam0), 0, -1) && BitTest(Global_4718592.f_15, 23)) && !BitTest(Global_4718592.f_15, 18)))
			{
				return func_189(1);
			}
			...
			{
				return func_185(bParam1, 1, iVar0, bParam4);
			}
		}
...
bool func_202(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
void func_226(bool bParam0, int iParam1, int iParam2)
{
	struct<15> Var0;
	...
	if (bParam0)
	{
		...
		{
			func_227(82, "GB_TXTMSG_INIT2", 2, 0, 0, 0, 0, 1, 0, 1);
		}
	}
}

int func_227(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_229(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	bool bVar1;
...
void func_230(int iParam0, char* sParam1, bool bParam2, var uParam3)
{
	struct<14> Var0;
...
void func_241()
{
	if ((!func_264() && func_249()) && func_247(PLAYER::PLAYER_ID()))
	{
		if (func_90())
		{
			func_242("GB_INFO_MC_L", 0);
		}
		else
		{
			func_242("GB_INFO_LFG", 0);
		}
	}
}
...
void func_243(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	int iVar0;
...
struct<16> func_265(int iParam0)
{
...
void func_267(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15)
{
...
void func_274(bool bParam0, bool bParam1, int iParam2, var uParam3)
{
	var uVar0;
	int iVar6;
	int iVar7;
...
void func_329(int iParam0, int iParam1, char* sParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	char cVar2[32];
...
var func_330(var uParam0, var uParam1)
{
	return unk_0xD69CE161FE614531(3, uParam0, func_331(uParam1));
}
...
struct<16> func_332(int iParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	struct<16> Var2;
...
var func_336(int iParam0, var uParam1)
{
	return unk_0xD69CE161FE614531(0, iParam0, func_331(uParam1));
}
...
void func_340(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	bVar1 = (iParam0 % 32);
	MISC::CLEAR_BIT(&(Global_2738587.f_5234.f_7[iVar0]), bVar1);
}
...
void func_366(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
{
	return unk_0xD69CE161FE614531(2, uParam0, func_331(uParam1));
}
...
struct<16> func_371(int iParam0)
{
	struct<16> Var0;
...
void func_377(char* sParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_379(var uParam0, int iParam1, bool bParam2, char* sParam3, bool bParam4, bool bParam5)
{
	struct<8> Var0;
	int iVar16;
	char* sVar17;
...
int func_381(char* sParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		...
		while (iVar1 < 32)
		{
			...
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1886967[bVar0 /*609*/].f_10.f_105)) && MISC::ARE_STRINGS_EQUAL(&(Global_1886967[bVar0 /*609*/].f_10.f_105), sParam0))
				{
					return 1;
				}
			}
...
int func_383(int iParam0, char* sParam1)
{
...
int func_384(char* sParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_385(int iParam0, char* sParam1)
{
	switch (iParam0)
	{
		case 0:
...
struct<16> func_393(int iParam0)
{
	struct<16> Var0;
...
struct<16> func_394(int iParam0)
{
	struct<16> Var0;
