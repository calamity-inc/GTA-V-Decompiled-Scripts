...
void func_2()
{
	...
	func_3(0);
	MISC::CLEAR_BIT(&uLocal_111, false);
}
...
int func_73(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		...
		{
			if (!Global_262145.f_21553 || func_62(PLAYER::PLAYER_ID()))
			{
				return 1;
			}
		}
...
void func_147()
{
	...
	func_149(2, 202, 1);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202) && !BitTest(uLocal_111, 2))
	{
		func_148();
	}
	func_149(2, 203, 1);
	...
	if (PAD::IS_USING_CURSOR(2))
	{
		...
		func_149(2, 238, 1);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 238) && !BitTest(uLocal_111, 2))
		{
			func_148();
		}
	}
...
int func_181(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_219(PLAYER::PLAYER_ID()) || (func_218() && func_217())) && !BitTest(Global_2793046.f_4690, 31)) && !bParam4)
	{
		iVar1 = func_216();
...
int func_198(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_200(iParam1, bParam0, iVar0, 0) && !BitTest(Global_4718592.f_15, 18)) || ((func_188(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(bParam0), 0, -1) && BitTest(Global_4718592.f_15, 23)) && !BitTest(Global_4718592.f_15, 18)))
			{
				return func_187(1);
			}
...
void func_225(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	if (!func_117())
	{
		return;
...
void func_228(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
void func_229(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_288(int iParam0, int iParam1, char* sParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	char cVar2[32];
...
struct<16> func_291(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2849801[iParam0 /*3*/][func_289(iParam2)];
	iVar1 = Global_2849801[iParam1 /*3*/][func_289(iParam2)];
...
int func_318(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 14192)
	{
		...
		iVar0 = Global_2805029[iParam0 /*3*/][func_289(iParam1)];
		if (STATS::STAT_GET_INT(iVar0, &uVar1, -1))
		{
			return uVar1;
		}
...
int func_336(char* sParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		...
		while (iVar1 < 32)
		{
			...
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894573[bVar0 /*608*/].f_10.f_105)) && MISC::ARE_STRINGS_EQUAL(&(Global_1894573[bVar0 /*608*/].f_10.f_105), sParam0))
				{
					return 1;
				}
			}
...
int func_360(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
