#region Local Var
	...
	var uLocal_90 = 0;
	struct<4> Local_91[8];
	int iLocal_124[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	var uLocal_133[1] = { 0 };
	var uLocal_135 = 0;
...
int func_23()
{
	...
	if (!func_306(0))
	{
		if (func_113(func_252(PLAYER::PLAYER_ID()), &Local_136, &(Local_136.f_3)))
		{
			func_112(0);
		}
	}
	...
	{
		MISC::CLEAR_AREA(Local_136, 5f, true, false, false, false);
		if (func_107(&(Local_83.f_6), func_111(), Local_136, Local_136.f_3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			iVar0 = func_16();
...
int func_107(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	float fVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		*uParam0 = NETWORK::VEH_TO_NET(iVar1);
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_108(Param2, fParam5, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_108(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (func_109(PLAYER::PLAYER_ID(), Param0, iParam4) > -1)
	{
...
int func_109(int iParam0, struct<3> Param1, int iParam4)
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_113(struct<3> Param0, var uParam3, var uParam4)
{
	...
	Var0.f_4 = 1000f;
	Var0.f_27 = 1;
	if (func_114(Param0, 0f, 0f, 0f, func_111(), 1, uParam3, uParam4, &Var0))
	{
		return 1;
	}
	return 0;
...
int func_114(struct<3> Param0, struct<3> Param3, int iParam6, int iParam7, var uParam8, var uParam9, var uParam10)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (Global_2667225.f_676 == 0)
	{
		...
		func_236();
		func_246();
		if (!uParam10->f_27 || (((((((func_235(Param0, 1, 1133903872) && !uParam10->f_28) && !Global_2815059.f_924) && !Global_2815059.f_913) && !Global_2815059.f_921) && !Global_2815059.f_925) && !Global_2815059.f_933) && !Global_2815059.f_945))
		{
			func_216(Param0, iParam6);
		}
		if (func_202(Param0))
		{
			func_216(Param0, iParam6);
	...
	switch (Global_2667225.f_676)
	{
		case 2:
			if (PATHFIND::ARE_NODES_LOADED_FOR_AREA((Param0.f_0 - 100f), (Param0.f_1 - 100f), (Param0.f_0 + 100f), (Param0.f_1 + 100f)))
			{
				...
				if (((uParam10->f_3 && func_196(Param0, fVar2, fVar3, fVar4, 1f, 0, 0, 0, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0)) && !uParam10->f_7) && !func_194(Param0, *uParam9, iParam6, PLAYER::PLAYER_ID(), 0))
				{
					Global_2667225.f_683 = { Param0 };
				...
				func_138(Global_2667225.f_683, Global_2667225.f_686, iParam6, &(Global_2667225.f_673));
			...
			if (Global_2667225.f_671)
			{
				if (Global_2667225.f_673 == Global_2667225.f_674)
				{
					if (Global_2667225.f_672)
					{
						...
						{
							if (func_137(Global_2667225.f_683, Global_2667225.f_686, iParam6, 1, 1036831949))
							{
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2667225.f_700) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2667225.f_699))
					{
						if (NETWORK::NETWORK_ENTITY_AREA_HAVE_ALL_REPLIED(Global_2667225.f_699))
						{
							...
							{
								if (func_133(Global_2667225.f_683, Global_2667225.f_686, iParam6, PLAYER::PLAYER_ID(), 0) || func_116(Global_2667225.f_683, Global_2667225.f_686, iParam6, 1, 0, 0, 0, 1, 0))
								{
									func_135(Global_2667225.f_683, 0);
									func_134(-1);
								}
		...
		case 5:
			...
			func_140(&(Global_2667225.f_683), &(Global_2667225.f_686), &Var66);
...
int func_116(struct<3> Param0, float fParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_326(iVar1, bParam5, bParam6))
			{
				if (NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam8 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_132(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1 && iParam10) && bParam7) && func_127(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								...
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(iVar1), false))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(iVar3) && !ENTITY::IS_ENTITY_DEAD(iVar3, false))
									{
										...
										if (func_126(Param0, fParam3, iParam4, Var5, fVar8, iVar4, 0))
										{
											return 1;
										}
									}
								...
								if (func_117(func_252(iVar1), Param0, fParam3, iParam4, fVar2))
								{
									return 1;
								}
							}
...
int func_117(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7, float fParam8)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	if (SYSTEM::VDIST(Param0, Param3) < func_125(iParam7, 1008981770))
	{
		func_118(Param3, fParam6, iParam7, &Var0, &Var3, &fVar6, fParam8);
...
void func_118(struct<3> Param0, float fParam3, int iParam4, var uParam5, var uParam6, var uParam7, float fParam8)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	Var0 = { 0f, 1f, 0f };
	func_124(&Var0, 0f, 0f, fParam3);
	Var0 = { Var0 / FtoV(SYSTEM::VMAG(Var0)) };
	func_119(iParam4, &Var3, &Var6, 1086324736, 1080033280, 1077936128);
...
void func_119(int iParam0, var* uParam1, var* uParam2, float fParam3, float fParam4, float fParam5)
{
	int iVar0;
...
void func_124(var uParam0, struct<3> Param1)
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
float func_125(int iParam0, float fParam1)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	func_119(iParam0, &Var0, &Var3, 1086324736, 1080033280, 1077936128);
	Var6 = { Var3 - Var0 };
	fVar9 = (SYSTEM::SQRT(((((Var6.f_0 * 0.5f) * (Var6.f_0 * 0.5f)) + ((Var6.f_1 * 0.5f) * (Var6.f_1 * 0.5f))) + ((Var6.f_2 * 0.5f) * (Var6.f_2 * 0.5f)))) + fParam1);
	return fVar9;
}

int func_126(struct<3> Param0, float fParam3, int iParam4, struct<3> Param5, float fParam8, int iParam9, int iParam10)
{
	if (func_117(Param0, Param5, fParam8, iParam9, 1036831949))
	{
		return 1;
	}
	func_118(Param0, fParam3, iParam4, &Global_1976933, &(Global_1976933.f_3), &(Global_1976933.f_6), 1036831949);
	func_118(Param5, fParam8, iParam9, &(Global_1976933.f_7), &(Global_1976933.f_10), &(Global_1976933.f_13), 1036831949);
...
int func_133(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar0 < 32)
	{
		...
		{
			iVar1 = iVar0;
			if (func_326(iVar1, 0, 1) && func_326(iParam5, 0, 1))
			{
				if (Global_2680265.f_261[iVar0])
				{
					if (func_117(Global_2680265.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949))
					{
						return 1;
					}
				}
				else if (func_117(func_252(iVar1), Param0, fParam3, iParam4, 1036831949))
				{
					return 1;
				}
			}
			...
			else if (func_326(iVar1, 0, 0))
			{
				...
				{
					if (func_117(func_252(iVar1), Param0, fParam3, iParam4, 1036831949))
					{
						return 1;
					}
				}
...
void func_135(struct<3> Param0, int iParam3)
{
	...
	if (iParam3 == 0 && func_136(Param0, 0.01f))
	{
		return;
	}
...
int func_137(struct<3> Param0, float fParam3, int iParam4, bool bParam5, float fParam6)
{
	struct<3> Var0;
	struct<3> Var3;
	var uVar6;
	...
	else
	{
		...
		while (iVar7 < 3)
		{
			...
			{
				func_118(Param0, fParam3, iParam4, &Var0, &Var3, &uVar6, fParam6);
				if (bParam5)
				{
...
void func_138(struct<3> Param0, var uParam3, int iParam4, var uParam5)
{
	struct<8> Var0;
	
	*uParam5 = func_139(&Param0, &uParam3, &iParam4);
	Var0.f_0 = 495813132;
	Var0.f_1 = PLAYER::PLAYER_ID();
	Var0.f_2 = { Param0 };
	Var0.f_5 = uParam3;
		...
		if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar8))
		{
																			...
																			if (!uParam2->f_15 || !func_185(uParam2->f_35, &Var1, &(uParam2->f_38), &(uParam2->f_45), 0, 1))
																			{
																				if (uParam2->f_8)
																				{
																					...
																					if (!func_158(Var1, fVar4, uParam2->f_34))
																					{
																						if (uParam2->f_3 > 7f)
																						{
																							if (func_196(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, uParam2->f_3, 0, 0, 0, 0))
																							{
																								iVar23 = 1;
																							}
																						}
																						else if (func_196(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_116(Var1, fVar4, uParam2->f_34, 1, 1, 0, 0, 0, 0))
																						{
																							iVar23 = 1;
																						}
																					}
			...
			if (iVar0 >= (40 + iVar15) || iVar0 >= 100)
			{
				...
				else
				{
					...
					{
						func_146(iVar15, *uParam0, &iVar0, &Var1, &fVar4, uParam2, bVar10, iVar9, iVar5, fVar13, fVar14, bVar11);
						Var31 = { Var1 };
						fVar34 = fVar4;
						if (!uParam2->f_50)
						{
						...
						if (func_185(uParam2->f_35, &Var31, &(uParam2->f_38), &(uParam2->f_45), bVar35, 1) || func_180(&Var31, bVar35))
						{
							if (!uParam2->f_50)
							{
								uParam2->f_33 = 0;
...
void func_142(var uParam0, var uParam1, var uParam2, struct<3> Param3)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
{
	if (func_145(Param0, fParam3, iParam4, iParam5, 0) || func_144(Param0, iParam4, iParam6))
	{
		return 1;
	}
	return 0;
...
int func_145(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < 32)
	{
		if (!iParam4 == iVar0 || iParam5 == 1)
		{
			...
			if (bParam6)
			{
				if (func_326(iVar1, 0, 1) && func_326(iParam4, 0, 1))
				{
...
void func_146(int iParam0, struct<3> Param1, int iParam4, var* uParam5, float* fParam6, var uParam7, bool bParam8, int iParam9, int iParam10, float fParam11, float fParam12, bool bParam13)
{
	int iVar0;
...
int func_158(struct<3> Param0, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1) && !ENTITY::IS_ENTITY_DEAD(iVar1, false))
	{
		...
		if (func_126(Param0, fParam3, iParam4, Var3, fVar6, iVar2, 0))
		{
			return 1;
		}
	}
...
{
	if (func_133(Param0, fParam3, iParam4, iParam5, iParam6) || func_194(Param0, fParam3, iParam4, iParam5, iParam7))
	{
		return 1;
	}
	return 0;
...
int func_160(struct<3> Param0, var uParam3)
{
	if (uParam3->f_18)
	{
		...
		{
			case 0:
				if (func_163(Param0, uParam3->f_19, uParam3->f_25, 0, 0))
				{
					return 1;
				}
				break;
			...
			case 1:
				if (func_161(Param0, uParam3->f_19, uParam3->f_22, 0, 0))
				{
					return 1;
				}
				break;
...
int func_161(struct<3> Param0, struct<3> Param3, struct<3> Param6, bool bParam9, bool bParam10)
{
	func_162(&Param3, &Param6);
...
bool func_163(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7, bool bParam8)
{
	if (bParam7 && bParam8)
	{
		Param0.f_2 = 0f;
...
int func_164(struct<3> Param0, float fParam3)
{
	int iVar0;
	...
	if (func_153(PLAYER::PLAYER_ID(), 1, 0))
	{
		if (Global_4980736.f_36355 > 0)
		{
			...
			while (iVar0 < Global_4980736.f_36355)
			{
				...
				{
					if (func_117(Param0, Global_4980736.f_36356[iVar0 /*134*/], Global_4980736.f_36356[iVar0 /*134*/].f_6, Global_4980736.f_36356[iVar0 /*134*/].f_7, fParam3))
					{
						return 1;
					}
				}
...
Vector3 func_165(struct<3> Param0, float* fParam3, int iParam4, bool bParam5, struct<3> Param6, bool bParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16)
{
	struct<3> Var0;
	var uVar3;
	var uVar4;
...
float func_166(int iParam0, float fParam1)
{
	...
	func_119(iParam0, &fVar0, &fVar3, 1086324736, 1080033280, 1077936128);
	fVar6 = (fVar3 - fVar0);
	if (fVar6 < fParam1)
	{
		return fParam1;
...
int func_168(struct<3> Param0, float fParam3, struct<3> Param4)
{
	struct<3> Var0;
	struct<3> Var3;
...
float func_169(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
bool func_171(struct<3> Param0, var uParam3)
{
...
int func_173(var uParam0, bool bParam1)
{
	...
	if (func_179(*uParam0))
	{
		if (bParam1)
		{
			...
			func_178(&Var1, Global_2667225.f_593, Global_2667225.f_596, 1036831949, 0, fVar4);
			if (func_174(Var1, &uVar0) || func_179(Var1))
			{
				Var1 = { *uParam0 };
				func_178(&Var1, Global_2667225.f_593, Global_2667225.f_596, 1036831949, 1, fVar4);
			}
			*uParam0 = { Var1 };
		}
	}
...
int func_175(struct<3> Param0, var uParam3, float fParam4, bool bParam5, bool bParam6)
{
	switch (uParam3->f_10)
	{
		case 0:
			return func_163(Param0, *uParam3, ((uParam3->f_6 + fParam4) + (IntToFloat(Global_2667225.f_2735) * uParam3->f_8)), bParam5, bParam6);
			break;
		
		case 1:
			return func_161(Param0, *uParam3 + Vector((fParam4 * -1f), (fParam4 * -1f), (fParam4 * -1f)), uParam3->f_3 + Vector(fParam4, fParam4, fParam4), bParam5, bParam6);
			break;
...
void func_178(var uParam0, struct<3> Param1, float fParam4, float fParam5, bool bParam6, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_181(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, int iParam10, float fParam11, bool bParam12)
{
	int iVar0;
	struct<3> Var1;
	...
	{
		case 0:
			func_178(&Param0, Param3, fParam9, fParam11, bParam12, 0);
			break;
		
		case 1:
			func_184(&Param0, Param3, Param6, fParam11, bParam12);
			break;
		
		case 2:
			func_182(&Param0, Param3, Param6, fParam9, fParam11, bParam12);
			break;
	}
	iVar0 = 0;
	while (iVar0 < 40)
	{
		...
		{
			case 0:
				if (!func_163(Var1, Param3, fParam9, 0, 0))
				{
					return Var1;
				}
				break;
			...
			case 1:
				if (!func_161(Var1, Param3, Param6, 0, 0))
				{
					return Var1;
				}
				break;
...
void func_182(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, float fParam8, bool bParam9)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (fVar9 < (fParam7 * 0.5f))
	{
		...
		else if (func_169(Var6, Var29) >= 0f)
		{
			Var6 = { Var6 * FtoV(((((fVar16 * 0.5f) + fVar9) + fParam8) * -1f)) };
		}
		else
...
Vector3 func_183(struct<3> Param0, struct<3> Param3)
{
	return ((Param0.f_1 * Param3.f_2) - (Param0.f_2 * Param3.f_1)), ((Param0.f_2 * Param3.f_0) - (Param0.f_0 * Param3.f_2)), ((Param0.f_0 * Param3.f_1) - (Param0.f_1 * Param3.f_0));
}

void func_184(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, float fParam7, bool bParam8)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_185(struct<3> Param0, var uParam3, var uParam4, var uParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	bool bVar1;
	...
	if (func_238(Param0))
	{
		if (func_188(uParam3, bParam6, 0, 1, 1))
		{
			if (bParam6)
			{
			}
	...
	if (bParam7)
	{
		if (func_136(*uParam3, 1056964608))
		{
			return 1;
		}
	}
	...
	while (iVar0 < *uParam4)
	{
		if (SYSTEM::VDIST(*uParam3, *(uParam4[iVar0 /*3*/])) < (*uParam5)[iVar0])
		{
			if (bParam6)
			{
				func_178(uParam3, *(uParam4[iVar0 /*3*/]), (*uParam5)[iVar0], 1036831949, 0, 0);
			}
			bVar1 = true;
		}
		iVar0++;
...
void func_187(var uParam0, var uParam1, float fParam2, bool bParam3, bool bParam4)
{
	if (bParam4)
	{
		switch (uParam1->f_10)
...
int func_188(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	struct<3> Var1;
								...
								if (!uParam2->f_15 || !func_185(uParam2->f_35, &Var3, &(uParam2->f_38), &(uParam2->f_45), 0, 1))
								{
									if (uParam2->f_8)
									{
										...
										if (!func_158(Var3, fVar6, uParam2->f_34))
										{
											if (uParam2->f_3 > 7f)
											{
												if (func_196(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, uParam2->f_3, 0, 0, 0, 0))
												{
													bVar12 = true;
												}
											}
											else if (func_196(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_116(Var3, fVar6, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0))
											{
												bVar12 = true;
											}
										}
										if (bVar12)
										{
											if ((uParam2->f_29 || uParam2->f_30) || uParam2->f_52)
											{
												...
												if (uParam2->f_52)
												{
													iVar13 = func_150(Var3, uParam2->f_54, &fVar14);
												}
...
int func_194(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6)
{
	...
	while (iVar0 < 32)
	{
		if (!iParam5 == iVar0 || iParam6 == 1)
		{
			...
			while (iVar1 < 2)
			{
				if (func_195(Param0, iParam4, Global_2680265.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2680265.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4))
				{
					if (func_126(Param0, fParam3, iParam4, Global_2680265.f_461[iVar0 /*11*/][iVar1 /*5*/], Global_2680265.f_461[iVar0 /*11*/][iVar1 /*5*/].f_3, Global_2680265.f_461[iVar0 /*11*/][iVar1 /*5*/].f_4, 0))
					{
						if (func_326(iVar2, 0, 1) && func_326(iParam5, 0, 1))
						{
							return 1;
						}
						else
...
int func_195(struct<3> Param0, int iParam3, struct<3> Param4, int iParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
	
	fVar0 = func_125(iParam3, 1008981770);
	fVar1 = func_125(iParam7, 1008981770);
...
int func_196(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)
{
	...
	if (fParam14 > 0f)
	{
		if (func_201(Param0, fParam14, 1, 1, bParam15, bParam17, bParam11, bParam15, 0))
		{
			return 0;
		}
	}
	...
	if (bParam8)
	{
		if (fParam6 > 0f)
		{
			if (func_197(Param0, fParam6, iParam7, iParam9, fParam10, bParam11, iParam12, fParam16, bParam17))
			{
				return 0;
			}
		}
...
int func_197(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam4 && !bParam7)
	{
		if (func_326(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_198(PLAYER::PLAYER_ID()), Param0, true) <= (fVar2 + fParam3))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_326(iVar1, 1, 1))
		{
			if (!func_31(iVar1, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_132(iVar1) || !bParam10) && !Global_2689235[iVar1 /*453*/].f_267)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
						...
						if (!bParam7)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_198(iVar1), Param0, true) <= (fVar2 + fParam3))
								{
...
int func_201(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_326(iVar1, bParam4, bParam5))
			{
				if (iParam10 || NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_132(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_252(iVar1), Param0, true) < fParam3)
								{
									return 1;
								}
							}
...
void func_216(struct<3> Param0, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2[3];
	...
	if (!func_234())
	{
		...
		else if (func_226(Param0, &iVar2, &iVar6) || (func_203(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam3))))
		{
			func_245();
			iVar0 = 0;
			while (iVar0 < iVar2)
			{
				...
				if (!iVar6[iVar0] && func_225(iVar2[iVar0], -1))
				{
					if (func_229(iParam3))
					{
				...
				{
					if (((func_224(PLAYER::PLAYER_PED_ID()) || func_223(PLAYER::PLAYER_PED_ID())) && VEHICLE::IS_THIS_MODEL_A_PLANE(iParam3)) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam3))
					{
						if (func_222(iParam3))
						{
							func_221(iVar2[iVar0]);
						}
						else if (func_220(iParam3))
						{
...
void func_218(struct<3> Param0, float fParam3, int iParam4, bool bParam5)
{
	struct<2> Var0;
	struct<2> Var3;
	float fVar6;
	...
	if (!iParam4 == 0)
	{
		func_119(iParam4, &Var0, &Var3, 1086324736, 1080033280, 1077936128);
		...
		func_232(Var10, fParam3);
	}
	else
	{
		func_232(Param0, fParam3);
	}
}
...
int func_226(struct<2> Param0, var uParam2, var uParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_232(struct<3> Param0, float fParam3)
{
...
int func_235(struct<2> Param0, var uParam2, bool bParam3, float fParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_240(struct<3> Param0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_175(Param0, &(Global_2667225.f_45[iVar0 /*12*/]), fParam3, 0, 0))
			{
				return iVar0;
			}
		}
...
int func_241(struct<3> Param0, float fParam3)
{
	int iVar0;
...
{
	Local_91[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
}

int func_257(int iParam0)
{
	return Local_91[iParam0 /*4*/].f_1;
}
...
bool func_265(int iParam0, int iParam1)
{
	...
	iVar0 = (iParam1 / 32);
	iVar1 = (iParam1 % 32);
	return BitTest(Local_91[iParam0 /*4*/].f_2[iVar0], iVar1);
}
...
void func_275(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	MISC::CLEAR_BIT(&(Local_91[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), iVar1);
}
...
void func_291()
{
	if (func_297())
	{
		...
		{
			iLocal_140 = HUD::ADD_BLIP_FOR_ENTITY(func_16());
			HUD::SET_BLIP_SPRITE(iLocal_140, func_296());
			func_293(&iLocal_140, func_295());
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_140, func_292());
		}
	}
	else if (HUD::DOES_BLIP_EXIST(iLocal_140))
	{
...
void func_303()
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		...
		{
			iLocal_124[iVar0] = iVar0;
			iVar1 = NETWORK::NETWORK_GET_PLAYER_INDEX(iLocal_124[iVar0]);
			if (func_326(iVar1, 0, 1))
			{
				if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
				{
					if (!bVar2)
					{
						if (func_265(iLocal_124[iVar0], 1))
						{
							bVar2 = true;
						}
					}
					if (!func_12(1))
					{
						if (func_265(iLocal_124[iVar0], 0))
						{
							func_253(1);
						}
					}
					if (!func_12(3))
					{
						if (func_265(iLocal_124[iVar0], 2))
						{
							func_253(3);
						}
					}
					if (!func_12(4))
					{
						if (func_265(iLocal_124[iVar0], 3))
						{
							func_253(4);
						}
					}
					if (!func_12(5))
					{
						if (func_265(iLocal_124[iVar0], 4))
						{
							func_253(5);
						}
					}
...
bool func_306(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	return BitTest(uLocal_133[iVar0], iVar1);
}
...
int func_322(struct<21> Param0)
{
	func_325(8, Param0);
	NETWORK::RESERVE_NETWORK_MISSION_VEHICLES(1);
	func_323(0, -1, 0);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_83, 8, 0);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_91, 33, 0);
