...
void __EntryFunction__()
{
	...
	if (func_497())
	{
		...
		if (iLocal_1778 == 0)
		{
			...
			func_422(804.2744f, -1077.559f, 27.5087f, 71.7369f, 1, 0);
		}
		...
		else if (iLocal_1778 == 2)
		{
			...
			func_422(-182.1094f, -1004.058f, 113.1362f, 250.235f, 1, 0);
		}
...
float func_127()
{
	...
	if (func_85(Global_114370.f_19966.f_1, 32768))
	{
		fVar0 = (fVar0 + 0.2f);
	}
	...
	switch (iLocal_1037)
	{
		case 0:
			...
			if (bLocal_1065)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1038))
				{
					func_411(805.0217f, -1076.811f, 26.62203f, 813.8823f, -1076.814f, 32.50576f, 5f, 814.4346f, -1081.688f, 27.3991f, 90.2655f, 1, 1, 1, 0, 0);
...
void func_409()
{
	...
	{
		case 0:
			if (func_410(&iLocal_1040, 4f, 799.7321f, -1083.417f, 30.3753f, -1.3455f, 0f, -42.1124f, 42.5517f, 1, 0.3f))
			{
				iLocal_1079 = 1;
			}
			break;
		...
		case 1:
			if (func_410(&iLocal_1040, 11f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.3f))
			{
				iLocal_1079 = 2;
			}
			break;
		...
		case 2:
			if (func_410(&iLocal_1040, 20f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.3f))
			{
				iLocal_1079 = 3;
			}
			break;
		...
		case 3:
			if (func_410(&iLocal_1040, 25f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.2f))
			{
				iLocal_1079 = 4;
			}
			break;
		...
		case 4:
			if (func_410(&iLocal_1040, 30f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.2f))
			{
				iLocal_1079 = 5;
			}
			break;
		...
		case 5:
			if (func_410(&iLocal_1040, 37f, 812.5805f, -1076.648f, 28.9375f, 2.1171f, 0.0247f, 79.0055f, 29.2734f, 1, 0.2f))
			{
				iLocal_1079 = 6;
			}
			break;
...
int func_410(int iParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
...
int func_413(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_414(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_485(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
