...
void func_377(int iParam0, struct<3> Param1, float fParam4)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_378(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_408()
{
	...
	{
		case 0:
			if (func_409(&iLocal_1040, 4f, 799.7321f, -1083.417f, 30.3753f, -1.3455f, 0f, -42.1124f, 42.5517f, 1, 0.3f))
			{
				iLocal_1079 = 1;
			}
			break;
		...
		case 1:
			if (func_409(&iLocal_1040, 11f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.3f))
			{
				iLocal_1079 = 2;
			}
			break;
		...
		case 2:
			if (func_409(&iLocal_1040, 20f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.3f))
			{
				iLocal_1079 = 3;
			}
			break;
		...
		case 3:
			if (func_409(&iLocal_1040, 25f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.2f))
			{
				iLocal_1079 = 4;
			}
			break;
		...
		case 4:
			if (func_409(&iLocal_1040, 30f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.2f))
			{
				iLocal_1079 = 5;
			}
			break;
		...
		case 5:
			if (func_409(&iLocal_1040, 37f, 812.5805f, -1076.648f, 28.9375f, 2.1171f, 0.0247f, 79.0055f, 29.2734f, 1, 0.2f))
			{
				iLocal_1079 = 6;
			}
			break;
...
int func_409(int iParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
