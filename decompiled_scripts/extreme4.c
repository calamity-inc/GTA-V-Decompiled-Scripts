...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (func_322(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, false, true, 0))
			{
			...
			if (!func_271())
			{
				if (func_265(1, 20f, 1))
				{
					if ((!iLocal_381 || MISC::GET_GAME_TIMER() > iLocal_382 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						iLocal_364 = PED::ADD_SCENARIO_BLOCKING_AREA(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, false, true, true, true);
						iLocal_147 = 1;
					}
				}
			}
...
void func_272()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((PAD::IS_CONTROL_PRESSED(0, 30) || PAD::IS_CONTROL_PRESSED(0, 31)) || PAD::IS_CONTROL_PRESSED(0, 23)) || PAD::IS_CONTROL_PRESSED(0, 21)) || PAD::IS_CONTROL_PRESSED(0, 22)) || (func_284() && PAD::IS_CONTROL_PRESSED(0, 1))) || (func_284() && PAD::IS_CONTROL_PRESSED(0, 2))) || (func_284() && PAD::IS_CONTROL_PRESSED(0, 32)))
			{
...
int func_275(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_281(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_282(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_285()
{
	...
	{
		func_295(1732.133f, 91.9424f, 169.7872f, 128.6917f, 1, 0);
		func_293(0, -1, 1);
...
void func_286()
{
	...
	{
		func_290(Local_80.f_28[0], 1737.453f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
		func_287(&(Local_80.f_28[0]), 1737.453f, 101.7498f, 170.0243f, 288.5211f);
	}
...
void func_287(int* iParam0, struct<3> Param1, float fParam4)
{
...
void func_288(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_289(iParam0);
...
int func_290(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_295(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_340())
	{
...
void func_296()
{
	switch (iLocal_148)
	{
		...
		case 2:
			func_290(PLAYER::PLAYER_PED_ID(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Walk"), false, 1, false);
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723.452f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
...
int func_298(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_339(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
