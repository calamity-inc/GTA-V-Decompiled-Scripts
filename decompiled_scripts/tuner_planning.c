...
int func_97()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_281, -1350.245f, 137.3038f, -96.10934f, -1347.282f, 138.094f, -94.10934f, 1.75f, false, true, 0) && func_98(ENTITY::GET_ENTITY_HEADING(iLocal_281), 198f, 75f))
	{
		return 1;
	}
	return 0;
...
void func_159(var uParam0, var uParam1, float fParam2)
{
...
void func_279(struct<3> Param0, var uParam3)
{
	int iVar0;
	int iVar1;
...
int func_280(struct<3> Param0, int iParam3, float fParam4)
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
...
int func_341(var uParam0)
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 188) || func_342(uParam0, 0, 0))
	{
		return 0;
	}
	else if (PAD::IS_CONTROL_JUST_PRESSED(2, 187) || func_342(uParam0, 0, 1))
	{
		return 1;
	}
	else if (PAD::IS_CONTROL_JUST_PRESSED(2, 189) || func_342(uParam0, 0, 2))
	{
		return 2;
	}
	else if (PAD::IS_CONTROL_JUST_PRESSED(2, 190) || func_342(uParam0, 0, 3))
	{
		return 3;
	}
...
void func_349(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	int iVar0[4];
	float fVar5;
	float fVar6;
...
void func_352(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
...
void func_372(var uParam0)
{
	...
	{
		func_378(2, 201, "CH_INSTR_LM", uParam0, 1, 365);
	}
	else if (func_374(uParam0, iVar0))
	{
		func_378(2, 201, "TN_INSTR_ACC", uParam0, 1, 365);
	}
	func_378(2, 202, "CH_INSTR_QUIT", uParam0, 1, 365);
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2))
	{
		func_378(2, 39, "CH_INSTR_ZOOM", uParam0, 1, 365);
	}
	else
	{
		func_373(2, 15, "CH_INSTR_ZOOM", uParam0);
	}
	func_373(2, 1, "HEIST_IB_LOOK", uParam0);
	func_373(2, 0, "HEIST_IB_NAV", uParam0);
}

void func_373(int iParam0, int iParam1, char* sParam2, var uParam3)
{
	int iVar0;
...
void func_378(int iParam0, int iParam1, char* sParam2, var uParam3, bool bParam4, int iParam5)
{
	int iVar0;
...
void func_416(var uParam0, struct<3> Param1, struct<3> Param4, var uParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, bool bParam15)
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param4 };
	uParam0->f_7 = uParam7;
...
bool func_430(var uParam0)
{
	if (!BitTest(uParam0->f_1093, 0))
	{
		...
		Local_283.f_2 = 98359;
		Local_283.f_4 = 96994;
		Local_283.f_4.f_1 = 96920;
		Local_283.f_4.f_2 = 58584;
		Local_283.f_7 = 58572;
		Local_283.f_7.f_1 = 58559;
		Local_283.f_7.f_4 = 58547;
		Local_283.f_7.f_4.f_1 = 58538;
		Local_283.f_7.f_4.f_3 = 58525;
		Local_283.f_7.f_4.f_4 = 58512;
		Local_283.f_7.f_4.f_5 = 58499;
		Local_283.f_7.f_4.f_6 = 58490;
		Local_283.f_7.f_4.f_8 = 58482;
		Local_283.f_44 = 57590;
		Local_283.f_30 = 57548;
		Local_283.f_30.f_1 = 57506;
		Local_283.f_30.f_2 = 57476;
		Local_283.f_30.f_10 = 57467;
		Local_283.f_30.f_3 = 57458;
		Local_283.f_30.f_7.f_2 = 57445;
		Local_283.f_46 = 57414;
		Local_283.f_47 = 57174;
		Local_283.f_48 = 57076;
		Local_283.f_49.f_2 = 57067;
		Local_283.f_49 = 57058;
		Local_283.f_49.f_1 = 57050;
		Local_283.f_49.f_3 = 57041;
		Local_283.f_49.f_5 = 57030;
		Local_283.f_49.f_4 = 57017;
		Local_283.f_49.f_6 = 57008;
		Local_283.f_49.f_7 = 56997;
		Local_283.f_49.f_8 = 56988;
		Local_283.f_59 = 56979;
		Local_283.f_59.f_1 = 56831;
		Local_283.f_59.f_2 = 56819;
		Local_283.f_59.f_3 = 56810;
		Local_283.f_59.f_5 = 56798;
		Local_283.f_59.f_6 = 56771;
		Local_283.f_59.f_7 = 56734;
		Local_283.f_72 = 56697;
		Local_283.f_72.f_1 = 56660;
		Local_283.f_72.f_6 = 56420;
		Local_283.f_72.f_8 = 55350;
...
void func_503(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<8> Var0;
...
int func_556(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
...
int func_565(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		case 148:
		...
		case 233:
			return func_588(iParam1, iParam2, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), iParam4);
		...
		case 181:
			return func_566(iParam1, iParam2, PLAYER::INT_TO_PLAYERINDEX(bParam5), iParam4);
...
int func_588(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_590(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
int func_594(int iParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_606(int iParam0, int iParam1, int iParam2, var uParam3)
{
	switch (iParam0)
	{
		case 1:
...
int func_616(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		case 148:
		...
		case 233:
			return func_638(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_629(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, -1, 0, 0);
		
		case 158:
			return func_623(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, -1, 0, 0);
		
		case 181:
			return func_617(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, -1, 0, 0);
...
int func_617(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
...
int func_623(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
...
int func_629(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
...
int func_638(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
...
int func_644(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
...
int func_650(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
...
int func_660(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
int func_674(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
