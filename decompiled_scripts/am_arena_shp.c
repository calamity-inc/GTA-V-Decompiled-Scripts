...
void func_17(int iParam0)
{
	...
	if (iVar7 || SCRIPT::GET_EVENT_DATA(1, iParam0, &Var0, 7))
	{
		...
		if (iVar9 != -1)
		{
			...
			{
				Global_4534105[iVar9 /*85*/].f_66.f_18 = MISC::GET_FRAME_COUNT();
			}
		}
		bVar95 = true;
		if (iVar9 != -1)
			...
			case 0:
				if (iVar9 != -1)
				{
					...
					else if (func_13())
					{
						if (bVar95)
						{
							NETSHOPPING::NET_GAMESERVER_BASKET_APPLY_SERVER_DATA(Global_4534105[iVar9 /*85*/].f_66, &uVar96);
						}
					}
				}
				break;
							...
							else if (Global_4534105[iVar9 /*85*/].f_66.f_11 & 2 != 0)
							{
								...
								if (func_23(Global_4535609) && func_13())
								{
									if (!func_22(Global_4534105[iVar9 /*85*/].f_66))
									{
										...
										Global_4535466[iVar101 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
									}
								}
								else
								{
						...
						else if (Global_4534105[iVar9 /*85*/].f_66.f_11 & 2 != 0)
						{
							...
							if (func_23(Global_4535609) && func_13())
							{
								if (!func_22(Global_4534105[iVar9 /*85*/].f_66))
								{
									...
									Global_4535466[iVar102 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
								}
							}
							else
							{
					...
					else if (Global_4534105[iVar9 /*85*/].f_66.f_11 & 2 != 0)
					{
						...
						if ((func_23(Global_4535609) && func_13()) && func_31(Var0.f_2))
						{
							if (!func_22(Global_4534105[iVar9 /*85*/].f_66))
							{
								...
								Global_4535466[iVar103 /*7*/].f_4 = NETWORK::GET_NETWORK_TIME();
							}
						}
						else
						{
...
void func_32(int iParam0, bool bParam1)
{
	...
	switch (Global_4534105[iParam0 /*85*/].f_66.f_4)
	{
		...
		case 2050093329:
			MONEY::_NETWORK_SPENT_PAY_BOSS(Global_4534105[iParam0 /*85*/].f_6, Global_4534105[iParam0 /*85*/].f_7, Global_4534105[iParam0 /*85*/].f_66.f_1);
			break;
		
		case -1752488069:
			MONEY::_NETWORK_SPENT_PAY_GOON(Global_4534105[iParam0 /*85*/].f_6, Global_4534105[iParam0 /*85*/].f_7, Global_4534105[iParam0 /*85*/].f_66.f_1);
			break;
		...
		case 1868043300:
			MONEY::_NETWORK_SPENT_ARCADE_GAME(Global_4534105[iParam0 /*85*/].f_66.f_1, 0, 1, Global_4534105[iParam0 /*85*/], Global_4534105[iParam0 /*85*/].f_66.f_1);
			break;
	...
	switch (Global_4534105[iParam0 /*85*/].f_66.f_4)
	{
		...
		case -1896606724:
			...
			MONEY::_NETWORK_SPENT_ISLAND_HEIST(Global_4534105[iParam0 /*85*/].f_66.f_1, 0, 1, &Var6);
			break;
		...
		case -1029672338:
			MONEY::_0xE2BB399D90942091(Global_4534105[iParam0 /*85*/].f_66.f_1, Global_4534105[iParam0 /*85*/].f_66.f_16);
			break;
	...
	if (func_13())
	{
		if (bParam1)
		{
			NETSHOPPING::NET_GAMESERVER_BASKET_APPLY_SERVER_DATA(Global_4534105[iParam0 /*85*/].f_66, &uVar16);
		}
	}
	func_7(iParam0);
}
