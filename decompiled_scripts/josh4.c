...
void func_181(int iParam0)
{
	...
	func_182(iParam0);
	MISC::SET_BIT(&(Global_113969.f_18577[iParam0 /*6*/]), false);
}
...
void func_188(bool bParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::SET_BIT(&Global_112604, bParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_112604, bParam0);
	}
	Global_112603 = 1;
}
...
void func_195(int iParam0, bool bParam1)
{
	...
	if (bVar0 >= 0 && bVar0 <= 31)
	{
		if (!func_202(iParam0))
		{
			MISC::SET_BIT(&(Global_113969.f_26437), bVar0);
			if (!bParam1)
			{
...
void func_421(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_431(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_433(iParam0, uVar1[iVar6], 1) && func_432(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_474(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_236(iParam0);
...
void func_475(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_237(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_476(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_477(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
