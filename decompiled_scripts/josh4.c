...
void __EntryFunction__()
{
	...
	if (func_475())
	{
		func_509("*** Setting up initial scene for replay");
		func_474(Local_104, fLocal_107, 1, 0);
		func_509("*** Replay setup started");
		Global_79494 = 1;
		iLocal_77 = 0;
		while (!func_463(&Local_441))
		{
			SYSTEM::WAIT(0);
		}
		func_509("*** Josh 4 scene set up");
		func_462(&Local_441, 0, 1);
		Global_79494 = 0;
	}
	if (func_461(Local_441.f_28[1]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_441.f_28[1], true);
	}
	if (func_461(Local_441.f_28[2]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_441.f_28[2], true);
	}
	iLocal_505 = Local_441.f_35[0];
	iLocal_506 = Local_441.f_35[1];
	func_509("*** About to set up positions...");
	func_460();
	func_453(58, 2, 0);
	if (func_475())
	{
		func_509("*** Creating replay vehicle and jumping to post-cutscene");
	...
	switch (iLocal_86)
	{
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_210())
			{
				...
				{
					if (func_461(Local_441.f_28[iVar0]))
					{
...
void func_2()
{
	if (func_461(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST_RADIO");
			func_509("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
			func_509("Starting 'JOSH4_COPS_LOST'");
		}
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
		func_509("Player is somehow not alive when passing the mission - starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_476();
}
...
void func_181(int iParam0)
{
	...
	func_182(iParam0);
	MISC::SET_BIT(&(Global_114372.f_18577[iParam0 /*6*/]), false);
}
...
void func_184(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		MISC::CLEAR_BIT(&(Global_114372.f_32753[iParam0]), bParam1);
	}
}
...
void func_188(bool bParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::SET_BIT(&Global_113007, bParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_113007, bParam0);
	}
	Global_113006 = 1;
}
...
void func_195(int iParam0, bool bParam1)
{
	...
	if (bVar0 >= 0 && bVar0 <= 31)
	{
		if (!func_202(iParam0))
		{
			MISC::SET_BIT(&(Global_114372.f_26437), bVar0);
			if (!bParam1)
			{
...
void func_211()
{
	if (iLocal_531 == 0)
	{
		if (func_212(PLAYER::PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			...
			func_509("*** Played special Josh 4 police report ***");
			iLocal_531 = 1;
		}
	}
}
	...
	switch (iLocal_100)
	{
		case 0:
			if (iLocal_99 == 3)
			{
				if (func_461(Local_441.f_28[0]))
				{
					...
					{
						func_509("Josh car not ok - do Josh flee anyway");
						TASK::OPEN_SEQUENCE_TASK(&iLocal_504);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_108, 2f, 20000, 1f, 1, 40000f);
						if (func_208(iLocal_506))
						{
		...
		case 1:
			if (func_461(Local_441.f_28[0]))
			{
				if (!iLocal_523)
				{
					if (iLocal_513[0] || iLocal_513[1])
					{
						if (func_214(Local_441.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							...
							func_509("Doing Josh comment");
						}
						else
						{
							func_509("Too far away to do Josh comment");
						}
						iLocal_523 = 1;
					}
				}
				...
				{
					func_509("Deleting Josh, setting as lost");
					func_237(&(Local_441.f_28[0]));
					func_236(&iLocal_506);
					iLocal_100 = 2;
				}
				if (func_461(PLAYER::PLAYER_PED_ID()) && func_461(Local_441.f_28[0]))
				{
					if (iLocal_527 < 3)
					{
...
void func_239(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	MISC::SET_BIT(&Global_21032, false);
...
void func_241()
{
	switch (Local_87.f_11)
	{
		case 0:
			...
			while (iLocal_508 <= 4)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_532[iLocal_508 /*7*/], Local_532[iLocal_508 /*7*/].f_3, Local_532[iLocal_508 /*7*/].f_6, false, true, 2))
				{
					...
					func_509("Requesting flee recording: ");
			...
			if (func_208(Local_87.f_7))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_87.f_7))
				{
					if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_87.f_9, Local_87.f_10))
					{
						...
						func_509("Flee car recording finished!");
						Local_87.f_11 = 4;
					}
				}
				else
		...
		case 4:
			...
			func_509("Flee car & ped released!");
			break;
	}
}
...
void func_243()
{
	...
	switch (iLocal_99)
	{
		case 0:
			...
			{
				func_509("************************************** TIMEOUT - AIM next frame");
				iLocal_99 = 1;
				iLocal_509 = MISC::GET_GAME_TIMER();
			}
			iVar0 = 1;
			while (iVar0 <= (Local_441.f_28 - 1))
			{
				if (func_461(Local_441.f_28[iVar0]))
				{
					...
					{
						func_509("************************************** TOO FAR - AIM next frame");
						iLocal_99 = 1;
						iLocal_509 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 2:
			...
			{
				func_509("************************************** TIMEOUT - ARREST next frame");
				if (func_461(Local_441.f_28[1]))
				{
			...
			while (iVar0 <= (Local_441.f_28 - 1))
			{
				if (func_461(Local_441.f_28[iVar0]))
				{
					...
					{
						func_509("************************************** TOO FAR - ATTACK next frame");
						iLocal_99 = 3;
						iLocal_509 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 4:
			...
			while (iVar0 <= (Local_441.f_28 - 1))
			{
				if (func_461(Local_441.f_28[iVar0]))
				{
					...
					{
						func_509("************************************** THREAT DURING ARREST - ATTACK next frame");
						iLocal_99 = 3;
						iLocal_509 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 3:
			...
			if (!iLocal_516)
			{
				...
				func_509("Doing cop fire warning");
				iLocal_516 = 1;
			...
			else
			{
				...
				{
					if (func_461(Local_441.f_28[iVar1]))
					{
		...
		while (iVar0 <= (Local_441.f_28 - 1))
		{
			if (func_461(Local_441.f_28[iVar0]))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_441.f_28[iVar0]))
				{
					...
					{
						func_509("************************************** AIMED WEAPON - ATTACK now");
						iLocal_99 = 3;
					}
				}
				if (func_244(Local_441.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_509("************************************** ATTACKED/THREATENED - ATTACK now");
					iLocal_99 = 3;
				}
				if (iLocal_99 != 4)
				{
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_461(PLAYER::PLAYER_PED_ID()) && func_461(iParam0))
	{
...
void func_265()
{
	...
	else if (!iLocal_521)
	{
		...
		func_509("Starting 'JOSH4_ACTION'");
		iLocal_521 = 1;
	}
	else if (!iLocal_522)
	{
		if (func_461(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				func_509("Starting 'JOSH4_VEHICLE'");
				iLocal_522 = 1;
			}
		}
	}
...
void func_266()
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_461(Local_441.f_28[1]))
		{
			func_509("Trying to set Cop 1 component variation (intro loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_441.f_28[1], 0);
		}
		if (func_461(Local_441.f_28[2]))
		{
			func_509("Trying to set Cop 2 component variation (intro loop)");
			...
			switch (iLocal_525)
			{
				...
				case 3:
					...
					if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
					{
						...
						{
							AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_START");
							func_509("Starting 'JOSH4_START' via cutscene skip");
							iLocal_520 = 1;
						}
					}
					break;
...
void func_278()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_461(Local_441.f_28[0]))
		{
			func_509("Playing Josh's leadout");
			TASK::OPEN_SEQUENCE_TASK(&iLocal_504);
...
void func_294()
{
	...
	if (func_461(Local_441.f_28[1]))
	{
		...
		func_509("*** Registered Cop standing");
	}
	if (func_461(Local_441.f_28[2]))
	{
		...
		func_509("*** Registered Cop with notepad");
	}
	if (func_461(iLocal_502))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_502, "Security_guard_pistol", 0, 0, 0);
		func_509("*** Registered idle cop gun");
	}
	if (func_461(iLocal_503))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_503, "FBI_Agent_1_Gun", 0, 0, 0);
		func_509("*** Registered notepad cop gun");
	}
	iLocal_520 = 0;
	iLocal_521 = 0;
	iLocal_522 = 0;
...
void func_305()
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_461(Local_441.f_28[1]))
		{
			func_509("Trying to set Cop 1 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_441.f_28[1], 0);
		}
		if (func_461(Local_441.f_28[2]))
		{
			func_509("Trying to set Cop 2 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_with_notepad", Local_441.f_28[2], 0);
		}
	}
	switch (iLocal_86)
	{
		case 0:
			...
			{
				func_509("Doing setup for leadin");
				func_232(&uLocal_276, 4, Local_441.f_28[0], "JOSH", 0, 1);
				func_232(&uLocal_276, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				STREAMING::REQUEST_ANIM_DICT("rcmjosh4");
			...
			{
				func_509("Skipping setup for leadin (repeat play/wrong area)");
				func_302(1);
			}
			break;
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, false, true, 0))
			{
				if (func_461(PLAYER::PLAYER_PED_ID()) && func_268(Local_441.f_28[0]))
				{
				...
				if (!iLocal_517)
				{
					if (func_268(Local_441.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_441.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_210())
						{
							...
							func_509("Done Josh leadin anim");
							if (func_268(Local_441.f_28[2]))
							{
								...
								func_509("Done Notepad cop leadin anim");
							}
							if (func_268(Local_441.f_28[1]))
							{
								...
								func_509("Done Speaker cop leadin anim");
							}
				...
				{
					if ((func_461(PLAYER::PLAYER_PED_ID()) && func_268(Local_441.f_28[0])) && !func_306())
					{
						if (!func_298(PLAYER::PLAYER_PED_ID(), joaat("script_task_turn_ped_to_face_entity")))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_441.f_28[0], 0);
					...
					if (func_268(Local_441.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_441.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							...
							if (func_214(PLAYER::PLAYER_PED_ID(), Local_441.f_28[0], 1) <= 2f)
							{
								...
								func_509("Player too close to Josh, starting cutscene early");
								func_302(1);
							}
						}
						else
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_317(Global_79504, Global_79506, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_328(0) || Global_79519) || Global_79507 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79503)
...
{
	return func_330(iParam0, Global_43922);
}
...
void func_338(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_420(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_419(Param1, 0f, 0f, 0f, 0))
		{
		...
		if (Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_402(iParam0, &(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_402(iParam0, &(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_340(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_344(iParam1, &(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114372.f_20121[iParam0 /*43*/].f_31 = func_343(*iParam1);
				...
				func_341(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114372.f_20121[iParam0 /*43*/].f_1));
				...
				func_341(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114372.f_20121[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_345(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_378(iVar0, bParam1, uParam2) && !func_377(PLAYER::PLAYER_ID())) && !func_358(iParam0))
	{
		return 0;
	}
...
int func_347(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			...
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_352(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_353(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_354(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_376(PLAYER::PLAYER_ID()) || func_375(PLAYER::PLAYER_ID()))
	{
		if (func_359(iParam0))
		{
			return 1;
...
int func_362(int iParam0)
{
	...
	if (func_377(iParam0) && Global_2657921[iParam0 /*463*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_375(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[iParam0 /*463*/].f_321.f_10 != func_221())
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_376(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[iParam0 /*463*/].f_321.f_10 != func_221())
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_377(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_348(Global_2657921[iParam0 /*463*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
void func_380(int iParam0, int iParam1)
{
	...
	func_381(iParam0, &(Global_114372.f_32753.f_5510));
}
...
void func_381(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_383(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_288(iParam0, 0, 0)) || func_288(iParam0, 1, 0)) || func_288(iParam0, 2, 0)) || func_398(iParam0) != 145) || func_397(iParam0)) || func_396(iParam0)) || func_346(iParam0)) || func_395(iParam0)) || !func_385(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_396(iParam0))
		{
		}
...
int func_402(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_407(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_374(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_405(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_405(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_404(iParam0);
	if (func_403(*iParam0))
	{
...
int func_405(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_406(iParam0, 38) + 1;
		iVar1 = func_406(iParam0, 24) + 1;
...
int func_406(int iParam0, int iParam1)
{
	...
	while (iVar0 >= 0 && func_407(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
{
	if (!func_408() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_411(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98703[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98703[iVar0]) == func_412(iParam0, iParam1))
				{
...
void func_413(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_418(&(Global_78038.f_555[0 /*21*/]), iVar0))
		{
...
void func_414(int iParam0)
{
	...
	if (func_418(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_185(iParam0, 0)) && Global_78947.f_66 == 0) && Global_114372.f_32753.f_1958[Global_78038.f_555[0 /*21*/].f_14] != 0) && Global_114372.f_32753.f_1958[Global_78038.f_555[0 /*21*/].f_14] > 3) && (!func_416(0, Global_78038.f_555[0 /*21*/].f_12) || !func_416(1, Global_78038.f_555[0 /*21*/].f_12)))
			{
				func_415(&(Global_114372.f_32753.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]), &Global_78947);
...
int func_416(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_417(&(Global_114372.f_32753.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_386(Global_114372.f_32753.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_418(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_419(Global_114372.f_32753.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_419(Global_114372.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_419(Global_114372.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_419(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
{
	return func_421(&(Global_107917.f_2890), Param0, fParam3, 0);
}
	...
	if (func_445(uParam0))
	{
		...
		if (func_444(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_426(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_399(iVar0, uParam0->f_11);
				}
				else if ((!func_423(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_422(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_423(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_425(iParam0, Global_78038.f_139[38], 0))
			{
				func_414(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_425(iParam0, Global_78038.f_139[43], 1))
			{
				func_414(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_425(iParam0, uVar1[iVar6], 1) && func_424(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_419(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_426(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_382(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_382(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_382(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_382(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_382(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_382(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_382(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_382(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_382(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_382(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_382(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_382(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_382(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_382(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_382(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_382(iVar6));
				}
				iVar6++;
			}
		}
		...
		{
			if (func_435(uParam1->f_5) || func_435(uParam1->f_6))
			{
			}
			else
			{
		...
		if (((BitTest(uParam1->f_77, 15) || func_434(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_433())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_402(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_382(iVar7 + 1)))
				{
		...
		if ((((func_427() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_356(1)))
		{
...
int func_427()
{
	...
	if (func_430(7))
	{
		if (func_429(Global_2672741.f_4.f_16) || func_428(Global_2672741.f_4.f_16))
		{
			return 0;
		}
	}
...
{
	return func_431(&(Global_2672741.f_188), iParam0);
}

var func_431(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_437(int iParam0)
{
	...
	if (func_439(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_445(var uParam0)
{
	...
	if (!func_386(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
...
bool func_446()
{
	return func_444(&(Global_107917.f_2890));
}

void func_447()
{
	func_448(&(Global_107917.f_2890));
}
...
int func_449(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_451(Global_107917.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_452()
{
	return func_445(&(Global_107917.f_2890));
}
		...
		if (bParam2)
		{
			if (!Global_79248)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9342[iParam1 /*4*/] = { func_455(iParam0) };
					...
					{
						Global_9293[1 /*6*/] = { func_455(iParam0) };
...
void func_460()
{
	...
	if (func_337())
	{
		if (func_335(0, 1))
		{
			func_509("*** Opened Josh gate for replay");
		}
	}
	func_509("*** Set up coords");
}
...
void func_462(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_461(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_461(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_461(uParam0->f_41[iVar0]))
		{
...
int func_463(var uParam0)
{
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_473(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_77 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_467(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_466(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_461(uParam0->f_28[1]))
				{
			...
			{
				func_466(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_461(uParam0->f_28[2]))
				{
			...
			{
				func_465(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_464(&(uParam0->f_35[1]), 0);
...
void func_464(int* iParam0, bool bParam1)
{
	...
	func_465(iParam0, iLocal_79, Var0, fVar3);
...
void func_465(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_236(iParam0);
...
void func_466(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_237(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_467(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_468(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_468(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_476()
{
	...
	if (func_486())
	{
		func_509("...Random Character Script was triggered so additional cleanup required");
	}
	iVar0 = 1;
	while (iVar0 <= (Local_441.f_28 - 1))
	{
...
void func_487(bool bParam0)
{
	...
	if (!func_504())
	{
		...
		{
			func_162(iVar0, 1, 0);
			func_488(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_113459[iVar0 /*10*/].f_9 == -1)
...
int func_489(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_495())
	{
		...
		{
			iVar33 = func_490(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_491()
{
	...
	iVar0 = func_492(&(Global_101392.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_492(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
	
	iVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_493(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_495()
{
	...
	{
		if (func_490(&(Global_101392.f_3)) > -1)
		{
			return 1;
		}
	}
