...
void __EntryFunction__()
{
	...
	if (func_474())
	{
		func_508("*** Setting up initial scene for replay");
		func_473(Local_104, fLocal_107, 1, 0);
		func_508("*** Replay setup started");
		Global_78935 = 1;
		iLocal_77 = 0;
		while (!func_462(&Local_441))
		{
			SYSTEM::WAIT(0);
		}
		func_508("*** Josh 4 scene set up");
		func_461(&Local_441, 0, 1);
		Global_78935 = 0;
	}
	if (func_460(Local_441.f_28[1]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_441.f_28[1], true);
	}
	if (func_460(Local_441.f_28[2]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_441.f_28[2], true);
	}
	iLocal_505 = Local_441.f_35[0];
	iLocal_506 = Local_441.f_35[1];
	func_508("*** About to set up positions...");
	func_459();
	func_452(58, 2, 0);
	if (func_474())
	{
		func_508("*** Creating replay vehicle and jumping to post-cutscene");
		func_337(&iLocal_84, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_314(Local_441.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_85)
		{
			case 0:
				func_304();
	...
	switch (iLocal_86)
	{
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_210())
			{
				...
				{
					if (func_460(Local_441.f_28[iVar0]))
					{
...
void func_2()
{
	if (func_460(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			func_508("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
			func_508("Starting 'JOSH4_COPS_LOST'");
		}
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
		func_508("Player is somehow not alive when passing the mission - starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_475();
}
...
void func_211()
{
	if (iLocal_531 == 0)
	{
		if (func_212(PLAYER::PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			...
			func_508("*** Played special Josh 4 police report ***");
			iLocal_531 = 1;
		}
	}
}
	...
	switch (iLocal_100)
	{
		case 0:
			if (iLocal_99 == 3)
			{
				if (func_460(Local_441.f_28[0]))
				{
					...
					{
						func_508("Josh car not ok - do Josh flee anyway");
						TASK::OPEN_SEQUENCE_TASK(&iLocal_504);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_108, 2f, 20000, 1f, 1, 40000f);
						if (func_208(iLocal_506))
						{
							TASK::TASK_ENTER_VEHICLE(0, iLocal_506, 20000, -1, 2f, 1, 0);
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_506, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, true);
						}
						else
						{
		...
		case 1:
			if (func_460(Local_441.f_28[0]))
			{
				if (!iLocal_523)
				{
					if (iLocal_513[0] || iLocal_513[1])
					{
						if (func_214(Local_441.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							...
							func_508("Doing Josh comment");
						}
						else
						{
							func_508("Too far away to do Josh comment");
						}
						iLocal_523 = 1;
					}
				}
				...
				{
					func_508("Deleting Josh, setting as lost");
					func_237(&(Local_441.f_28[0]));
					func_236(&iLocal_506);
					iLocal_100 = 2;
				}
				if (func_460(PLAYER::PLAYER_PED_ID()) && func_460(Local_441.f_28[0]))
				{
					if (iLocal_527 < 3)
					{
...
void func_239(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	MISC::SET_BIT(&Global_20711, false);
...
void func_241()
{
	switch (Local_87.f_11)
	{
		case 0:
			...
			while (iLocal_508 <= 4)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_532[iLocal_508 /*7*/], Local_532[iLocal_508 /*7*/].f_3, Local_532[iLocal_508 /*7*/].f_6, false, true, 2))
				{
					...
					func_508("Requesting flee recording: ");
			...
			if (func_208(Local_87.f_7))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_87.f_7))
				{
					if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_87.f_9, Local_87.f_10))
					{
						...
						func_508("Flee car recording finished!");
						Local_87.f_11 = 4;
					}
				}
				else
		...
		case 4:
			...
			func_508("Flee car & ped released!");
			break;
	}
}
...
void func_243()
{
	...
	switch (iLocal_99)
	{
		case 0:
			...
			{
				func_508("************************************** TIMEOUT - AIM next frame");
				iLocal_99 = 1;
				iLocal_509 = MISC::GET_GAME_TIMER();
			}
			iVar0 = 1;
			while (iVar0 <= (Local_441.f_28 - 1))
			{
				if (func_460(Local_441.f_28[iVar0]))
				{
					...
					{
						func_508("************************************** TOO FAR - AIM next frame");
						iLocal_99 = 1;
						iLocal_509 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 2:
			...
			{
				func_508("************************************** TIMEOUT - ARREST next frame");
				if (func_460(Local_441.f_28[1]))
				{
			...
			while (iVar0 <= (Local_441.f_28 - 1))
			{
				if (func_460(Local_441.f_28[iVar0]))
				{
					...
					{
						func_508("************************************** TOO FAR - ATTACK next frame");
						iLocal_99 = 3;
						iLocal_509 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 4:
			...
			while (iVar0 <= (Local_441.f_28 - 1))
			{
				if (func_460(Local_441.f_28[iVar0]))
				{
					...
					{
						func_508("************************************** THREAT DURING ARREST - ATTACK next frame");
						iLocal_99 = 3;
						iLocal_509 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 3:
			...
			if (!iLocal_516)
			{
				...
				func_508("Doing cop fire warning");
				iLocal_516 = 1;
			...
			else
			{
				...
				{
					if (func_460(Local_441.f_28[iVar1]))
					{
		...
		while (iVar0 <= (Local_441.f_28 - 1))
		{
			if (func_460(Local_441.f_28[iVar0]))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_441.f_28[iVar0]))
				{
					...
					{
						func_508("************************************** AIMED WEAPON - ATTACK now");
						iLocal_99 = 3;
					}
				}
				if (func_244(Local_441.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					func_508("************************************** ATTACKED/THREATENED - ATTACK now");
					iLocal_99 = 3;
				}
				if (iLocal_99 != 4)
				{
...
bool func_247(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_460(iParam0) || !func_460(iParam1))
	{
		if (iVar4 != -1)
		{
...
void func_265()
{
	...
	else if (!iLocal_521)
	{
		...
		func_508("Starting 'JOSH4_ACTION'");
		iLocal_521 = 1;
	}
	else if (!iLocal_522)
	{
		if (func_460(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				func_508("Starting 'JOSH4_VEHICLE'");
				iLocal_522 = 1;
			}
		}
	}
...
void func_266()
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_460(Local_441.f_28[1]))
		{
			func_508("Trying to set Cop 1 component variation (intro loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_441.f_28[1], 0);
		}
		if (func_460(Local_441.f_28[2]))
		{
			func_508("Trying to set Cop 2 component variation (intro loop)");
			...
			switch (iLocal_525)
			{
				...
				case 3:
					...
					if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
					{
						...
						{
							AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_START");
							func_508("Starting 'JOSH4_START' via cutscene skip");
							iLocal_520 = 1;
						}
					}
					break;
...
void func_278()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_460(Local_441.f_28[0]))
		{
			func_508("Playing Josh's leadout");
			TASK::OPEN_SEQUENCE_TASK(&iLocal_504);
...
void func_294()
{
	...
	if (func_460(Local_441.f_28[1]))
	{
		...
		func_508("*** Registered Cop standing");
	}
	if (func_460(Local_441.f_28[2]))
	{
		...
		func_508("*** Registered Cop with notepad");
	}
	if (func_460(iLocal_502))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_502, "Security_guard_pistol", 0, 0, 0);
		func_508("*** Registered idle cop gun");
	}
	if (func_460(iLocal_503))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_503, "FBI_Agent_1_Gun", 0, 0, 0);
		func_508("*** Registered notepad cop gun");
	}
	iLocal_520 = 0;
	iLocal_521 = 0;
	iLocal_522 = 0;
...
void func_304()
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (func_460(Local_441.f_28[1]))
		{
			func_508("Trying to set Cop 1 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_441.f_28[1], 0);
		}
		if (func_460(Local_441.f_28[2]))
		{
			func_508("Trying to set Cop 2 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_with_notepad", Local_441.f_28[2], 0);
		}
	}
	switch (iLocal_86)
	{
		case 0:
			...
			{
				func_508("Doing setup for leadin");
				func_232(&uLocal_276, 4, Local_441.f_28[0], "JOSH", 0, 1);
				func_232(&uLocal_276, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				STREAMING::REQUEST_ANIM_DICT("rcmjosh4");
			...
			{
				func_508("Skipping setup for leadin (repeat play/wrong area)");
				func_301(1);
			}
			break;
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, false, true, 0))
			{
				if (func_460(PLAYER::PLAYER_PED_ID()) && func_268(Local_441.f_28[0]))
				{
				...
				if (!iLocal_517)
				{
					if (func_268(Local_441.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_441.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_210())
						{
							...
							func_508("Done Josh leadin anim");
							if (func_268(Local_441.f_28[2]))
							{
								...
								func_508("Done Notepad cop leadin anim");
							}
							if (func_268(Local_441.f_28[1]))
							{
								...
								func_508("Done Speaker cop leadin anim");
							}
				...
				{
					if ((func_460(PLAYER::PLAYER_PED_ID()) && func_268(Local_441.f_28[0])) && !func_305())
					{
						if (!func_298(PLAYER::PLAYER_PED_ID(), joaat("script_task_turn_ped_to_face_entity")))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_441.f_28[0], 0);
					...
					if (func_268(Local_441.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_441.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							...
							if (func_214(PLAYER::PLAYER_PED_ID(), Local_441.f_28[0], 1) <= 2f)
							{
								...
								func_508("Player too close to Josh, starting cutscene early");
								func_301(1);
							}
						}
						else
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_316(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_327(0) || Global_78960) || Global_78948 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78944)
...
{
	return func_329(iParam0, Global_43377);
}
...
void func_330()
{
	...
	if (!func_336())
	{
		func_335(PLAYER::PLAYER_PED_ID(), Local_104, fLocal_107, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_302(1);
...
int func_335(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_337(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_419(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_418(Param1, 0f, 0f, 0f, 0))
		{
		...
		if (Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_401(iParam0, &(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_401(iParam0, &(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_154(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_343(iParam1, &(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113810.f_20121[iParam0 /*43*/].f_31 = func_342(*iParam1);
				...
				func_340(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113810.f_20121[iParam0 /*43*/].f_1));
				...
				func_340(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113810.f_20121[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_344(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_377(iVar0, bParam1, uParam2) && !func_376(PLAYER::PLAYER_ID())) && !func_357(iParam0))
	{
		return 0;
	}
...
int func_346(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			...
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_351(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_352(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_353(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_354(int iParam0)
{
	...
	if ((((!func_356(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_355(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
{
	if (func_375(PLAYER::PLAYER_ID()) || func_374(PLAYER::PLAYER_ID()))
	{
		if (func_358(iParam0))
		{
			return 1;
...
int func_361(int iParam0)
{
	...
	if (func_376(iParam0) && Global_2657704[iParam0 /*463*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_374(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[iParam0 /*463*/].f_321.f_10 != func_221())
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_375(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657704[iParam0 /*463*/].f_321.f_10 != func_221())
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_376(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_2657704[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_347(Global_2657704[iParam0 /*463*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
void func_379(int iParam0, int iParam1)
{
	...
	func_380(iParam0, &(Global_113810.f_32752.f_5510));
}
...
void func_380(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_382(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_381(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_288(iParam0, 0, 0)) || func_288(iParam0, 1, 0)) || func_288(iParam0, 2, 0)) || func_397(iParam0) != 145) || func_396(iParam0)) || func_395(iParam0)) || func_345(iParam0)) || func_394(iParam0)) || !func_384(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_395(iParam0))
		{
		}
...
int func_385(int iParam0, bool bParam1, int iParam2)
{
	int iVar0;
	struct<2> Var1;
...
int func_401(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_406(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_373(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_404(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_404(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_403(iParam0);
	if (func_402(*iParam0))
	{
...
int func_404(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_405(iParam0, 38) + 1;
		iVar1 = func_405(iParam0, 24) + 1;
...
int func_405(int iParam0, int iParam1)
{
	...
	while (iVar0 >= 0 && func_406(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
{
	if (!func_407() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_410(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98144[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98144[iVar0]) == func_411(iParam0, iParam1))
				{
...
void func_412(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_417(&(Global_77479.f_555[0 /*21*/]), iVar0))
		{
...
void func_413(int iParam0)
{
	...
	if (func_417(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_185(iParam0, 0)) && Global_78388.f_66 == 0) && Global_113810.f_32752.f_1958[Global_77479.f_555[0 /*21*/].f_14] != 0) && Global_113810.f_32752.f_1958[Global_77479.f_555[0 /*21*/].f_14] > 3) && (!func_415(0, Global_77479.f_555[0 /*21*/].f_12) || !func_415(1, Global_77479.f_555[0 /*21*/].f_12)))
			{
				func_414(&(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]), &Global_78388);
...
int func_415(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_416(&(Global_113810.f_32752.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_385(Global_113810.f_32752.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
int func_417(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_418(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_418(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_418(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_419(struct<3> Param0, float fParam3)
{
	return func_420(&(Global_107357.f_2890), Param0, fParam3, 0);
}

int func_420(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_444(uParam0))
	{
		...
		if (func_443(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_425(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_398(iVar0, uParam0->f_11);
				}
				else if ((!func_422(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_421(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_422(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_424(iParam0, Global_77479.f_139[38], 0))
			{
				func_413(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_424(iParam0, Global_77479.f_139[43], 1))
			{
				func_413(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_424(iParam0, uVar1[iVar6], 1) && func_423(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_418(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_423(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_425(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (BitTest(uParam1->f_77, func_381(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (BitTest(uParam1->f_77, func_381(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_381(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (BitTest(uParam1->f_77, func_381(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_381(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (BitTest(uParam1->f_77, func_381(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_381(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (BitTest(uParam1->f_77, func_381(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_381(iVar4));
					}
				}
				iVar4++;
			}
		...
		else if (uParam1->f_66 == joaat("surfer3"))
		{
			...
			while (iVar5 <= 2)
			{
				if (BitTest(uParam1->f_77, func_381(iVar5)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_381(iVar5));
				}
				iVar5++;
			}
		}
		...
		{
			if (BitTest(uParam1->f_77, func_381(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_381(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_381(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				if (BitTest(uParam1->f_77, func_381(iVar6)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_381(iVar6));
				}
				iVar6++;
			}
		}
		...
		{
			if (func_434(uParam1->f_5) || func_434(uParam1->f_6))
			{
			}
			else
			{
		...
		if (((BitTest(uParam1->f_77, 15) || func_433(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_432())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar7 <= 11)
			{
				if (BitTest(uParam1->f_77, func_381(iVar7 + 1)))
				{
		...
		if ((((func_426() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_355(1)))
		{
...
int func_426()
{
	...
	if (func_429(7))
	{
		if (func_428(Global_2672524.f_4.f_16) || func_427(Global_2672524.f_4.f_16))
		{
			return 0;
		}
	}
...
{
	return func_430(&(Global_2672524.f_184), iParam0);
}
...
int func_436(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_442(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_438(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_444(var uParam0)
{
	...
	if (!func_385(uParam0->f_12.f_66, 0, -1))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_423(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_445()
{
	return func_443(&(Global_107357.f_2890));
}

void func_446()
{
	func_447(&(Global_107357.f_2890));
}
...
int func_448(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_450(Global_107357.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_451()
{
	return func_444(&(Global_107357.f_2890));
}
		...
		if (bParam2)
		{
			if (!Global_78689)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9029[iParam1 /*4*/] = { func_454(iParam0) };
					...
					{
						Global_8980[1 /*6*/] = { func_454(iParam0) };
...
void func_459()
{
	...
	if (func_336())
	{
		if (func_334(0, 1))
		{
			func_508("*** Opened Josh gate for replay");
		}
	}
	func_508("*** Set up coords");
}
...
void func_461(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_460(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_460(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_460(uParam0->f_41[iVar0]))
		{
...
int func_462(var uParam0)
{
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_472(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_77 = 1;
			break;
		
		case 1:
			if (!func_471(&iVar0) || !func_469(&(uParam0->f_48)))
			{
				return 0;
			}
			if (!func_334(0, 1))
		...
		case 2:
			...
			{
				if (func_466(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_465(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_460(uParam0->f_28[1]))
				{
			...
			{
				func_465(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_460(uParam0->f_28[2]))
				{
			...
			{
				func_464(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_463(&(uParam0->f_35[1]), 0);
...
void func_463(int* iParam0, bool bParam1)
{
	...
	func_464(iParam0, iLocal_79, Var0, fVar3);
...
void func_464(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_236(iParam0);
...
void func_465(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_237(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_466(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_467(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_467(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_475()
{
	...
	if (func_485())
	{
		func_508("...Random Character Script was triggered so additional cleanup required");
	}
	iVar0 = 1;
	while (iVar0 <= (Local_441.f_28 - 1))
	{
...
int func_488(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_494())
	{
		...
		{
			iVar33 = func_489(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_490()
{
	...
	iVar0 = func_491(&(Global_100833.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_491(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
	
	iVar0 = MISC::GET_HASH_KEY(sParam0);
	iVar1 = func_492(iVar0, 1);
	if (iVar1 == -1 && !bParam1)
	{
	}
	return iVar1;
...
int func_494()
{
	...
	{
		if (func_489(&(Global_100833.f_3)) > -1)
		{
			return 1;
		}
	}
