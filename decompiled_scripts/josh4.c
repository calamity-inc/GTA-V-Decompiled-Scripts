...
void __EntryFunction__()
{
	...
	if (func_467())
	{
		...
		func_466(Local_106, fLocal_109, 1, 0);
		func_501("*** Replay setup started");
		Global_78564 = 1;
		iLocal_79 = 0;
		while (!func_455(&Local_443))
		{
			SYSTEM::WAIT(0);
		}
		func_501("*** Josh 4 scene set up");
		func_454(&Local_443, 0, 1);
		Global_78564 = 0;
	}
	if (func_453(Local_443.f_28[1]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_443.f_28[1], true);
	}
	if (func_453(Local_443.f_28[2]))
	{
	...
	switch (iLocal_88)
	{
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_209())
			{
				...
				{
					if (func_453(Local_443.f_28[iVar0]))
					{
...
int func_32(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78130[1 /*14*/] = { func_84(iVar0, iParam1, uVar31[iParam1], -1) };
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_84(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_84(iVar10, 14, uVar69[iVar1], -1) };
			func_51(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_67(14);
			if (Global_78128 == 1)
			{
	...
	switch (iLocal_102)
	{
		...
		case 1:
			if (func_453(Local_443.f_28[0]))
			{
				...
				if (func_453(PLAYER::PLAYER_PED_ID()) && func_453(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
	...
	switch (iLocal_101)
	{
		...
		case 3:
			...
			else
			{
				...
				{
					if (func_453(Local_443.f_28[iVar1]))
					{
...
void func_276()
{
	...
	{
		if (func_453(iLocal_504) && func_453(Local_443.f_28[1]))
		{
	...
	{
		if (func_453(iLocal_505) && func_453(Local_443.f_28[2]))
		{
...
void func_302()
{
	...
	switch (iLocal_88)
	{
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, false, true, 0))
			{
				if (func_453(PLAYER::PLAYER_PED_ID()) && func_267(Local_443.f_28[0]))
				{
				...
				{
					if ((func_453(PLAYER::PLAYER_PED_ID()) && func_267(Local_443.f_28[0])) && !func_303())
					{
						if (!func_296(PLAYER::PLAYER_PED_ID(), joaat("script_task_turn_ped_to_face_entity")))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 0);
	...
	if (Global_78573 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_314(Global_78574, Global_78576, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_405(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_412(struct<3> Param0, float fParam3)
{
	return func_413(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_413(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_415(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_417(iParam0, uVar1[iVar6], 1) && func_416(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_456(int* iParam0, bool bParam1)
{
	...
	func_457(iParam0, iLocal_81, Var0, fVar3);
...
void func_457(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_235(iParam0);
...
void func_458(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_236(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_459(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_460(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_481(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_487())
	{
		...
		{
			iVar33 = func_482(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_484(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
