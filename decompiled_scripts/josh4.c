...
float func_211(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_212()
{
	if (iLocal_528 == 0)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, false, true, 0))
		{
			...
			func_231(&uLocal_278, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (iLocal_102 != 0)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_531) > 6000)
			{
				...
				else if (iLocal_102 == 1)
				{
					if (func_457(Local_443.f_28[0]))
					{
						if (func_213(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) < 75f)
						{
				...
				if (func_457(Local_443.f_28[0]))
				{
					...
					if (func_207(iLocal_508))
					{
						if (MISC::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, false, true, false, false, false, iLocal_508, false))
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_110, 2f, 20000, 1f, 1, 40000f);
		...
		case 1:
			if (func_457(Local_443.f_28[0]))
			{
				if (!iLocal_525)
				{
					...
					{
						if (func_213(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							func_231(&uLocal_278, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_231(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
							if (func_209())
				...
				if (func_213(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) > 350f)
				{
				...
				if (func_457(PLAYER::PLAYER_PED_ID()) && func_457(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						if (func_213(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) < 10f)
						{
							if (!func_209() && (MISC::GET_GAME_TIMER() - iLocal_532) > 8000)
							{
	...
	switch (iLocal_101)
	{
		case 0:
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_457(Local_443.f_28[iVar0]))
				{
					if (func_213(Local_443.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 10f)
					{
		...
		case 2:
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_457(Local_443.f_28[iVar0]))
				{
					if (func_213(Local_443.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_518)
			{
				...
				func_231(&uLocal_113, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			else
			{
				...
				while (iVar1 <= (Local_443.f_28 - 1))
				{
					...
					{
						if (func_213(Local_443.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) > 20f)
						{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_530) > 15000)
				{
					...
					while (iVar1 <= (Local_443.f_28 - 1))
					{
						if (func_457(Local_443.f_28[iVar1]))
						{
							if (func_213(Local_443.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) >= 50f)
							{
	...
	if (iLocal_101 != 3)
	{
		...
		while (iVar0 <= (Local_443.f_28 - 1))
		{
			if (func_457(Local_443.f_28[iVar0]))
			{
				...
				if (iLocal_101 != 4)
				{
					if (func_213(Local_443.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) < 2.3f)
					{
...
void func_302()
{
	...
	switch (iLocal_88)
	{
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, false, true, 0))
			{
				if (func_457(PLAYER::PLAYER_PED_ID()) && func_267(Local_443.f_28[0]))
				{
				...
				if (!iLocal_519)
				{
					...
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_443.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_209())
						{
				...
				{
					if ((func_457(PLAYER::PLAYER_PED_ID()) && func_267(Local_443.f_28[0])) && !func_303())
					{
						if (!func_296(PLAYER::PLAYER_PED_ID(), joaat("script_task_turn_ped_to_face_entity")))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 0);
					...
					if (func_267(Local_443.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							...
							if (func_213(PLAYER::PLAYER_PED_ID(), Local_443.f_28[0], 1) <= 2f)
							{
								if (func_209())
								{
									func_232();
...
{
	if (((!func_325(0) || Global_78828) || Global_78817 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78813)
...
void func_328()
{
	...
	if (!func_334())
	{
		func_333(PLAYER::PLAYER_PED_ID(), Local_106, fLocal_109, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_300(1);
...
int func_333(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_342(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	bVar1 = false;
	if (func_351(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
...
int func_352(int iParam0)
{
	...
	if ((!func_353(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger"))
	{
		return 0;
	}
	return 1;
...
int func_355(int iParam0)
{
	...
	if (func_358(PLAYER::PLAYER_ID()) && (!func_352(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_356(int iParam0)
{
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_348(iParam0)) || func_357(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_374(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_351(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_286(iParam0, 0, 0)) || func_286(iParam0, 1, 0)) || func_286(iParam0, 2, 0)) || func_394(iParam0) != 145) || func_393(iParam0)) || func_392(iParam0)) || func_343(iParam0)) || func_391(iParam0)) || !func_381(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_392(iParam0))
		{
		}
...
void func_407(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0]) == func_408(iParam0, iParam1))
				{
...
void func_422(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((func_423() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
void func_460(int* iParam0, bool bParam1)
{
	...
	func_461(iParam0, iLocal_81, Var0, fVar3);
...
void func_462(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_236(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_463(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_464(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_464(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_485(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_491())
	{
		...
		{
			iVar33 = func_486(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
