...
int func_135(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_163(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	struct<3> Var0;
	var uVar3;
...
void func_164(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
int func_180(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
void func_187(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_30())
	{
...
float func_191(int iParam0, int iParam1, bool bParam2)
{
	struct<3> Var0;
	struct<3> Var3;
