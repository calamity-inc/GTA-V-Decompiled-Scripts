...
void func_110(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_117(struct<3> Param0, int iParam3)
{
	return func_118(Global_104212.f_2890.f_12.f_66, Param0, iParam3);
}

int func_118(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_122(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_131(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_161(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	struct<3> Var0;
	var uVar3;
...
void func_162(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_175(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_73(&(Global_77348.f_555[0 /*21*/]), iParam0))
	{
...
int func_178(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
void func_185(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_30())
	{
