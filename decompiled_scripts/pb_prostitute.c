...
void func_98(var uParam0)
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			else if (iLocal_294 != 0 && !func_470("PROS_NO_MONEY"))
			{
				func_64(0);
				switch (func_23())
				{
...
void func_295(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_320(Global_23711.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23711.f_6331)
		{
			...
			else
			{
				...
				{
					func_315();
					func_313((((Global_23708 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT", Global_23711.f_6339, Global_23711.f_6340)), ((Global_23709 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23711.f_6339, Global_23711.f_6340);
				}
				else if (Global_23711.f_6334 > Global_23711.f_5828)
				{
					...
					{
						func_315();
						func_313((((Global_23708 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT", Global_23711.f_6337, Global_23711.f_6336)), ((Global_23709 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23711.f_6337, Global_23711.f_6336);
					}
				}
			}
...
int func_379(int iParam0)
{
	...
	if (iLocal_306[iParam0] == 0)
	{
		...
		else if ((((ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("casco") || ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("feltzer3")) || ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("fagaloa")) || ENTITY::GET_ENTITY_MODEL(iLocal_97) == joaat("warrener2")) || ENTITY::GET_ENTITY_MODEL(iLocal_97) == -122993285)
		{
...
void func_536(var uParam0)
{
	...
	if (func_470("PROS_ACCEPT") && !Global_32980)
	{
		HUD::CLEAR_HELP(true);
	}
