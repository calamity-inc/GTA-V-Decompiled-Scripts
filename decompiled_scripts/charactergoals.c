		...
		switch (iLocal_16)
		{
			case 0:
				if (iLocal_17[0])
				{
					...
					StringCopy(&(Global_23544[3 /*42*/]), "PA_TREV1", 16);
					StringCopy(&(Global_23544[3 /*42*/].f_4), "PA_TREV1", 16);
					Global_23544[3 /*42*/].f_8 = 0;
					Global_23544[3 /*42*/].f_9 = 1;
					StringCopy(&(Global_23544[3 /*42*/].f_10[1 /*4*/]), "PA_TREV1A", 16);
					...
					func_43(2, 3, 1, 1);
					func_40("PA_TREV1A", Global_23544[3 /*42*/].f_27[1]);
					iLocal_16 = 1;
				}
				break;
