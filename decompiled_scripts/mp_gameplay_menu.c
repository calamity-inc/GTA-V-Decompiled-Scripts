...
void func_15()
{
	...
	{
		func_26(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 201, true), "FMMC_SEL_ACCE", &(Local_19.f_4), 0);
		func_26(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 202, true), "FMMC_SEL_CANC", &(Local_19.f_4), 0);
		func_26(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 188, true), "FMMC_SEL_UP", &(Local_19.f_4), 0);
		func_26(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 187, true), "FMMC_SEL_DOWN", &(Local_19.f_4), 0);
	}
	Var0 = { func_25() };
...
void func_27()
{
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && func_32(0, 0))
	{
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23831.f_6331)
		{
			...
			else
			{
				...
				{
					func_61();
					func_59((((Global_23828 + fParam5) - 0.00390625f) - func_60("CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340);
				}
				else if (Global_23831.f_6334 > Global_23831.f_5828)
				{
					...
					{
						func_61();
						func_59((((Global_23828 + fParam5) - 0.00390625f) - func_60("CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336);
					}
				}
			}
...
void func_44(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)
{
...
void func_50(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_66(bool bParam0, int* iParam1, int* iParam2, float fParam3)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_94()
{
	...
	if ((PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_RELEASED(2, 237)) && Global_4541816 != Local_19.f_2)
	{
	...
	else if ((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 201) || PAD::IS_CONTROL_JUST_PRESSED(2, 201)) || ((PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_RELEASED(2, 237)) && Global_4541816 == Local_19.f_2))
	{
		func_89(2);
		AUDIO::PLAY_SOUND_FRONTEND(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
	}
