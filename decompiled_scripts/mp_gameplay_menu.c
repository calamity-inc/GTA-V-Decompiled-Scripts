...
int func_6(var uParam0, bool bParam1, int iParam2)
{
	char cVar0[64];
	int iVar16;
	int iVar17;
...
void func_14()
{
	...
	if (PAD::HAVE_CONTROLS_CHANGED(2) && Local_44.f_4.f_693 != 0)
	{
	...
	{
		func_25(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 201, true), "FMMC_SEL_ACCE", &(Local_44.f_4), 0);
		func_25(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 202, true), "FMMC_SEL_CANC", &(Local_44.f_4), 0);
		func_25(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 188, true), "FMMC_SEL_UP", &(Local_44.f_4), 0);
		func_25(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(0, 187, true), "FMMC_SEL_DOWN", &(Local_44.f_4), 0);
	}
	Var0 = { func_24() };
...
void func_15(var uParam0, var uParam1, var uParam2, int iParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_25(char* sParam0, char* sParam1, var uParam2, char* sParam3)
{
	int iVar0;
...
void func_28(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		...
		{
			func_71(Global_23711.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23711.f_6331)
		{
			...
			else
			{
				...
				{
					func_54();
					func_52((((Global_23708 + fParam5) - 0.00390625f) - func_53("CM_ITEM_COUNT", Global_23711.f_6339, Global_23711.f_6340)), ((Global_23709 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23711.f_6339, Global_23711.f_6340);
				}
				else if (Global_23711.f_6334 > Global_23711.f_5828)
				{
					...
					{
						func_54();
						func_52((((Global_23708 + fParam5) - 0.00390625f) - func_53("CM_ITEM_COUNT", Global_23711.f_6337, Global_23711.f_6336)), ((Global_23709 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23711.f_6337, Global_23711.f_6336);
					}
				}
			}
...
void func_37(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)
{
...
void func_41(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_42(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
void func_43(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (!Global_23711.f_5327)
		{
			...
			while (iVar1 < Global_23711.f_5326)
			{
				if (MISC::GET_HASH_KEY(&(Global_23711.f_5553[iVar1 /*4*/])) != MISC::GET_HASH_KEY("PREV"))
				{
					...
					func_19(&(Global_23711.f_5328[bVar1 /*16*/]));
					iVar2 = bVar1 + 1;
					...
					{
						func_18(&(Global_23711.f_5553[bVar1 /*4*/]));
					}
					else
					{
...
void func_50(int iParam0, bool bParam1, int* iParam2, int* iParam3, int* iParam4, int* iParam5)
{
...
float func_53(char* sParam0, int iParam1, int iParam2)
{
...
void func_55(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_60(bool bParam0, int* iParam1, int* iParam2, float fParam3)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
var func_70(var uParam0, int iParam1)
{
	return BitTest((*uParam0)[(iParam1 / 32)], (iParam1 % 32));
}

void func_71(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5, int iParam6)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_79(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
...
void func_80(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
...
void func_91()
{
	...
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 188) || PAD::IS_CONTROL_JUST_PRESSED(2, 188))
	{
		iVar0 = (iVar0 - 1);
		AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
	}
	PAD::DISABLE_CONTROL_ACTION(0, 187, true);
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 187) || PAD::IS_CONTROL_JUST_PRESSED(2, 187))
	{
		iVar0++;
		AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
	}
	...
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 201) || PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		func_86(2);
...
bool func_95(char* sParam0, int iParam1, bool bParam2)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
