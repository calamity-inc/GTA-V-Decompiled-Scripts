...
void func_1()
{
	...
	while (bLocal_228 < 6)
	{
		if (func_7(PLAYER::INT_TO_PLAYERINDEX(iLocal_227), 0, 1))
		{
			...
			{
				MISC::CLEAR_BIT(&(Local_230.f_2[bLocal_228]), bLocal_227);
			}
		}
		else
		{
			MISC::CLEAR_BIT(&(Local_230.f_9[bLocal_228]), bLocal_227);
			MISC::CLEAR_BIT(&(Local_230.f_9[bLocal_228]), bLocal_227);
		}
	...
	if (iLocal_260[bParam0] == 0)
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_PENDING_STATE(iParam1) == -1)
		{
			if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(iParam1) != iParam2)
			{
				...
				{
					MISC::SET_BIT(&(iLocal_260[bParam0]), bVar0);
...
void func_9()
{
	...
	if ((BitTest(Global_2803781, iLocal_229) || BitTest(Global_2803781.f_1, iLocal_229)) || BitTest(Global_2803781.f_2, iLocal_229))
	{
		...
		if (BitTest(Global_2803781.f_1, bLocal_229))
		{
			MISC::CLEAR_BIT(&(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_229);
		}
		if (BitTest(Global_2803781.f_2, bLocal_229))
		{
			MISC::SET_BIT(&(Local_280[PLAYER::PLAYER_ID() /*4*/].f_3), bLocal_229);
		}
	}
	else if (fVar0 <= 20f)
	{
		if (OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, Local_124[bLocal_229 /*17*/].f_3, Local_124[bLocal_229 /*17*/].f_6, Local_124[bLocal_229 /*17*/].f_9, false, true))
		{
			if (!BitTest(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_229))
			{
				MISC::SET_BIT(&(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_229);
			}
		}
		if ((bLocal_229 == 0 || bLocal_229 == 1) || bLocal_229 == 5)
		{
			if (Global_2696135 || !func_13())
			{
				if (OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, Local_124[bLocal_229 /*17*/].f_10, Local_124[bLocal_229 /*17*/].f_13, Local_124[bLocal_229 /*17*/].f_16, false, true))
				{
					if (!BitTest(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_229))
					{
						MISC::SET_BIT(&(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_229);
		...
		if ((bLocal_229 == 2 || bLocal_229 == 3) || bLocal_229 == 4)
		{
			if (func_11() >= 0)
			{
				if (func_10(29))
				...
				else if (BitTest(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_229) && !OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, Local_124[bLocal_229 /*17*/].f_3, Local_124[bLocal_229 /*17*/].f_6, Local_124[bLocal_229 /*17*/].f_9, false, true))
				{
					MISC::CLEAR_BIT(&(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_229);
				}
			}
	...
	else if (BitTest(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_229))
	{
		MISC::CLEAR_BIT(&(Local_280[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_229);
	}
	bLocal_229++;
...
struct<15> func_49(int iParam0, int iParam1)
{
	struct<15> Var0;
...
void func_51(struct<15> Param0, bool bParam15)
{
	if (Param0.f_0 != 0)
	{
...
void func_67(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_66();
