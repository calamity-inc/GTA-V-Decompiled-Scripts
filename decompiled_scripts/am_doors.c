...
void func_1()
{
	...
	while (bLocal_230 < 6)
	{
		if (func_7(PLAYER::INT_TO_PLAYERINDEX(iLocal_229), 0, 1))
		{
			...
			{
				MISC::CLEAR_BIT(&(Local_232.f_2[bLocal_230]), bLocal_229);
			}
		}
		else
		{
			MISC::CLEAR_BIT(&(Local_232.f_9[bLocal_230]), bLocal_229);
			MISC::CLEAR_BIT(&(Local_232.f_9[bLocal_230]), bLocal_229);
		}
	...
	if (iLocal_262[bParam0] == 0)
	{
		if (OBJECT::DOOR_SYSTEM_GET_DOOR_PENDING_STATE(iParam1) == -1)
		{
			if (OBJECT::DOOR_SYSTEM_GET_DOOR_STATE(iParam1) != iParam2)
			{
				...
				{
					MISC::SET_BIT(&(iLocal_262[bParam0]), bVar0);
...
void func_9()
{
	...
	if ((BitTest(Global_2748465, iLocal_231) || BitTest(Global_2748465.f_1, iLocal_231)) || BitTest(Global_2748465.f_2, iLocal_231))
	{
		...
		if (BitTest(Global_2748465.f_1, bLocal_231))
		{
			MISC::CLEAR_BIT(&(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_231);
		}
		if (BitTest(Global_2748465.f_2, bLocal_231))
		{
			MISC::SET_BIT(&(Local_282[PLAYER::PLAYER_ID() /*4*/].f_3), bLocal_231);
		}
	}
	else if (fVar0 <= 20f)
	{
		if (OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, Local_126[bLocal_231 /*17*/].f_3, Local_126[bLocal_231 /*17*/].f_6, Local_126[bLocal_231 /*17*/].f_9, false, true))
		{
			if (!BitTest(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_231))
			{
				MISC::SET_BIT(&(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_231);
			}
		}
		if ((bLocal_231 == 0 || bLocal_231 == 1) || bLocal_231 == 5)
		{
			if (Global_2697675 || !func_13())
			{
				if (OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, Local_126[bLocal_231 /*17*/].f_10, Local_126[bLocal_231 /*17*/].f_13, Local_126[bLocal_231 /*17*/].f_16, false, true))
				{
					if (!BitTest(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_231))
					{
						MISC::SET_BIT(&(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_231);
		...
		if ((bLocal_231 == 2 || bLocal_231 == 3) || bLocal_231 == 4)
		{
			if (func_11() >= 0)
			{
				if (func_10(29))
				...
				else if (BitTest(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_231) && !OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, Local_126[bLocal_231 /*17*/].f_3, Local_126[bLocal_231 /*17*/].f_6, Local_126[bLocal_231 /*17*/].f_9, false, true))
				{
					MISC::CLEAR_BIT(&(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_231);
				}
			}
	...
	else if (BitTest(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2, bLocal_231))
	{
		MISC::CLEAR_BIT(&(Local_282[PLAYER::PLAYER_ID() /*4*/].f_2), bLocal_231);
	}
	bLocal_231++;
