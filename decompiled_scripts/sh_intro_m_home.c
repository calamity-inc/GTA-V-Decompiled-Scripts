...
void __EntryFunction__()
{
	...
	iLocal_40 = 0;
	func_230(&uLocal_51);
	func_229(&uLocal_51, -844.1494f, 162.5587f, 65.89324f);
	func_229(&uLocal_51, -849.6625f, 166.8695f, 66.54545f);
	func_229(&uLocal_51, -846.0641f, 198.5984f, 76.9182f);
	func_229(&uLocal_51, -796.5247f, 194.1427f, 77.94861f);
	func_229(&uLocal_51, -774.8713f, 195.2026f, 77.13674f);
	func_229(&uLocal_51, -768.1328f, 190.1837f, 76.24245f);
	func_229(&uLocal_51, -761.3875f, 139.444f, 66.47416f);
	func_229(&uLocal_51, -764.7377f, 137.702f, 66.47416f);
	func_229(&uLocal_51, -800.0312f, 141.218f, 61.96946f);
	func_229(&uLocal_51, -851.1459f, 139.2239f, 60.13711f);
	func_229(&uLocal_51, -850.1609f, 150.5272f, 64.38181f);
	func_229(&uLocal_51, -844.149f, 155.8286f, 65.77842f);
	func_228(&uLocal_51);
	while (true)
	{
		switch (iLocal_35)
...
void func_50(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_46(&(Global_78038.f_555[0 /*21*/]), iParam0))
	{
...
int func_200(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
int func_205(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
int func_212(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_226(struct<3> Param0, struct<3> Param3, float fParam6)
{
	struct<3> Var0;
...
bool func_227(var uParam0, struct<2> Param1, var uParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_229(var uParam0, struct<3> Param1)
{
	if (uParam0->f_51 == 0)
	{
	}
