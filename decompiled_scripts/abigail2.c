...
void __EntryFunction__()
{
	...
	if (func_474())
	{
		...
		{
			case 0:
				func_472(-1595.201f, 5217.495f, 3.0009f, 208.2675f, 1, 0);
				func_388(1);
				break;
			}
	}
...
int func_249(int iParam0)
{
	if (iParam0 != func_221())
	{
		...
		else if ((Global_1575079 && iParam0 == PLAYER::PLAYER_ID()) && func_250(iParam0, 1, 0))
		{
			return Global_2657921[iParam0 /*463*/].f_321.f_7 != -1;
		}
	}
...
void func_269()
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_168) && func_476(iLocal_167))
	{
	...
	switch (iLocal_166)
	{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_337 == 0)
				{
					if (((func_476(iLocal_160) && PED::IS_PED_IN_VEHICLE(iLocal_167, iLocal_160, true)) && func_232(iLocal_167, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_215(&uLocal_171, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_337 = 1;
					}
...
int func_279(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_476(PLAYER::PLAYER_PED_ID()) && func_476(iParam0))
	{
...
bool func_282(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_476(iParam0) || !func_476(iParam1))
	{
		if (iVar4 != -1)
		{
		...
		case 1:
			switch (iLocal_349)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_511(16)) && func_476(iLocal_167))
						{
...
void func_307(bool bParam0)
{
	...
	else if (BitTest(Global_114372.f_20567.f_471, bParam0) || BitTest(Global_2359296[func_309() /*5569*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114372.f_20567.f_471), bParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_309() /*5569*/].f_681.f_10), bParam0);
	}
	if (bVar0)
	{
...
int func_311(int iParam0)
{
	...
	return BitTest(Global_2359296[func_309() /*5569*/].f_681.f_10, iParam0);
}
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_374(Global_79504, Global_79506, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
		...
		if (Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_461(iParam0, &(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_461(iParam0, &(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_461(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_400(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_162(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_404(iParam1, &(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114372.f_20121[iParam0 /*43*/].f_31 = func_403(*iParam1);
				...
				func_401(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114372.f_20121[iParam0 /*43*/].f_1));
				...
				func_401(Global_114372.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114372.f_20121[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_405(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_437(iVar0, bParam1, uParam2) && !func_436(PLAYER::PLAYER_ID())) && !func_417(iParam0))
	{
		return 0;
	}
...
int func_407(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			...
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_411(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_412(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_413(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_421(int iParam0)
{
	...
	if (func_436(iParam0) && Global_2657921[iParam0 /*463*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_434(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			...
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_435(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1 && Global_2657921[iParam0 /*463*/].f_321.f_10 != func_221())
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_436(int iParam0)
{
	if (iParam0 != func_221())
	{
		if (func_250(iParam0, 1, 1))
		{
			if (Global_2657921[iParam0 /*463*/].f_321.f_7 != -1)
			{
				return func_408(Global_2657921[iParam0 /*463*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_437(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
void func_439(int iParam0, int iParam1)
{
	...
	func_440(iParam0, &(Global_114372.f_32753.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_441(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_350(iParam0, 0, 0)) || func_350(iParam0, 1, 0)) || func_350(iParam0, 2, 0)) || func_457(iParam0) != 145) || func_456(iParam0)) || func_455(iParam0)) || func_406(iParam0)) || func_454(iParam0)) || !func_444(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_455(iParam0))
		{
		}
...
int func_445(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		if ((((!func_452() && !func_451()) && !func_450()) && !func_449()) && !func_453())
		{
			return 0;
		}
	}
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_466(*uParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
...
int func_464(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_465(iParam0, 38) + 1;
		iVar1 = func_465(iParam0, 24) + 1;
...
void func_472(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_474())
	{
...
void func_478(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
