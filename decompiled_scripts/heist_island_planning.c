...
void __EntryFunction__()
{
	...
	fLocal_1754 = 100f;
	fLocal_1764 = 0.5f;
	StringCopy(&Local_1507, SCRIPT::GET_THIS_SCRIPT_NAME(), 64);
...
void func_24(var uParam0)
{
	...
	switch (iLocal_1430)
	{
		...
		case 2:
			TASK::OPEN_SEQUENCE_TASK(&iLocal_1433);
			TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_46(iLocal_1431), 0.5f, 20000, func_45(iLocal_1431), 0.05f);
			TASK::TASK_ACHIEVE_HEADING(0, func_45(iLocal_1431), 0);
			...
			TASK::CLOSE_SEQUENCE_TASK(iLocal_1433);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_1439, iLocal_1433);
			iLocal_1430 = 3;
			if (!func_42())
			{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_1439, func_48(), func_43(), 3) && !func_40(&uLocal_1435, 6000, 0))
			{
				return;
			}
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_1439, func_48(), func_43(), 3))
			{
				PED::PLAY_FACIAL_ANIM(iLocal_1439, func_39(), func_48());
			}
			func_38(&uLocal_1435);
			uParam0->f_726.f_5 = 1;
			func_34(uParam0, 14);
		...
		case 5:
			TASK::TASK_PLAY_ANIM(iLocal_1439, func_48(), func_25(), 8f, 1.5f, -1, 262152, 0f, false, false, false);
			if (func_42())
			{
		...
		case 6:
			if ((!iLocal_1416 && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_1439, func_48(), func_25(), 3)) && !func_40(&uLocal_1435, 6000, 0))
			{
				return;
			}
			if (iLocal_1416)
			{
				TASK::CLEAR_PED_TASKS(iLocal_1439);
			}
			STREAMING::REMOVE_ANIM_DICT(func_48());
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_1433);
			func_38(&uLocal_1435);
			iLocal_1430 = 0;
			iLocal_1416 = 0;
			break;
...
void func_127(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam6, struct<3> Param7, bool bParam10, bool bParam11, var uParam12, var uParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, bool bParam21, bool bParam22, bool bParam23, int iParam24, int iParam25, bool bParam26)
{
		...
		if (func_35(Var0))
		{
			if (func_76(PLAYER::PLAYER_ID(), 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_176()) && !ENTITY::IS_ENTITY_DEAD(func_176(), false))
				{
					...
					Var3 = { 0f, 0f, ENTITY::GET_ENTITY_HEADING(func_176()) };
					if (func_74(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_775, 1, 0))
					{
	...
	else if (bParam21)
	{
		...
		Var0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_166(iVar10), func_165(iVar10), 3.5688f, 7.9792f, 4.1641f) };
	...
	{
		func_150();
		func_149(&Var11, 144, Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32);
		if (!func_35(Var11))
		{
			Var0 = { Var11 };
		}
		func_143(&Var11, 144, Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32);
		Var3 = { Var11 };
	}
...
{
	MISC::SET_BIT(&(Local_1527.f_3[(iParam1 / 32)]), (iParam1 % 32));
...
int func_415(var uParam0, int iParam1)
{
	switch (iParam1)
	{
		...
		case 107:
		case 108:
			return (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && uParam0->f_1084 == iLocal_1440);
...
bool func_465(char* sParam0, int iParam1)
{
...
int func_495(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)
{
	int iVar0;
...
void func_511(bool bParam0)
{
	...
	MISC::SET_BIT(&(Global_1975224[PLAYER::PLAYER_ID() /*53*/].f_1), false);
	func_4(9511, iVar0, -1, 1, 0);
	func_523(6);
	func_522();
	func_518();
...
int func_531()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1439) && func_75(iLocal_1440, 1, 1))
	{
		if ((!func_118() && !func_117()) && !func_116())
		{
			if ((INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_1439) != joaat("Rm_Command") && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_1439) != joaat("Rm_Stair1")) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_1439) != joaat("Rm_Room2"))
			{
				return 1;
			}
		}
...
void func_544(int iParam0)
{
	...
	iLocal_1412 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
	iLocal_1414 = 1;
}
...
int func_545(var uParam0, int iParam1)
{
	switch (iParam1)
	{
		...
		case 66:
		case 67:
			if (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && uParam0->f_1084 != iLocal_1440)
			{
				return 0;
			}
			break;
...
void func_548(int iParam0)
{
	...
	iLocal_1411 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
	iLocal_1413 = 1;
}
...
void func_563(var uParam0)
{
	switch (uParam0->f_726)
	{
		...
		case 2:
			if (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !iLocal_1425)
			{
...
void func_577(int iParam0, struct<9> Param1, bool bParam10)
{
	...
	switch (iLocal_1434)
	{
		...
		case 59:
			...
			else
			{
				...
				MONEY::_NETWORK_SPENT_ISLAND_HEIST(Global_262145.f_29917, 0, 1, &Var13);
			}
			func_601(1);
...
void func_604(bool bParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		MISC::SET_BIT(&(Global_1975224[PLAYER::PLAYER_ID() /*53*/].f_5.f_45), bParam0);
	}
	else
	{
		MISC::CLEAR_BIT(&iVar0, bParam0);
		MISC::CLEAR_BIT(&(Global_1975224[PLAYER::PLAYER_ID() /*53*/].f_5.f_45), bParam0);
	}
...
void func_609(var uParam0, int iParam1)
{
	...
	MISC::SET_BIT(&(Local_1527[(iParam1 / 32)]), (iParam1 % 32));
}
...
void func_611(int iParam0, bool bParam1, char* sParam2)
{
...
void func_614(var uParam0, bool bParam1)
{
	...
	if (!MONEY::NETWORK_CAN_SPEND_MONEY(func_608(bParam1), false, true, false, -1, 0))
	{
		return;
	}
...
void func_615(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4)
{
...
int func_686(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 233:
			return func_709(iParam1, iParam2, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), iParam4);
		...
		case 158:
			return func_690(iParam1, iParam2, PLAYER::INT_TO_PLAYERINDEX(bParam5), iParam4);
...
int func_737(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	switch (iParam0)
	{
		...
		case 233:
			return func_759(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_750(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, -1, 0, 0);
		
		case 158:
			return func_744(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, -1, 0, 0);
		
		case 181:
			return func_738(iParam1, iParam3, PLAYER::INT_TO_PLAYERINDEX(bParam5), 0, -1, 0, 0);
...
{
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_1412))
	{
		*iParam0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_1412);
		return 1;
	}
	*iParam0 = -1;
	return 0;
...
{
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_1411))
	{
		*iParam0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_1411);
		return 1;
	}
	*iParam0 = -1;
	return 0;
...
void func_828(var uParam0)
{
	...
	if (iLocal_1432 != Global_1975224[uParam0->f_1084 /*53*/].f_5.f_45)
	{
		...
		while (bVar0 < 6)
		{
			...
			{
				MISC::SET_BIT(&iLocal_1432, bVar0);
	...
	if (bLocal_1422 != Global_1975224[uParam0->f_1084 /*53*/].f_5.f_44)
	{
		bLocal_1422 = Global_1975224[uParam0->f_1084 /*53*/].f_5.f_44;
		func_566(uParam0->f_711, 98, bLocal_1422);
	}
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		return;
...
void func_831(var uParam0)
{
	...
	if (uParam0->f_1084 == PLAYER::PLAYER_ID() && Global_1975224[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*53*/].f_52 != iLocal_1420)
	{
		Global_1975224[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*53*/].f_52 = iLocal_1420;
	}
}
...
void func_833(var uParam0)
{
	...
	if (uParam0->f_1084 == PLAYER::PLAYER_ID() && Global_1975224[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*53*/].f_51 != iLocal_1418)
	{
		Global_1975224[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*53*/].f_51 = iLocal_1418;
	}
}
...
void func_836(int iParam0, char* sParam1)
{
...
void func_842(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
{
	if (((NETWORK::NETWORK_IS_ACTIVITY_SESSION() || uParam0->f_1096) || (uParam0->f_1084 != iLocal_1440 && Global_1974423[uParam0->f_1084 /*25*/].f_20)) || uParam0->f_1097)
	{
		return 1;
	}
	return 0;
...
void func_867(int iParam0, char* sParam1, bool bParam2, char* sParam3, bool bParam4, char* sParam5, bool bParam6)
{
...
void func_875(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
...
void func_876(int iParam0, bool bParam1, bool bParam2)
{
...
void func_877(int iParam0, bool bParam1, bool bParam2, bool bParam3, char* sParam4, char* sParam5)
{
...
void func_927(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, struct<2> Param5, float fParam7)
{
...
void func_935(int iParam0, struct<14> Param1)
{
...
int func_963()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(iLocal_1439, 1561.149f, 386.0429f, -49.68533f, 1f, 0.65f, 1f, false, true, 0) && func_964(ENTITY::GET_ENTITY_HEADING(iLocal_1439), 180f, 60f))
	{
		return 1;
	}
	return 0;
...
void func_977()
{
	iLocal_1439 = PLAYER::PLAYER_PED_ID();
	iLocal_1440 = PLAYER::PLAYER_ID();
}
