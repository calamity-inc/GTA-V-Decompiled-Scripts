		...
		if (!func_105(0) && !func_104(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_114())
				{
					...
					iLocal_461 = BitTest(Global_8137, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
...
void func_12(int iParam0)
{
	...
	func_13(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_13(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_13(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_98(struct<3> Param0, float fParam3, float fParam4)
{
	float fVar0;
	float fVar1;
...
void func_99(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_100(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_116(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7, float fParam8)
{
