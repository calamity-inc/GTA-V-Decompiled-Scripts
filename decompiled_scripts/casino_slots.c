...
void func_1()
{
	...
	{
		func_13();
		MISC::SET_BIT(&(Local_2741.f_659), false);
	}
	func_2();
}
...
void func_47()
{
	...
	if (bVar0)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(0, 0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(0, 0))
		{
			...
			MISC::CLEAR_BIT(&uLocal_1638, false);
		}
	...
	if (!BitTest(uLocal_1638, 3))
	{
		...
		if ((((bVar0 && (!BitTest(Local_2741.f_653[func_11(iLocal_2125)], func_10(iLocal_2125)) || BitTest(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10, 2))) && !BitTest(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10, 0)) && BitTest(uLocal_1638, 0)) && !(BitTest(uLocal_1638, 21) || BitTest(uLocal_1638, 22)))
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 201) || PAD::IS_CONTROL_JUST_PRESSED(2, 208))
			{
				...
				else if (func_197() >= (Local_213[iLocal_2125 /*21*/].f_16 * iLocal_2128))
				{
					if ((((iLocal_1642 == 4 || iLocal_1642 == 10) || iLocal_1642 == 11) || iLocal_1642 == 12) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -278874898))
					{
						...
						func_194();
						MISC::CLEAR_BIT(&(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10), true);
						MISC::CLEAR_BIT(&(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10), 2);
						MISC::CLEAR_BIT(&(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10), false);
			...
			if (!BitTest(uLocal_1638, 3))
			{
				if ((((iLocal_1642 == 4 || iLocal_1642 == 10) || iLocal_1642 == 11) || iLocal_1642 == 12) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -278874898))
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 203) && !BitTest(uLocal_1638, 27))
					{
						MISC::SET_BIT(&uLocal_1638, 30);
						func_186(1, -1, -1, -1);
						iLocal_2128++;
					...
					if (PAD::IS_CONTROL_JUST_RELEASED(2, 204) && !BitTest(uLocal_1638, 28))
					{
						MISC::SET_BIT(&uLocal_1638, 30);
						func_186(1, -1, -1, -1);
						iLocal_2128 = 5;
			...
			if (!BitTest(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10, 3))
			{
				if (((iLocal_1642 == 8 || iLocal_1642 == 14) || iLocal_1642 == 9) || iLocal_1642 == 15)
				{
					if (func_35() > 0.99f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("start_spin")))
					{
						...
						MISC::SET_BIT(&(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10), false);
					}
				}
				else
				{
			...
			if (!BitTest(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10, 1))
			{
				...
				if (Local_213[iLocal_2125 /*21*/] > 0)
				{
					if (func_124(Local_213[iLocal_2125 /*21*/], &iLocal_2740, 0))
					{
						...
						func_60();
						MISC::SET_BIT(&(Local_3401[PLAYER::PLAYER_ID() /*11*/].f_10), true);
						iLocal_2740 = 0;
					}
				}
				else
...
int func_95(int iParam0, int iParam1)
{
	if (NETWORK::NETWORK_CLAN_SERVICE_IS_VALID())
	{
		Global_2707308 = { func_78(iParam0) };
		Global_2707321 = { func_78(iParam1) };
...
int func_164(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	MISC::CLEAR_BIT(&uLocal_1639, false);
	if (iParam1 == iParam2 && iParam2 == iParam3)
	{
		...
		{
			MISC::SET_BIT(&uLocal_1639, false);
		}
		return iVar1;
	}
	else
...
void func_186(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iLocal_2082 != iParam0)
	{
		...
		{
			case 1:
				func_193("SLOTS_HELPB", Local_213[iLocal_2125 /*21*/].f_16, Local_213[iLocal_2125 /*21*/].f_16 * 5);
				break;
...
int func_207(int iParam0)
{
	...
	else if ((((((((Global_262145.f_26515 || (Global_262145.f_26522 && Local_213[iParam0 /*21*/].f_17 == 1)) || (Global_262145.f_26520 && Local_213[iParam0 /*21*/].f_17 == 2)) || (Global_262145.f_26517 && Local_213[iParam0 /*21*/].f_17 == 3)) || (Global_262145.f_26518 && Local_213[iParam0 /*21*/].f_17 == 4)) || (Global_262145.f_26521 && Local_213[iParam0 /*21*/].f_17 == 5)) || (Global_262145.f_26519 && Local_213[iParam0 /*21*/].f_17 == 6)) || (Global_262145.f_26516 && Local_213[iParam0 /*21*/].f_17 == 7)) || (Global_262145.f_26523 && Local_213[iParam0 /*21*/].f_17 == 8))
	{
		...
		if (!BitTest(uLocal_1638, 0))
		{
			if (BitTest(uLocal_1638, 21) || BitTest(uLocal_1638, 22))
			{
				...
				if (func_280(0, -1, 0) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED(&Var0))
				{
					...
					MISC::SET_BIT(&uLocal_1638, false);
...
void func_247(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_263(Global_23831.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23831.f_6331)
		{
			...
			else
			{
				...
				{
					func_258();
					func_256((((Global_23828 + fParam5) - 0.00390625f) - func_257("CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340);
				}
				else if (Global_23831.f_6334 > Global_23831.f_5828)
				{
					...
					{
						func_258();
						func_256((((Global_23828 + fParam5) - 0.00390625f) - func_257("CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336);
					}
				}
			}
...
Vector3 func_294()
{
	...
	Var0 = { 0f, 0f, 0f };
	iVar3 = Global_2708759;
	iVar4 = Global_2708683;
	...
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_299(Global_2708681, 0), func_295(Global_2708681), Var0);
}
...
int func_297(int iParam0)
{
	...
	while (bVar1 < 54)
	{
		if (bVar1 < 32)
		{
			if (BitTest(Global_2708675, bVar1))
			{
				if (iVar2 == iVar0)
				{
					return bVar1;
		...
		else if (BitTest(Global_2708676, (bVar1 - 32)))
		{
			if (iVar2 == iVar0)
			{
				return bVar1;
	...
	if ((((((((((((((((func_12(PLAYER::PLAYER_ID(), 1, 1) && func_334(PLAYER::PLAYER_PED_ID()) <= 9) && !Global_2635563.f_2981) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !BitTest(Global_1943520.f_4, 2)) && !func_233()) && !NETWORK::IS_COMMERCE_STORE_OPEN()) && !HUD::IS_STORE_PENDING_NETWORK_SHUTDOWN_TO_OPEN()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && !func_232(1)) && !func_234()) && !func_222()) && !func_220()) && !CAM::IS_SCREEN_FADED_OUT()) && !CAM::IS_SCREEN_FADING_OUT()) && !Global_2696212.f_12) && Global_1943513 != 33)
	{
		...
		if (iLocal_2130 >= 0)
		{
			...
			if (Local_2741.f_598[iLocal_2130] == -1 && !func_327(iLocal_2130))
			{
				...
				{
					MISC::CLEAR_BIT(&uLocal_1638, true);
				}
...
int func_327(int iParam0)
{
	...
	{
		iParam0 = (iParam0 - 32);
		return BitTest(Global_2708676, iParam0);
	}
	return 0;
}
