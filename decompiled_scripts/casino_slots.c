...
void func_167(int iParam0)
{
	...
	else
	{
		...
		if (iParam0 == 15 || iParam0 == 9)
		{
			...
			NETWORK::_0x45F35C0EDC33B03B(iLocal_1634, iVar6, Local_1636, func_328(), &Local_2099, 2f, -1.5f, 13);
		}
	}
...
void func_273()
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Local_2097.f_0))
	{
		GRAPHICS::_0x32F34FF7F617643B(Local_2097.f_0, 1);
		...
		case 0:
			if (func_298())
			{
				if (func_297())
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), func_283(iLocal_1644), 1f, 7000, 0.05f, false, func_282(iLocal_1644));
					MISC::CLEAR_BIT(&uLocal_1631, 30);
					MISC::CLEAR_BIT(&uLocal_1631, 31);
					iLocal_1633++;
				}
