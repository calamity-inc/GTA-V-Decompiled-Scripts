...
int func_166(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
...
int func_199(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
void func_202()
{
	...
	switch (iLocal_2132)
	{
		case 0:
			...
			func_233(&Local_186, 324.7653f, -2974.495f, -1f, 0.1f, 0.1f, 2f, 1, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1);
		...
		case 2:
			...
			if (func_233(&Local_186, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((HUD::DOES_BLIP_EXIST(Local_186.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, false, true, 0)) && func_225(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/])))
			{
		...
		case 3:
			if (func_83(Local_53[0 /*2*/]) || (MISC::GET_GAME_TIMER() - iLocal_450) > 3500)
			{
				...
				func_216(0, 340.6675f, -2964.01f, 1.4937f, 1, 0, 1, 3000, 0, 1);
...
void func_205(bool bParam0, bool bParam1, bool bParam2, int iParam3, int iParam4)
{
	HUD::DISPLAY_RADAR(true);
	HUD::DISPLAY_HUD(true);
...
int func_207()
{
	...
	switch (iLocal_408)
	{
		case 0:
			...
			func_214(&uLocal_458, 298.9806f, -2977.643f, 6.101f, Vector(7.886f, -2964.665f, 298.5479f) - Vector(6.101f, -2977.643f, 298.9806f), 3000f, 0);
			iLocal_408++;
			break;
...
int func_214(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8)
{
...
void func_216(bool bParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9)
{
...
int func_233(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)
{
	...
	switch (iLocal_2132)
	{
		...
		case 1:
			if (iLocal_381)
			{
				...
				func_280();
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && !func_219(0))
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 51))
					{
						...
						func_216(0, 1249.787f, -3008.016f, 8.52751f, 1, 0, 1, 3000, 0, 1);
		...
		case 5:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], false))
			{
				func_237(1218.237f, -3005.128f, 4.8658f, 359.5065f, 0, 145);
...
void func_238(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_292(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
