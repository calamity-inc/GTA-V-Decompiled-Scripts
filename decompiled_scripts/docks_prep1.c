...
int func_148(struct<3> Param0, char* sParam3, struct<3> Param4)
{
	int iVar0;
	int iVar1;
...
int func_156(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_201()
{
	...
	switch (iLocal_2132)
	{
		case 0:
			...
			func_232(&Local_186, 324.7653f, -2974.495f, -1f, 0.1f, 0.1f, 2f, 1, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1);
		...
		case 2:
			...
			if (func_232(&Local_186, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((HUD::DOES_BLIP_EXIST(Local_186.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, false, true, 0)) && func_224(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/])))
			{
...
void func_204(bool bParam0, bool bParam1, bool bParam2, int iParam3, int iParam4)
{
	HUD::DISPLAY_RADAR(true);
	HUD::DISPLAY_HUD(true);
...
int func_206()
{
	...
	switch (iLocal_408)
	{
		case 0:
			...
			func_213(&uLocal_458, 298.9806f, -2977.643f, 6.101f, Vector(7.886f, -2964.665f, 298.5479f) - Vector(6.101f, -2977.643f, 298.9806f), 3000f, 0);
			iLocal_408++;
			break;
...
int func_213(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8)
{
...
void func_215(bool bParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9)
{
...
int func_232(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)
{
	...
	switch (iLocal_2132)
	{
		...
		case 1:
			if (iLocal_381)
			{
				...
				func_279();
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, false, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && !func_218(0))
				{
...
void func_290()
{
	switch (iLocal_397)
	{
		...
		case 2:
			...
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, false, true, 0) || !func_107(Local_62[4 /*10*/]))
			{
				iLocal_397 = 0;
			}
...
int func_302(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	bool bVar0;
...
int func_309(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
int func_317(var uParam0, struct<3> Param1, float fParam4, int iParam5)
{
...
void func_337(struct<3> Param0, var uParam3, int iParam4, int iParam5)
{
	if (func_307())
	{
