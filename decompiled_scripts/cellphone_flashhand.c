...
void __EntryFunction__()
{
	...
	if (Global_20930.f_1 == 5 || Global_20930.f_1 == 6)
	{
		...
		if (Global_20918)
		{
			func_82(Global_20911, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
		}
		else
		{
		...
		if (Global_20918)
		{
			func_82(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
		}
		else
		{
		...
		else
		{
			if (Global_21146 == 1)
			{
				if (Global_20918)
				{
					func_82(Global_20911, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
				}
				else
				{
			...
			{
				func_82(Global_20911, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
			}
			else
			{
	...
	while (true)
	{
					...
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("apptrackify")) == 0)
					{
						if (Global_79389)
						{
							if (Global_20930.f_1 == 9)
							{
								...
								{
									PAD::SET_INPUT_EXCLUSIVE(0, Global_20899);
								}
							}
							else
							{
		...
		if (!HUD::IS_PAUSE_MENU_ACTIVE())
		{
			if (!Global_76498)
			{
				...
				PAD::SET_INPUT_EXCLUSIVE(0, Global_20904);
				if (!func_65())
				{
					PAD::SET_INPUT_EXCLUSIVE(0, Global_20905);
				}
				if (Global_20930.f_1 > 4)
				{
					PAD::SET_INPUT_EXCLUSIVE(0, Global_20907);
				}
			}
		}
		...
		if (iLocal_73 == 1)
		{
			if (!PAD::IS_CONTROL_PRESSED(2, Global_20899))
			{
				Global_8804 = 1;
				iLocal_73 = 0;
			}
		...
		if (iLocal_96)
		{
			if (PAD::IS_CONTROL_PRESSED(2, Global_20898))
			{
		...
		else
		{
											...
											if (!MISC::IS_PC_VERSION())
											{
												if (!Global_20929 == 1)
												{
													if (Global_20930.f_1 > 6)
													{
														...
														MISC::CLEAR_BIT(&Global_8801, 26);
														MISC::CLEAR_BIT(&Global_8801, 25);
														MISC::SET_BIT(&(Global_2738935.f_1847), 17);
													}
												}
											}
										}
			...
			{
				iVar35 = 0;
				if (((Global_79389 && Global_2746026.f_1) && Global_2746026.f_37) && Global_20930.f_1 == 9)
				{
					iVar35 = 1;
...
void func_1()
{
	if (!PAD::IS_CONTROL_PRESSED(2, Global_20899) && !PAD::IS_CONTROL_PRESSED(2, Global_20898))
	{
		Global_20908 = 0;
	}
}
...
void func_35(bool bParam0)
{
	...
	iVar1 = 0;
	func_37(10, "CELL_16", iVar1, "appSettings", 24, 1, 1, 0, 0);
	Global_9369[iVar1] = 1;
...
void func_46()
{
	...
	if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_71))
	{
		...
		if (Global_20933 == 23 && MISC::ARE_STRINGS_EQUAL(&(Global_8807[Global_20933 /*15*/]), "CELL_BENWEB"))
		{
			if (BitTest(Global_8801, 6))
			{
				iVar0 = 1;
		...
		if (Global_79389)
		{
			...
			else
			{
				...
				if (func_123())
				{
					if (Global_20933 == 10)
					{
						if (!func_48("FIX_MPCHAR_BLCK"))
						{
							func_80("FIX_MPCHAR_BLCK", -1);
						}
						iVar0 = 1;
					}
				}
...
void func_55()
{
	...
	else
	{
		...
		if (Global_20929 == 0)
		{
			if (Global_20908 == 0)
			{
				if (func_64(2, Global_20898, 0) || Global_2749863 == 1)
				{
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
							...
							if (BitTest(Global_8801, 8))
							{
								switch (Global_20930.f_1)
								{
									...
									case 10:
										if (Global_8115 == 132)
										{
											if (Global_2746026.f_1 || BitTest(Global_8801, 20))
											{
												func_47();
												func_78();
											}
...
void func_56()
{
	...
	switch (Global_20930.f_1)
	{
		...
		case 10:
			...
			{
				func_82(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202", 0, 0, 0, 0);
				if (Global_20873)
				{
		...
		case 9:
			if (Global_20929 == 1)
			{
				...
				{
					func_82(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_8115 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_82(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2169[Global_8115 /*29*/].f_3), &(Global_2169[Global_8115 /*29*/].f_7), "CELL_217", &(Global_2169[Global_8115 /*29*/].f_3), 0);
				}
				func_114(Global_20911, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_22286 == 4 || Global_22286 == 3)
			{
				...
				else
				{
					...
					if (func_59(Global_8115, Global_20930) == 0)
					{
						...
						func_82(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8115 /*10*/].f_4), "CELL_300", &cVar1, "CELL_195", 0);
					}
					else
					{
						func_114(Global_20911, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_57()
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20911))
	{
		...
		if (Global_20929 == 1)
		{
			if (Global_20918)
			{
				func_82(Global_20911, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203", 0, 0, 0, 0);
			}
			else
			{
			...
			{
				func_82(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204", 0, 0, 0, 0);
			}
			else
			{
				func_82(Global_20911, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_22299)
	{
		if (Global_79389)
		{
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20911))
			{
				if (!MISC::IS_PC_VERSION())
				{
					func_82(Global_20911, "SET_SOFT_KEYS", 1f, 1f, 8f, -1f, -1f, "CELL_201", 0, 0, 0, 0);
					MISC::SET_BIT(&(Global_2738935.f_1847), 15);
				}
			}
		}
	}
...
void func_61()
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20911))
	{
		if (!Global_22294)
		{
			...
			{
				func_82(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8115 /*10*/].f_4), "CELL_300", "CELL_219", "CELL_195", 0);
			}
			else
			{
				func_82(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2169[Global_8115 /*29*/].f_3), &(Global_2169[Global_8115 /*29*/].f_7), "CELL_219", &(Global_2169[Global_8115 /*29*/].f_3), 0);
			}
		}
		func_114(Global_20911, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
	}
...
int func_97(struct<3> Param0, int iParam3)
{
	if (iParam3 != -1)
	{
...
void func_114(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_118()
{
	...
	if (NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		...
		else if (func_119(Global_2746026.f_20))
		{
