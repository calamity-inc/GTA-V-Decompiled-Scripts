...
void __EntryFunction__()
{
	...
	if (Global_20248 == 0)
	{
		...
		if ((MISC::IS_XBOX360_VERSION() || func_113()) || MISC::IS_PC_VERSION())
		{
			...
			func_112(Global_20247, "SET_SOFT_KEYS_COLOUR", 2f, SYSTEM::TO_FLOAT(iLocal_108), SYSTEM::TO_FLOAT(iLocal_109), SYSTEM::TO_FLOAT(iLocal_110), -1082130432);
			HUD::GET_HUD_COLOUR(9, &iLocal_108, &iLocal_109, &iLocal_110, &uLocal_111);
			func_112(Global_20247, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(iLocal_108), SYSTEM::TO_FLOAT(iLocal_109), SYSTEM::TO_FLOAT(iLocal_110), -1082130432);
			HUD::GET_HUD_COLOUR(6, &iLocal_108, &iLocal_109, &iLocal_110, &uLocal_111);
			func_112(Global_20247, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(iLocal_108), SYSTEM::TO_FLOAT(iLocal_109), SYSTEM::TO_FLOAT(iLocal_110), -1082130432);
		}
		else
		{
	...
	if (Global_78319)
	{
		...
		if (Global_4541506 == 0)
		{
			...
			if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var16) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)) && Global_4541509 == 0)
			{
			...
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				if (PAD::IS_CONTROL_PRESSED(0, 25) || PAD::IS_CONTROL_PRESSED(0, 68))
				{
					if (Global_78319)
					{
						...
						if (iLocal_113 != joaat("weapon_unarmed") && Global_20266.f_1 < 7)
						{
							MISC::SET_BIT(&Global_8137, 4);
						}
					}
...
void func_9()
{
	...
	{
		Local_119 = { Global_20212[Global_20211 /*3*/] };
	}
	else
	{
		Local_119 = { Global_20219[Global_20211 /*3*/] };
	}
	fVar4 = func_15(Local_119, Global_20212[Global_20211 /*3*/], Global_20226, Var1, fVar0, 0);
...
float func_15(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	...
	if (fVar3 < 1f)
	{
		...
		Global_20194 = { func_16(Param0, Param3, fVar4) };
		Global_20197 = { func_16(Param6, Param9, fVar4) };
	}
	else
	{
		Global_20194 = { Param3 };
...
void func_20()
{
	if (BitTest(Global_8137, 10) || iLocal_122 == 1)
	{
...
void func_51()
{
	...
	else
	{
		if (iLocal_82 == 0)
		{
			Local_83 = { Global_20219[Global_20211 /*3*/] };
			Local_83.f_0 = (Local_83.f_0 - 10f);
			Local_83.f_1 = (Local_83.f_1 + 20f);
			iLocal_82 = 1;
		}
		fVar1 = func_15(Global_20212[Global_20211 /*3*/], Local_83, -90f, 0f, 90f, -90f, 0f, 90f, 450f, 1);
		if (fVar1 >= 1f)
		{
			MISC::SET_BIT(&Global_8137, 8);
			MISC::SET_BIT(&Global_8136, 14);
...
void func_92()
{
	...
	func_112(Global_20247, "SET_PROVIDER_ICON", SYSTEM::TO_FLOAT(iLocal_89), SYSTEM::TO_FLOAT(iLocal_90), -1082130432, -1082130432, -1082130432);
}
...
int func_93()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_98(bVar0))
		{
			...
			{
				if (BitTest(Global_113386.f_7688[iVar4 /*15*/].f_2, bVar0))
				{
			...
			{
				if (BitTest(Global_113386.f_7688.f_651[iVar4 /*14*/].f_2, bVar0))
				{
			...
			{
				if (BitTest(Global_113386.f_7688.f_765[iVar4 /*10*/].f_2, bVar0))
				{
...
int func_96(struct<3> Param0, int iParam3)
{
	if (iParam3 != -1)
	{
		if (iParam3 >= Global_43053)
		{
			return 0;
		}
		if (SYSTEM::VDIST2(Param0, Global_43053[iParam3 /*5*/]) <= (Global_43053[iParam3 /*5*/].f_3 * Global_43053[iParam3 /*5*/].f_3))
		{
			return 1;
		}
		else if (Global_43053[iParam3 /*5*/].f_4 != -1)
		{
			return func_96(Param0, Global_43053[iParam3 /*5*/].f_4);
		}
	}
	return 0;
}
...
void func_110()
{
	...
	if (iLocal_92 != Global_8139)
	{
		Global_8139 = iLocal_92;
		...
		func_81(Global_20247, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_91), SYSTEM::TO_FLOAT(iLocal_92), -1f, -1f, -1f, &Local_94, 0, 0, 0, 0);
		if (Global_20209 == 0)
		{
			func_92();
		}
