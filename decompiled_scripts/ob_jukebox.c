	...
	switch (iLocal_134)
	{
		case 0:
			if (func_194() && func_193())
			{
				...
				if (iLocal_124 == -1)
				{
					func_190(&iLocal_124, 4, "JBOX_INTERACT", 0, 0, 0, 0);
					func_189();
				}
...
void func_67(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_94(Global_23831.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23831.f_6331)
		{
			...
			else
			{
				...
				{
					func_88();
					func_86((((Global_23828 + fParam5) - 0.00390625f) - func_87("CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340);
				}
				else if (Global_23831.f_6334 > Global_23831.f_5828)
				{
					...
					{
						func_88();
						func_86((((Global_23828 + fParam5) - 0.00390625f) - func_87("CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336);
					}
				}
			}
...
void func_139(struct<67> Param0, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, int iParam85)
{
	struct<4> Var0;
	int iVar37;
...
void func_236()
{
	if (iLocal_122 == 126)
	{
		...
		else if (BitTest(Global_2707505, 1))
		{
