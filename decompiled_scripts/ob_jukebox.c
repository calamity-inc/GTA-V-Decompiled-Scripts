	...
	switch (iLocal_132)
	{
		case 0:
			if (func_193() && func_192())
			{
				...
				if (iLocal_122 == -1)
				{
					func_189(&iLocal_122, 4, "JBOX_INTERACT", 0, 0, 0, 0);
					func_188();
				}
...
void func_66(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_93(Global_23711.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23711.f_6331)
		{
			...
			else
			{
				...
				{
					func_87();
					func_85((((Global_23708 + fParam5) - 0.00390625f) - func_86("CM_ITEM_COUNT", Global_23711.f_6339, Global_23711.f_6340)), ((Global_23709 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23711.f_6339, Global_23711.f_6340);
				}
				else if (Global_23711.f_6334 > Global_23711.f_5828)
				{
					...
					{
						func_87();
						func_85((((Global_23708 + fParam5) - 0.00390625f) - func_86("CM_ITEM_COUNT", Global_23711.f_6337, Global_23711.f_6336)), ((Global_23709 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23711.f_6337, Global_23711.f_6336);
					}
				}
			}
...
int func_108()
{
	if (((((((((func_109(31708, -1) || func_109(31709, -1)) || func_109(31710, -1)) || func_109(31711, -1)) || func_109(31712, -1)) || func_109(31713, -1)) || func_109(31714, -1)) || func_109(31757, -1)) || func_109(32287, -1)) || func_109(42149, -1))
	{
		return 1;
	}
	return 0;
...
void func_113()
{
	func_115("JBOX_CONF_T");
	func_93(0, "JBOX_MENU_0", 0, 1, 0, 0, 0);
	func_93(1, "JBOX_MENU_1", 0, 1, 0, 0, 0);
	func_111(iLocal_119, 1, 1);
	func_114(201, "ITEM_SELECT", -1, 0);
	func_114(202, "ITEM_BACK", -1, 0);
}

void func_114(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	char* sVar0;
...
void func_128(int iParam0)
{
	...
	if (MONEY::NETWORK_CAN_SPEND_MONEY(1, false, false, true, -1, 0))
	{
		if (func_141())
		{
			func_129(1976384368, 1, &iVar1, 0, 0, 1);
...
void func_147(var uParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, var uParam5)
{
	if (MISC::IS_PC_VERSION() && !NETWORK::NETWORK_TEXT_CHAT_IS_TYPING())
	{
		...
		if (func_149(0, 0, 0) || PAD::IS_CONTROL_PRESSED(2, 188))
		{
			*uParam0 = 1;
		}
		if (func_148(0, 0, 0) || PAD::IS_CONTROL_PRESSED(2, 187))
		{
			*uParam1 = 1;
		}
...
void func_162(char* sParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5, float fParam6)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_164(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
void func_166(struct<3> Param0, float fParam3)
{
...
void func_178(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_189(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_190()
{
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_191("JBOX_NO_MONEY"))
	{
		HUD::CLEAR_HELP(true);
	}
}
...
bool func_224(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)
{
