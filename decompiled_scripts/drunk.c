...
void func_75(int iParam0)
{
	...
	{
		case 0:
			iVar0 = Global_262145.f_18341;
			break;
		
		case 1:
			iVar0 = Global_262145.f_18331;
			break;
		
		case 2:
			iVar0 = Global_262145.f_18342;
			break;
		
		case 3:
			iVar0 = Global_262145.f_18334;
			break;
		
		case 4:
			iVar0 = Global_262145.f_18330;
			break;
		...
		case 7:
			iVar0 = Global_262145.f_18345;
			break;
		
		case 8:
			iVar0 = Global_262145.f_18346;
			break;
		
		case 9:
			iVar0 = Global_262145.f_18349;
			break;
...
void func_124()
{
	...
	if ((Global_44355[iLocal_62 /*5*/].f_3 >= 10 || Global_44355[iLocal_62 /*5*/].f_4 >= 15) || BitTest(Global_44572, 9))
	{
		...
		if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && Local_41.f_1 == PLAYER::PLAYER_PED_ID()) && func_139(PLAYER::PLAYER_ID())) && Global_262145.f_24533)
		{
			if (Global_44355[iLocal_62 /*5*/].f_3 >= 10)
			{
				Global_44355[iLocal_62 /*5*/].f_3 = 9;
		...
		if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && Local_41.f_1 == PLAYER::PLAYER_PED_ID()) && func_132(PLAYER::PLAYER_ID())) && Global_262145.f_27220)
		{
			if (Global_44355[iLocal_62 /*5*/].f_3 >= 10)
			{
				Global_44355[iLocal_62 /*5*/].f_3 = 9;
		...
		if (((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && Local_41.f_1 == PLAYER::PLAYER_PED_ID()) && func_129(PLAYER::PLAYER_ID())) && Global_262145.f_27253)
		{
			if (Global_44355[iLocal_62 /*5*/].f_3 >= 10)
			{
				Global_44355[iLocal_62 /*5*/].f_3 = 9;
...
float func_144(int iParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
void func_175(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
