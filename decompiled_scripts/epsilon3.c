...
void __EntryFunction__()
{
	...
	if (func_330())
	{
		...
		Global_78935 = 0;
		func_320(1843.172f, 4701.249f, 37.5487f, 320.2838f, 1, 0);
		func_319(0);
	}
	if (!func_330())
	{
...
void func_295(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_352(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
