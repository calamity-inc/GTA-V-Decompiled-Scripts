...
void func_25(var uParam0, var uParam1, var uParam2)
{
	...
	switch (Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4)
	{
		...
		case 4:
			if ((!NETWORK::NETWORK_IS_SCRIPT_ACTIVE(Local_225.f_3, Local_225.f_6, true, 0) || (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_darts_apartment")) == 0 && Local_225.f_2 == 0)) || (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_armwrestling_apartment")) == 0 && Local_225.f_2 == 1))
			{
				func_38(&iLocal_208);
				func_42(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]));
				func_44(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 7, 0);
