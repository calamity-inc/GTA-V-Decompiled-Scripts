	...
	if (bParam21)
	{
		switch (Local_228.f_4)
		{
			...
			case 6:
				...
				if ((PAD::IS_CONTROL_JUST_PRESSED(2, func_102(0)) || BitTest(Local_257.f_3, Param0.f_0)) && !bLocal_96)
				{
					func_41(&Local_228, 8);
				}
				...
				if (func_19(&(Local_384[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3))
				{
					...
					{
						if ((PAD::IS_CONTROL_JUST_PRESSED(2, 201) && BitTest(Local_257.f_2, Param0.f_0)) && !bLocal_96)
						{
							func_41(&Local_228, 7);
						}
						if (Param0.f_2 == 0)
...
float func_104(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
{
	func_139(iParam0, 0, Global_262145.f_18194);
	func_139(iParam0, 1, Global_262145.f_18195);
