					...
					if (Param0.f_0 == 1)
					{
						...
						while (iVar1 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
						{
							...
							if (bVar1 != NETWORK::PARTICIPANT_ID_TO_INT())
							{
								if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar2))
								{
									if ((Local_390[bVar1 /*5*/].f_1 == Param0.f_0 && BitTest(Local_390[bVar1 /*5*/].f_3, 6)) && BitTest(Local_390[bVar1 /*5*/].f_3, 1))
									{
										Local_208.f_5 = 1;
										if (Local_208.f_8 >= 0)
										{
											if (Local_208.f_8 == 0 && BitTest(Local_390[bVar1 /*5*/].f_3, 5))
											{
												Local_208.f_6 = 1;
											}
											else if (Local_208.f_8 == 1 && !BitTest(Local_390[bVar1 /*5*/].f_3, 5))
											{
												Local_208.f_6 = 1;
											}
										}
	...
	if (bParam21)
	{
		switch (Local_234.f_4)
		{
			...
			case 6:
				...
				if ((PAD::IS_CONTROL_JUST_PRESSED(2, func_103(0)) || BitTest(Local_263.f_3, Param0.f_0)) && !bLocal_101)
				{
					func_42(&Local_234, 8);
				}
				...
				if (func_20(&(Local_390[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3))
				{
					...
					{
						if ((PAD::IS_CONTROL_JUST_PRESSED(2, 201) && BitTest(Local_263.f_2, Param0.f_0)) && !bLocal_101)
						{
							func_42(&Local_234, 7);
						}
						if (Param0.f_2 == 0)
...
void func_52(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_79(Global_23831.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23831.f_6331)
		{
			...
			else
			{
				...
				{
					func_73();
					func_71((((Global_23828 + fParam5) - 0.00390625f) - func_72("CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6339, Global_23831.f_6340);
				}
				else if (Global_23831.f_6334 > Global_23831.f_5828)
				{
					...
					{
						func_73();
						func_71((((Global_23828 + fParam5) - 0.00390625f) - func_72("CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336)), ((Global_23829 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23831.f_6337, Global_23831.f_6336);
					}
				}
			}
