...
void __EntryFunction__()
{
	...
	StringCopy(&Local_91, "CELL_214", 16);
	StringCopy(&Local_95, "CELL_243", 16);
	StringCopy(&Local_99, "CELL_244", 16);
	StringCopy(&Local_103, "CELL_265", 16);
	StringCopy(&Local_107, "CELL_300", 16);
