...
void __EntryFunction__()
{
	...
	StringCopy(&Local_95, "CELL_214", 16);
	StringCopy(&Local_99, "CELL_243", 16);
	StringCopy(&Local_103, "CELL_244", 16);
	StringCopy(&Local_107, "CELL_265", 16);
	StringCopy(&Local_111, "CELL_300", 16);
...
void func_5()
{
	...
	if (iLocal_117)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(2, Global_20899))
		{
			iLocal_117 = 0;
		}
		return;
...
int func_36(int* iParam0)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(2, Global_20899))
	{
		return 0;
	}
	func_37();
...
int func_41(int* iParam0)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(2, Global_20900))
	{
		return 0;
	}
	func_42();
...
void func_43(int* iParam0)
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(2, Global_20906) || PAD::IS_CONTROL_JUST_PRESSED(2, 181))
	{
		func_46();
		iParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
	if (PAD::IS_CONTROL_JUST_PRESSED(2, Global_20907) || PAD::IS_CONTROL_JUST_PRESSED(2, 180))
	{
		func_44();
		iParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
