...
int func_152(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_250(int* iParam0, struct<3> Param1, float fParam4)
{
...
void func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_252(iParam0);
