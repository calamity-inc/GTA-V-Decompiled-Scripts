...
int func_179(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_256(int* iParam0, struct<3> Param1, float fParam4)
{
...
void func_261(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_285(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
