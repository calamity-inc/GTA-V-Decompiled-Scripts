...
void func_255(int* iParam0, struct<3> Param1, float fParam4)
{
...
void func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_257(iParam0);
