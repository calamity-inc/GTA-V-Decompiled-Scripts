...
void func_12()
{
	if (Global_4541718[iLocal_34 /*104*/].f_24 == 1)
	{
		if (Global_20791 == 0)
		{
			if (PAD::IS_CONTROL_PRESSED(2, Global_20784))
			{
				func_2();
				Global_20791 = 1;
				func_30();
	...
	if (Global_20791 == 0 && iLocal_40 == 1)
	{
		if (func_3(2, Global_20782, 0))
		{
			...
			else if (Global_4541718[iLocal_34 /*104*/].f_30 == 1)
			{
				...
				{
					func_22(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_7998 /*10*/].f_4), "CELL_300", "CELL_211", "CELL_195", 0);
				}
				else
				{
					func_22(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2139[Global_7998 /*29*/].f_3), &(Global_2139[Global_7998 /*29*/].f_7), "CELL_211", &(Global_2139[Global_7998 /*29*/].f_3), 0);
				}
				func_13();
				func_60();
			}
...
void func_13()
{
	...
	switch (Global_20813.f_1)
	{
		case 6:
			...
			if (Global_20801)
			{
				func_22(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
				func_22(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_21026 == 1)
				{
					if (Global_20801)
					{
						func_22(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
					}
					else
					{
				...
				{
					func_22(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
				}
				else
				{
		...
		case 10:
			...
			{
				func_22(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202", 0, 0, 0, 0);
				if (Global_20756)
				{
		...
		case 9:
			if (Global_20812 == 1)
			{
				...
				{
					func_22(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_7998 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_22(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2139[Global_7998 /*29*/].f_3), &(Global_2139[Global_7998 /*29*/].f_7), "CELL_217", &(Global_2139[Global_7998 /*29*/].f_3), 0);
				}
				func_57(Global_20794, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_22166 == 4 || Global_22166 == 3)
			{
				...
				else
				{
					...
					if (func_23(Global_7998, Global_20813) == 0)
					{
						...
						func_22(Global_20794, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_7998 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_57(Global_20794, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_14()
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20794))
	{
		...
		if (Global_20812 == 1)
		{
			if (Global_20801)
			{
				func_22(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203", 0, 0, 0, 0);
			}
			else
			{
			...
			{
				func_22(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204", 0, 0, 0, 0);
			}
			else
			{
				func_22(Global_20794, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
		...
		if ((func_3(2, Global_20782, 0) || Global_4542968 == 1) || Global_23226 == 1)
		{
			...
			if (Global_4541718[iLocal_34 /*104*/].f_24 != 0)
			{
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&Var0))
				{
					...
					if (Global_20801)
					{
						func_22(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 16f, -1f, -1f, "CELL_267", 0, 0, 0, 0);
					}
					else
					{
				...
				if (Global_4541718[iLocal_34 /*104*/].f_29 > 0)
				{
					if (Global_20801)
					{
						func_22(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_212", 0, 0, 0, 0);
					}
					else
					{
				...
				else if (Global_4541718[iLocal_34 /*104*/].f_30 == 1)
				{
					if (Global_20801)
					{
						func_22(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_201", 0, 0, 0, 0);
					}
					else
					{
						func_22(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, 0, 0, 0, 0, 0);
				...
				if (Global_4541718[iLocal_34 /*104*/].f_29 > 0)
				{
					if (MISC::ARE_STRINGS_EQUAL(&(Global_4541718[iLocal_34 /*104*/]), "CELL_FINV"))
					{
						if (Global_20801)
						{
							func_22(Global_20794, "SET_SOFT_KEYS", 3f, 0f, 14f, -1f, -1f, "CELL_213", 0, 0, 0, 0);
						}
						else
						{
				...
				if (Global_4541718[iLocal_34 /*104*/].f_24 == 2)
				{
					if (Global_4541718[iLocal_34 /*104*/].f_31 == 1)
					{
						...
						if (Global_20801)
						{
							func_22(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 11f, -1f, -1f, "CELL_264", 0, 0, 0, 0);
						}
						else
						{
				...
				{
					func_22(Global_20794, "SET_SOFT_KEYS", 1f, 1f, 12f, -1f, -1f, "CELL_216", 0, 0, 0, 0);
					MISC::SET_BIT(&Global_8683, 17);
				}
				else
				{
...
float func_47(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)
{
	struct<2> Var0;
	float fVar3;
	float fVar4;
...
Vector3 func_48(struct<3> Param0, struct<3> Param3, float fParam6)
{
...
void func_52()
{
	if (Global_4542968 == 0)
	{
		...
		func_53(Global_20794, "SET_HEADER", "CELL_INBOX", 0, 0, 0, 0);
		func_57(Global_20794, "DISPLAY_VIEW", 8f, SYSTEM::TO_FLOAT(iLocal_33), -1082130432, -1082130432, -1082130432);
		if (Global_20801)
		{
			if (iLocal_30 > 0)
			{
				func_22(Global_20794, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_214", 0, 0, 0, 0);
			}
			else
			{
...
int func_56(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_57(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
