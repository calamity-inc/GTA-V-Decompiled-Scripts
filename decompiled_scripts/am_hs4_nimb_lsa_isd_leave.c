...
void func_6(bool bParam0)
{
	...
	{
		if (!func_13(&(Global_2824375[bParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(bParam0))
		{
			if (!func_12())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
...
{
	if (!func_147() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
int func_156(bool bParam0, int iParam1)
{
	int iVar0;
...
void func_161(int iParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<9> Var0;
	int iVar13;
	bool bVar14;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		bVar14 = func_263(iParam0, 0);
		bVar15 = func_255(iParam0);
		bVar16 = func_178(iParam0, iParam3);
		if (bParam2)
		{
			bVar15 = true;
		}
		...
		while (iVar17 < 127)
		{
			...
			{
				if (func_170(&Var0, iVar17, iVar13, iParam0, -1))
				{
					if (func_163(iParam0, &Var0, iVar17, Var0.f_4, Var0.f_8, bVar14, bVar15, bParam2, bVar16))
					{
		...
		while (iVar18 < iVar19)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(iVar13, iVar18, &Var20))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20.f_0))
				{
					...
					{
						if (func_163(iParam0, &(Var20.f_7), iVar35, Var20.f_2, Var20.f_6, bVar14, bVar15, bParam2, bVar16))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(iParam0, Var20.f_2, Var20.f_3);
							func_162(iParam0, Var20.f_2, Var20.f_3);
						}
					}
				}
			}
...
int func_163(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
...
int func_169(int iParam0, char* sParam1, int iParam2)
{
	switch (iParam2)
	{
		case 1019352240:
...
bool func_170(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
void func_171(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_177(char* sParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)
{
	char cVar0[32];
...
int func_179(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar17 = (iParam1 - func_182(iParam0));
		if (iVar17 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar36 = (iParam1 - func_180(iParam0, func_181(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_181(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_189(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 12)
	{
		...
		while (iVar15 < iVar16)
		{
			...
			if (Var0.f_1 == iParam1)
			{
				return (func_190(iParam0) + iVar15);
			}
			iVar15++;
		}
	}
	...
	else if (iParam2 == 14)
	{
		...
		if (iVar17 != -1)
		{
			return (func_182(iParam0) + iVar17);
		}
	}
	else
	{
		...
		if (iVar18 != -1)
		{
			return (func_180(iParam0, func_181(iParam2)) + iVar18);
		}
	}
	return -99;
}
...
int func_192(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar7 < 7)
		{
			...
			if (uVar8[iVar4] != -99)
			{
				if (!func_192(iParam0, iVar4, uVar8[iVar4]))
				{
					...
					if (iVar4 == 13)
					{
						uVar25 = { func_201(iVar0, uVar8[iVar4]) };
						iVar5 = 0;
						while (iVar5 <= 8)
						{
							if (!func_192(iParam0, 14, uVar25[iVar5]))
							{
								iVar6 = 0;
								while (iVar6 <= 19)
								{
	...
	{
		uVar36 = { func_201(iVar0, iParam2) };
		iVar35 = 0;
		while (iVar35 <= 8)
		{
			if (!func_192(iParam0, 14, uVar36[iVar35]))
			{
				return 0;
			}
			iVar35++;
	...
	else
	{
		...
		if (iParam1 == 4)
		{
			...
			if (Global_78129 == 1)
			{
				...
				{
					if (func_194(iVar0, 4, iParam2, &uVar68))
					{
						return func_192(iParam0, 4, uVar68);
					}
				}
				else if (func_193(iVar0, 4, iParam2, &uVar68))
				{
					return func_192(iParam0, 4, uVar68);
				}
			}
...
int func_196(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
...
struct<10> func_201(int iParam0, int iParam1)
{
	int iVar0;
	struct<10> Var1;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_189(iParam1, Var16.f_0, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
void func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_204(int iParam0, int iParam1)
{
	int iVar0;
	struct<17> Var1;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_206(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_206(Var16.f_2)] = func_189(iParam1, Var16.f_0, func_206(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_206(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_207(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_208(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_254();
	if (iParam0 == joaat("mp_m_freemode_01"))
	{
...
void func_210(int iParam0)
{
	...
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_216(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_217(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_211(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_211(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_181(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_222(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 9, iParam1);
			return;
			break;
	}
	...
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_223(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 28, iParam1);
			return;
			break;
	}
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_224(int iParam0, int iParam1)
{
	...
	{
		Global_78130[0 /*14*/].f_5 = 4;
		func_221(iVar10, iParam0, 327, iParam1);
...
void func_225(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 6, iParam1);
			return;
			break;
	}
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_226(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 55, iParam1);
			if (Global_78130[0 /*14*/].f_7 > 0)
			{
...
void func_227(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 26, iParam1);
			if (Global_78130[0 /*14*/].f_7 > 0)
			{
...
void func_228(int iParam0, int iParam1)
{
	...
	{
		Global_78130[0 /*14*/].f_5 = 4;
		func_221(iVar10, iParam0, 256, iParam1);
		if (Global_78130[0 /*14*/].f_7 > 0)
		{
...
void func_230(int iParam0, int iParam1)
{
	...
	{
		Global_78130[0 /*14*/].f_5 = 4;
		func_221(iVar10, iParam0, 16, iParam1);
		return;
	}
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_231(int iParam0, int iParam1)
{
	...
	{
		Global_78130[0 /*14*/].f_5 = 4;
		func_221(iVar10, iParam0, 36, iParam1);
		return;
	}
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_232(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 136, iParam1);
			if (Global_78130[0 /*14*/].f_7 > 0)
			{
...
void func_237(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 4;
			func_221(iVar10, iParam0, 92, iParam1);
			return;
			break;
	}
...
void func_244(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 3;
			func_221(iVar10, iParam0, 7, iParam1);
			return;
			break;
	}
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_250(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 3;
			func_221(iVar10, iParam0, 46, iParam1);
			return;
			break;
	}
	func_211(&(Global_78130[0 /*14*/]), iVar10, iParam0, &sVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
...
void func_251(int iParam0, int iParam1)
{
	...
	{
		Global_78130[0 /*14*/].f_5 = 3;
		func_221(iVar10, iParam0, 241, iParam1);
		if (Global_78130[0 /*14*/].f_7 > 0)
		{
...
void func_252(int iParam0, int iParam1)
{
	...
	{
		Global_78130[0 /*14*/].f_5 = 3;
		func_221(iVar10, iParam0, 237, iParam1);
		if (Global_78130[0 /*14*/].f_7 > 0)
		{
			Global_78130[0 /*14*/].f_7 = SYSTEM::ROUND((SYSTEM::TO_FLOAT(Global_78130[0 /*14*/].f_7) * Global_295754.f_16));
		}
...
void func_253(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		default:
			Global_78130[0 /*14*/].f_5 = 3;
			func_221(iVar10, iParam0, 91, iParam1);
			return;
			break;
	}
