...
void __EntryFunction__()
{
	...
	func_521();
	iLocal_1448 = 1;
	Local_1236 = { func_519(iLocal_1448) };
	iLocal_1046 = 1;
	if (func_524())
	{
		func_531();
		bLocal_138 = true;
		iLocal_1556 = func_518();
		if (Global_94618)
		{
			bLocal_1533 = true;
			iLocal_1556++;
		...
		if (iLocal_1556 == 0)
		{
			...
			fLocal_1577 = 0.0954f;
			func_517(Local_1618, fLocal_1631, 1, 0);
		}
		else if (iLocal_1556 == 1)
		{
			...
			func_517(Local_1570, fLocal_1573, 1, 0);
		}
	...
	{
		SYSTEM::WAIT(0);
		func_514(&uLocal_1934);
		RECORDING::_0x208784099002BC30("M_ASS2", 0);
		func_513(&iLocal_1603, 14f, 1);
		if (func_512(&uScriptParam_0))
		{
			if (func_511())
			{
				if (func_510(&iLocal_1042))
				{
					Global_113386.f_19963.f_6 = func_530();
				}
				PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1593, false);
				func_531();
				func_509(&uLocal_1934);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				Global_113386.f_19963.f_6 = func_530();
				fLocal_134 = (Global_113386.f_19963.f_6 / 1000f);
...
void func_5(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_7(Global_113386.f_18533[iVar0], &Var2, &fVar5))
			{
...
void func_146()
{
	...
	if (!iLocal_139)
	{
		func_152(&uLocal_150, &Local_731, &Global_63169, 0);
...
int func_157(var uParam0, var uParam1)
{
	...
	switch (iLocal_1046)
	{
		...
		case 4:
			...
			{
				iLocal_1560 = Global_100441.f_12[0];
				if (iLocal_1556 == 0)
				{
					iLocal_1544 = 0;
			...
			if (bLocal_1518)
			{
				func_469(uParam0, &uLocal_1934, 1);
			...
			{
				func_469(uParam0, &uLocal_1934, 0);
			}
		...
		case 6:
			...
			Global_100441.f_12[0] = iLocal_1560;
	...
	if (CAM::IS_SCREEN_FADED_IN())
	{
		...
		else if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (PED::IS_PED_INJURED(*iParam0))
			{
				...
				else if (func_510(&iLocal_1039) && func_45(&iLocal_1039) < 3f)
				{
					iLocal_1031 = 1;
				}
				RECORDING::_0x293220DA1B46CEBC(3f, 2f, 3);
...
void func_305(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_363(&(Global_100441.f_3));
				if (iVar10 > -1)
				{
...
{
	return func_422(&(Global_106934.f_2890), Param0, fParam3, 0);
}
...
{
	if (!func_455() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_468(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_469(var uParam0, var uParam1, bool bParam2)
{
...
void func_474(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
...
void func_477(var uParam0)
{
	...
	func_475(&(uParam0->f_34));
	func_472(&(uParam0->f_46), &uLocal_1934);
}
...
int func_482(var uParam0, char* sParam1)
{
	int iVar0;
	int iVar1;
...
void func_488(var uParam0)
{
	...
	switch (iLocal_1468)
	{
		...
		case 1:
			...
			if (((func_510(&iLocal_1495) && func_45(&iLocal_1495) > fLocal_1480) || (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_1509) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_1509) >= 0.978f)) || bLocal_1501)
			{
				iLocal_1468 = 3;
			}
			break;
...
void func_491()
{
	...
	{
		case 0:
			if (func_492(&iLocal_1471, 8f, -728.4891f, -933.7799f, 19.9947f, -4.0865f, 0.0581f, -61.3739f, 30.7441f, 1, 0.2f))
			{
				iLocal_1557 = 1;
			}
			break;
		...
		case 1:
			if (func_492(&iLocal_1471, 14f, -702.2474f, -918.3937f, 19.7582f, -1.9904f, 0f, -56.7173f, 30f, 1, 0.3f))
			{
				iLocal_1557 = 2;
			}
			break;
		...
		case 2:
			if (func_492(&iLocal_1471, 23f, -698.241f, -917.8708f, 19.533f, -3.3396f, 0f, 75.4344f, 40f, 1, 0.3f))
			{
				iLocal_1557 = 3;
			}
			break;
		...
		case 3:
			if (func_492(&iLocal_1471, 28f, -716.4577f, -945.2582f, 19.8525f, -1.1558f, 0f, -21.0827f, 31f, 1, 0.2f))
			{
				iLocal_1557 = 4;
			}
			break;
		...
		case 4:
			if (func_492(&iLocal_1471, 33f, -702.0552f, -917.9715f, 19.7381f, -3.1893f, 0f, -63.3392f, 33.4611f, 1, 0.2f))
			{
				iLocal_1557 = 5;
			}
			break;
		...
		case 5:
			if (func_492(&iLocal_1471, 39f, -697.374f, -918.0989f, 19.8386f, -4.5194f, 0f, 86.2972f, 42f, 1, 0.2f))
			{
				iLocal_1557 = 6;
			}
			break;
...
int func_492(int iParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
...
void func_494(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_500(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
{
	func_503(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_503(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_513(var uParam0, float fParam1, bool bParam2)
{
...
void func_516(int* iParam0, char* sParam1, int iParam2)
{
	if (BitTest(*iParam0, 30))
	{
		switch (func_174(*iParam0))
