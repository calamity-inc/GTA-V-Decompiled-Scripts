...
void func_368(int iParam0, var uParam1)
{
	switch (iParam0)
	{
		...
		case 5:
			func_369(uParam1, "Barry3A", func_371(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_370(iParam0), 0, 1);
			break;
		...
		case 8:
			func_369(uParam1, "Dreyfuss1", func_371(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_370(iParam0), 0, 0);
			break;
		...
		case 38:
			func_369(uParam1, "Nigel1A", func_371(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_370(iParam0), 1, 1);
			break;
		...
		case 49:
			func_369(uParam1, "Paparazzo3A", func_371(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_370(iParam0), 0, 1);
			break;
		...
		case 58:
			func_369(uParam1, "Tonya1", func_371(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_370(iParam0), 0, 1);
			break;
...
int func_377(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10)
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_379(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	bool bVar1;
...
void func_380(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	if (!func_25())
	{
		return;
...
void func_383(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)
{
...
int func_402(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
		if (!func_403())
...
int func_423(struct<3> Param0, float fParam3)
{
	return func_424(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_424(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_441(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_442(iParam0, uVar1[iVar6], 1) && func_406(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_476(var uParam0, char* sParam1)
{
	func_477(uParam0, 1, -1, sParam1, 0);
}

void func_477(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
	...
	switch (iLocal_1468)
	{
		case 0:
			...
			if (bLocal_1539)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_1469))
				{
					func_505(-736.7908f, -924.1303f, 18.16373f, -696.8614f, -923.7517f, 19.65864f, 45f, -711.8602f, -920.7141f, 18.0145f, 0.0954f, func_511(), 1, 1, 1, 0, 0);
...
int func_495(int iParam0, float fParam1, struct<3> Param2, struct<3> Param5, float fParam8, bool bParam9, float fParam10)
{
...
void func_497(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_503(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_505(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_506(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_506(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_507(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_508(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_516(var uParam0, float fParam1, bool bParam2)
{
...
struct<39> func_522(int iParam0)
{
	struct<39> Var0;
