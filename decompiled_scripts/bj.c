...
void __EntryFunction__()
{
	...
	iVar1153 = -1;
	iVar1156 = -1;
	bVar1160 = Global_113810.f_18970;
	iVar1163 = 1;
	iVar1164 = -1;
	bVar1183 = false;
	bVar1188 = true;
	...
	if (BitTest(Global_113810.f_18970.f_1, bVar1160))
	{
		fVar1148 = 0.1f;
	}
	bVar872 = bVar1160;
	...
	while (true)
	{
		...
		switch (iVar719)
		{
			...
			case 5:
				...
				if (BitTest(Global_113810.f_18970.f_1, (func_368(&Var16) - 125)))
				{
			...
			case 9:
				...
				else if (func_330(&uVar101, 3, 1000) && !Global_23251.f_135)
				{
			...
			case 10:
				...
				if ((!bVar1179 && !bVar1180) && !bVar1182)
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (((((ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, false)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar1089, Var1132, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_371(&Var16, iVar1154), Var1132, false, true, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (bVar1202)
							{
								if (func_330(&uVar101, 3, 1000) && !Global_23251.f_135)
								{
									ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true);
									PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 256);
									CAM::DO_SCREEN_FADE_OUT(800);
				...
				if (((bVar1179 || bVar1180) || bVar1182) || (func_465(&iVar890) && func_464(&iVar890) > 0.25f))
				{
					...
					if (bVar1179 || iVar720 == 1)
					{
						...
						{
							iVar1162 = 125;
							MISC::SET_BIT(&(Global_113810.f_18970.f_1), (func_368(&Var16) - iVar1162));
							...
							while (bVar1166 < 13)
							{
								if (!BitTest(Global_113810.f_18970.f_1, bVar1166))
								{
...
void func_271(int* iParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	if (!func_264(iParam0, 1) && !Global_23251.f_135)
	{
...
int func_331(var uParam0, int* iParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8, var uParam11, var uParam12)
{
	struct<3> Var0;
...
int func_334(var uParam0, var uParam1, var uParam2, int* iParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param9)
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_350(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, int iParam9, var uParam10, int* iParam11, int* iParam12, int iParam13, int iParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20, float fParam21)
{
	struct<3> Var0;
	var uVar3;
	var uVar6;
...
void func_357(struct<3> Param0, var uParam3, var uParam4, var uParam5)
{
	var uVar0;
	var uVar1;
	float fVar2;
...
void func_358(struct<3> Param0, var uParam3, var uParam4)
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
Vector3 func_371(var uParam0, int iParam1)
{
...
int func_381(var uParam0, bool bParam1, int* iParam2, var uParam3, var uParam4, int* iParam5, int* iParam6, int* iParam7, int* iParam8, int iParam9, var uParam10, var uParam11, var uParam12)
{
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_386(Global_78945, Global_78947, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
void func_420(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_427(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
float func_433(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
void func_438(var uParam0, var uParam1, var uParam2, int* iParam3, int* iParam4, int* iParam5, int* iParam6, int* iParam7, int* iParam8, int* iParam9, int iParam10, int iParam11, int* iParam12, bool bParam13, int iParam14)
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_462(var uParam0, int* iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)
{
	char cVar0[64];
...
Vector3 func_466(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_480(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_485(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var3, 65f, false, 2), 1);
	}
	else
	{
	...
	{
		func_485(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var3, 65f, false, 2), 1);
	}
	else
	{
...
void func_507(char* sParam0, int* iParam1, bool bParam2)
{
...
int func_508(char* sParam0, char* sParam1, int* iParam2, bool bParam3)
{
...
void func_514(var uParam0)
{
	...
	func_521(&uVar3, &uVar4, &iVar5, &iVar6, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), PAD::IS_USING_KEYBOARD_AND_MOUSE(2));
...
void func_521(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_563(var uParam0, var uParam1, int* iParam2, int* iParam3, int* iParam4, var uParam5, int iParam6, var uParam7, int* iParam8, var uParam9, var uParam10, var uParam11, int iParam12, int iParam13, int iParam14, int iParam15, var uParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
