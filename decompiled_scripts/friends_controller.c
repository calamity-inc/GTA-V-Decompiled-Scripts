		...
		else
		{
			...
			else if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				if (!Global_114370.f_18106.f_398)
				{
					...
					{
						switch (func_418("AM_H_NOFRND"))
						{
							case 2:
								func_417("AM_H_NOFRND", 2, 0, 1000, 7500, 7, 0, 0, 0);
								break;
...
int func_70(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (uParam0->f_52)
	{
		...
		{
			MISC::SET_BIT(&(Global_114370.f_18106.f_410), bParam5);
			uParam0->f_52 = 0;
		}
	}
	else if (!func_71())
		...
		if (PED::IS_PED_INJURED(uParam1->f_2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_2) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (SYSTEM::VDIST2(Var3, Var6) < 150f)
				{
					...
					if (iVar9 < 6)
					{
						func_369("FR_X_INJ_1m", &(Global_2139[uParam1->f_1 /*29*/].f_3), 3, 0, 20000, 10000, 7, 0, 0, 0);
					}
				}
			}
...
void func_335(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
int func_339(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_341(int iParam0, int iParam1, int iParam2, var uParam3)
{
	struct<4> Var0;
	struct<4> Var4[2];
	int iVar13;
...
int func_343(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)
{
	struct<14> Var0;
...
int func_347(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	struct<4> Var0[2];
	int iVar9;
...
struct<10> func_357(int iParam0)
{
	int iVar0;
	struct<10> Var1;
...
struct<14> func_359(int iParam0)
{
	int iVar0;
	struct<14> Var1;
...
struct<15> func_361(int iParam0)
{
	int iVar0;
	struct<15> Var1;
...
int func_364(struct<3> Param0, bool bParam3)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_369(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_370(sParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9);
}

void func_370(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_372(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (*uParam1 != 0)
	{
...
void func_417(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
...
void func_429(int iParam0, bool bParam1, bool bParam2)
{
	if (iParam0 < 9)
	{
		...
		{
			MISC::CLEAR_BIT(&(Global_114370.f_18106.f_175[iParam0 /*19*/].f_18), bParam1);
		}
	}
}

int func_430(int iParam0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_433(int iParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	int iVar1;
...
bool func_434(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
bool func_436(var uParam0, int iParam1, char* sParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15)
{
	var uVar0;
	var uVar11;
...
int func_437(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_438(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
	func_439(iParam0);
	(*uParam1)[0] = uParam3;
	(*uParam2)[0] = uParam4;
...
int func_441(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)
{
	int iVar0;
	int iVar1;
...
int func_442(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	int iVar0;
...
float func_444(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
	return ((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1));
}
...
int func_456(int iParam0, char* sParam1, char* sParam2)
{
...
int func_458(int iParam0, var uParam1, var uParam2, var uParam3)
{
...
void func_476(bool bParam0)
{
	...
	func_478(1);
	func_477(896);
	func_480(2, 1986.868f, 3810.984f, 31.1159f, -2.28f, 0.42f, 0.11f, -1.02f, 2.28f, 0.0138f, 1);
	func_479(2138.562f, 3767.596f, 32.1819f, 120.8022f, 1995.681f, 3818.576f, 32.1837f);
	func_478(1);
	func_477(896);
	func_480(3, -13.8595f, -1454.332f, 29.4997f, 0.1999f, 8.5446f, 0.1003f, -1.0001f, 7.9046f, 0.1003f, 5);
	func_479(70.9006f, -1477.241f, 28.2852f, 140.958f, -24.3995f, -1457.326f, 30.6446f);
	func_478(2);
	func_477(896);
	...
	func_478(2);
	func_477(896);
	func_480(5, 1986.867f, 3810.984f, 31.1159f, -2.28f, 0.42f, 0.11f, -1.02f, 2.28f, 0.0138f, 2);
	func_479(2138.562f, 3767.596f, 32.1819f, 120.8022f, 1995.681f, 3818.576f, 32.1837f);
	func_478(4);
	func_477(896);
	func_480(6, -1158.263f, -1515.861f, 3.2873f, 3.7331f, 0.363f, 0.0341f, 3.1931f, 1.563f, 0.0341f, 3);
	func_479(-1079.374f, -1475.24f, 4.1272f, 25.0007f, -1166.17f, -1519.469f, 4.229f);
	func_478(4);
	func_477(896);
	func_480(7, 132.7787f, -1305.208f, 28.1826f, -1.1933f, 4.1322f, 0.0451f, -2.1933f, 3.8922f, -0.0049f, 4);
	func_479(65.7439f, -1308.325f, 28.3417f, 210.5102f, 125.2967f, -1307.992f, 29.2187f);
	func_478(4);
	func_477(768);
	func_480(8, 176.9471f, -1340.813f, 28.2908f, -1.2f, 2.1f, 0.0032f, -3f, 0.12f, 0.0032f, 4);
	func_479(361.4975f, -1296.77f, 31.3318f, 140.8159f, 182.2761f, -1333.38f, 28.8827f);
	func_478(4);
	func_477(640);
	func_480(9, -57.8633f, -1459.24f, 30.994f, -1.14f, 2.52f, 0.22f, -3.36f, 1.74f, 0.1667f, 10);
	func_479(68.9364f, -1479.64f, 29.2941f, 145.6588f, -50.0051f, -1459.135f, 31.9645f);
	func_478(8);
	func_477(896);
	...
	func_478(33);
	func_477(384);
	func_480(15, -820.9531f, -1088.276f, 10.0086f, -1.804f, 4.1191f, 0.1191f, -3.124f, 3.2191f, 0.1191f, 10);
	func_479(-841.6274f, -1165.006f, 6.0014f, 294.8121f, -819.1121f, -1091.451f, 10.6171f);
	func_478(6);
	func_477(128);
	...
	func_478(18);
	func_477(384);
	func_480(17, 249.3746f, -1008.328f, 28.2705f, 3.848f, -3.0003f, 0.0001f, 4.328f, -1.8003f, 0.0001f, 10);
	func_479(238.4106f, -1127.997f, 28.2691f, 87.3779f, 244.4703f, -1020.02f, 29.1059f);
	func_478(4);
	func_477(256);
	func_480(18, -210.3783f, -1498.204f, 30.4273f, 2.28f, -2.727f, 0.1f, 0.6f, -2.727f, 0.1f, 10);
	func_479(-281.035f, -1533.152f, 26.3419f, 343.7635f, -219.2698f, -1492.04f, 31.2461f);
	func_478(8);
	func_477(384);
	func_480(19, -1220.569f, -773.4271f, 17.1055f, 3.8194f, 4.9089f, 0.0656f, 5.9194f, 4.1889f, -0.0844f, 10);
	func_479(-1212.768f, -876.4072f, 12.1331f, 309.3317f, -1209.417f, -785.0978f, 16.9499f);
	func_478(49);
	func_477(384);
	func_480(20, -1391.763f, -584.7326f, 29.2332f, -2.1715f, -1.7725f, -0.01f, -2.6515f, -3.3925f, -0.11f, 10);
	func_479(-1513.684f, -678.0259f, 27.4965f, 47.765f, -1409.272f, -590.8218f, 30.3243f);
	func_478(4);
	func_477(256);
	func_480(21, -1345.279f, -385.1048f, 35.755f, 1.86f, -0.78f, 0f, 1.2f, -1.62f, 0f, 10);
	func_479(-1325.355f, -453.5642f, 33.4523f, 35.295f, -1346.246f, -397.871f, 36.6207f);
	func_478(10);
	func_477(384);
	func_480(22, -14.6068f, 6505.243f, 30.5105f, -0.5104f, -7.4223f, 0.0239f, 0.8696f, -6.2223f, 0.0239f, 10);
	func_479(90.1534f, 6595.789f, 30.5382f, 47.4841f, -8.4122f, 6513.607f, 31.3368f);
	func_478(63);
	func_477(384);
	func_480(23, 1393.716f, 3592.585f, 33.9297f, 0.8771f, 4.9569f, 0.0859f, -0.9829f, 5.4369f, 0.0859f, 10);
	func_479(1449.097f, 3669.69f, 33.1474f, 201.6678f, 1408.635f, 3599.183f, 34.8791f);
	func_478(63);
	func_477(384);
}
...
void func_479(struct<3> Param0, float fParam3, struct<3> Param4)
{
...
void func_480(int iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, int iParam10)
{
	iLocal_92 = iParam0;
