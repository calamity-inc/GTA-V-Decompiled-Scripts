...
void func_198(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)
{
	switch (*uParam0)
	{
		case 0:
...
int func_213(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
bool func_263(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
void func_273(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_230(iParam0);
...
void func_278(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_279(iParam0);
...
int func_281(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_300(int iParam0, struct<3> Param1, float fParam4)
{
	int iVar0[4];
	int iVar5;
...
int func_301(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_302(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
