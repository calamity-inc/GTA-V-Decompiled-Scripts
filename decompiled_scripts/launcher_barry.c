...
void func_199(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)
{
	switch (*uParam0)
	{
		case 0:
...
bool func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_213(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
void func_217(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
bool func_264(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
void func_279(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_280(iParam0);
...
int func_282(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
void func_286(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (func_216(uParam0->f_41[0]))
				{
					...
					func_274(&(uParam0->f_41[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_289(-2.01f));
...
int func_301(int iParam0, struct<3> Param1, float fParam4)
{
	int iVar0[4];
	int iVar5;
...
int func_302(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_303(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_320(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
