	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1343.f_0))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1347[0 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_1347[0 /*2*/], true);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1347[1 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_1347[1 /*2*/], true);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1347[2 /*2*/]))
		{
			...
			else
			{
				...
				ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_1347[2 /*2*/], true);
			}
		}
	}
}
		...
		else
		{
			...
			switch (uParam0->f_1)
			{
				...
				case 5:
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_1343.f_0) && !ENTITY::IS_ENTITY_DEAD(Local_1343.f_0, false))
					{
						VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_1343.f_0, 2, true);
						VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_1343.f_0, 3, true);
					}
					break;
				}
		}
