...
void func_46(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_43(&(Global_77479.f_555[0 /*21*/]), iParam0))
	{
...
int func_60(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
var func_158(int iParam0, var uParam1)
{
...
void func_231(struct<3> Param0, float fParam3, int iParam4, float fParam5, bool bParam6)
{
	int iVar0;
