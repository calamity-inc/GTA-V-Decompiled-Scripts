...
void __EntryFunction__()
{
	...
	if (func_498())
	{
		...
		{
			case 0:
				func_480(-2907.29f, 3215.91f, 9.866f, 215.2019f, 1, 0);
				break;
...
void func_418(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar65;
...
void func_422(char* sParam0, float fParam1)
{
	sParam0 = sParam0;
	fParam1 = fParam1;
}
...
int func_431(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
float func_432(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
	...
	switch (iLocal_192)
	{
		...
		case 4:
			if (iLocal_193 == 0)
			{
				if (func_490(Local_180.f_0))
				{
					if (func_432(Local_180.f_0, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						TASK::CLEAR_PED_TASKS(Local_180.f_0);
...
bool func_441(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_443(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_241(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
bool func_458(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
int func_493(var uParam0)
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			func_494(&(uParam0->f_28[0]), iVar0[1], -2881.755f, 3188.125f, 10.1136f, 254.1723f, 26);
...
void func_495(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_5(iParam0);
...
int func_515(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
