...
void func_6()
{
	...
	{
		func_7(fLocal_27, fLocal_28, "CELL_506", Global_23133[iLocal_23 /*9*/].f_2.f_2, Global_23133[iLocal_23 /*9*/].f_2.f_1);
	}
	else
	{
		func_7(fLocal_27, fLocal_28, "CELL_503", Global_23133[iLocal_23 /*9*/].f_2.f_2, Global_23133[iLocal_23 /*9*/].f_2.f_1);
	}
	fLocal_27 = (fLocal_27 + 0.07f);
	func_10(255, 255, 255, 205);
	func_7(fLocal_27, fLocal_28, "CELL_505", Global_23133[iLocal_23 /*9*/].f_2.f_3, Global_23133[iLocal_23 /*9*/].f_2.f_4);
	fLocal_27 = fLocal_25;
	func_10(255, 255, 255, 205);
...
void func_15()
{
	...
	while (iVar0 < iLocal_24)
	{
		...
		{
			func_7(fLocal_27, fLocal_28, "CELL_506", Global_23133[iLocal_16[iVar0] /*9*/].f_2.f_2, Global_23133[iLocal_16[iVar0] /*9*/].f_2.f_1);
		}
		else
		{
			func_7(fLocal_27, fLocal_28, "CELL_503", Global_23133[iLocal_16[iVar0] /*9*/].f_2.f_2, Global_23133[iLocal_16[iVar0] /*9*/].f_2.f_1);
		}
		fLocal_27 = (fLocal_27 + 0.07f);
		func_10(255, 255, 255, 205);
		func_7(fLocal_27, fLocal_28, "CELL_505", Global_23133[iLocal_16[iVar0] /*9*/].f_2.f_3, Global_23133[iLocal_16[iVar0] /*9*/].f_2.f_4);
		fLocal_27 = fLocal_25;
		func_10(255, 255, 255, 205);
		if (iVar0 == iLocal_22)
		{
