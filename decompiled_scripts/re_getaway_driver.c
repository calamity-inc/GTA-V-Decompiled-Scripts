...
void func_3(bool bParam0, bool bParam1)
{
	...
	MISC::SET_BIT(&(Global_114370.f_1.f_116), bParam0);
	switch (bParam0)
	{
		case 10:
...
var func_26(int iParam0, var uParam1)
{
...
int func_128(struct<3> Param0, float fParam3, int iParam4)
{
...
int func_144(int iParam0, struct<7> Param1, var uParam8, var uParam9)
{
	if (iParam0 == 1)
	{
...
void func_149(int iParam0, char* sParam1, int iParam2)
{
...
int func_153(char* sParam0, char* sParam1, int iParam2)
{
...
void func_155(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
...
void func_169()
{
	if (!bLocal_276)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_188(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), MISC::GET_RANDOM_INT_IN_RANGE(5, 15), &Local_241, 1, 1077936128, 0);
...
int func_170(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
int func_173(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_186(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_192(int iParam0, bool bParam1)
{
	...
	if (bParam1 <= func_198(iParam0))
	{
		...
		if (func_195(iParam0, bParam1) != 322)
		{
			func_193(func_195(iParam0, bParam1), Local_47.f_0, Local_47.f_1);
		}
...
void func_212(int* iParam0, char* sParam1, int iParam2)
{
	if (BitTest(*iParam0, 30))
	{
		switch (func_150(*iParam0))
...
int func_216(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
void func_248(struct<9> Param0, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_249(int iParam0)
{
	...
	{
		MISC::CLEAR_BIT(&Global_114366, false);
	}
