	...
	switch (iLocal_1035)
	{
		...
		case 6:
			...
			if (bLocal_1146)
			{
				...
				{
					func_57(&iLocal_1340, Global_113386.f_19963.f_5);
				}
				iLocal_1213 = func_531();
				if (Global_94618)
				{
	...
	switch (iLocal_1219)
	{
		case 0:
			if (!iLocal_377)
			{
				...
				Global_113386.f_19963.f_5 = func_52(&iLocal_1340);
...
{
	if (!func_511() && unk_0x00834EAC4A96E010(uParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_524(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
