...
int func_63(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_67(int iParam0)
{
	...
	{
		case 0:
			func_85("SCLUB_HOME_D", uLocal_74[0]);
		...
		case 1:
			HUD::CLEAR_PRINTS();
			func_68("SCLUB_HOME_A", uLocal_74[0], 0);
			iLocal_72 = 5;
			break;
		...
		case 4:
			func_85("SCLUB_HOME_D3", uLocal_74[0]);
			iLocal_72 = 6;
			break;
...
void func_69(char* sParam0, char* sParam1)
{
...
void func_70(char* sParam0, char* sParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam1);
...
void func_86(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
void func_92(bool bParam0)
{
	switch (uLocal_74[0])
	{
		...
		case 7:
			if (bParam0)
			{
				func_85("SCLUB_HOME_GO", uLocal_74[0]);
			}
			else
			{
		...
		case 13:
			if (!CAM::IS_SCREEN_FADING_OUT() && func_201(&iLocal_253) >= 1f)
			{
				...
				if (!func_139(uLocal_74[0], -1))
				{
					if (uLocal_74[0] == 5)
					{
						func_68("SCLUB_PHON_HELP_ALT", uLocal_74[0], 0);
					}
					else
					{
						func_68("SCLUB_PHON_HELP", uLocal_74[0], 0);
					}
				...
				if (iVar2 <= 2)
				{
					...
					func_110(-384575792, iVar3, iVar4, 3, func_114(), func_113(uLocal_74[0]), 60000, 10000, -1, 0, -1, 0, 1);
				}
				func_40();
			}
			break;
...
Vector3 func_197(int iParam0, struct<3> Param1)
{
	var uVar0;
...
void func_200(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_211(var uParam0, struct<3> Param1, bool bParam4, float fParam5)
{
	if (func_213(uParam0))
	{
...
void func_216(bool bParam0)
{
	...
	if (iLocal_76 != 9)
	{
		if (((fVar4 >= (200f / 2f) && func_193()) && !func_269(uLocal_331, 2)) || func_256(iLocal_272[0], 0))
		{
			...
			func_253(0);
			func_85("SCLUB_HOME_R", uLocal_74[0]);
			iLocal_76 = 9;
		}
	}
		...
		case 0:
			...
			if (func_193())
			{
				if (!func_269(uLocal_331, 1))
				{
					...
					func_85("SCLUB_HOME_MEET", uLocal_74[0]);
					func_253(0);
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_272[0], true), 3f, 3f, 3f, false, true, 0) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_338, false) && func_241(iLocal_338, iLocal_272[0], 1) <= 10f))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_338) && (VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_338) < 1 || (!bParam0 && !VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(iLocal_338)))))
				{
					...
					{
						func_68("SCLUB_SMALL_CAR", uLocal_74[0], 0);
			...
			else if (func_71("SCLUB_SMALL_CAR", &Var0))
			{
				HUD::CLEAR_HELP(true);
			}
			break;
...
float func_247(int iParam0, bool bParam1)
{
...
void func_265()
{
	...
	func_110(-384575792, iVar0, 6, 3, func_114(), func_113(uLocal_74[0]), 0, 10000, -1, 0, -1, 0, 1);
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Var0) > 100f)
		{
			...
			if (!func_269(uLocal_331, 128))
			{
				if (!func_34(0))
				{
					func_68("SCLUB_HOME_C_H", uLocal_74[0], 0);
...
void func_279(bool bParam0)
{
	switch (uLocal_74[0])
	{
		...
		case 7:
			if (bParam0)
			{
				func_85("SCLUB_HOME_MEE4", uLocal_74[0]);
			}
			else
			{
				func_85("SCLUB_HOME_MEET", uLocal_74[0]);
		...
		case 8:
			func_85("SCLUB_HOME_LIZ", uLocal_74[0]);
			break;
		
		case 9:
			func_85("SCLUB_HOME_HITCH", uLocal_74[0]);
			break;
	}
}
