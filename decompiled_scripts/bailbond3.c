...
void func_395(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	MISC::SET_BIT(&Global_21152, false);
...
void func_508(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_512(struct<3> Param0, float fParam3)
{
	return func_513(&(Global_107514.f_2890), Param0, fParam3, 0);
}

int func_513(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_515(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_517(iParam0, uVar1[iVar6], 1) && func_516(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_516(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_550(int iParam0, char* sParam1, int iParam2)
{
	char cVar0[16];
...
int func_552(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_57(iParam6))
...
int func_553(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_57(iParam1))
...
Vector3 func_554(struct<5> Param0, var uParam5, var uParam6, var uParam7)
{
	switch (Param0.f_4)
	{
		case 0:
