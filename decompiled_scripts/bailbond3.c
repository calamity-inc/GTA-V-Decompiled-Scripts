...
{
	func_105(&(Global_106934.f_2890), Param0, fParam3);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103950.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103950.f_4, false))
		{
			if (func_188(24) != Global_103950.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_185(ENTITY::GET_ENTITY_COORDS(Global_103950.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_136(Global_103950.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
{
	return func_197(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_254(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_254(iVar10, 14, uVar69[iVar1], -1) };
			func_223(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_246(14);
			if (Global_78128 == 1)
			{
...
void func_256(int iParam0)
{
	...
	func_257(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_263(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_257(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_257(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
void func_446(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_496(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_107(Param1, 0f, 0f, 0f, 0))
...
void func_492(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_496(struct<3> Param0, float fParam3)
{
	return func_497(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_497(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_499(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_501(iParam0, uVar1[iVar6], 1) && func_500(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_500(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_502(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_531()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_664, joaat("player"));
	Var0 = { func_538(Local_103) };
	Var3 = { func_537(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var3);
...
void func_532()
{
	if (func_23(Local_112.f_9))
	{
		...
		func_365(Local_112.f_9);
		func_533(Local_112.f_9, "TARGET_", 0);
		Local_112.f_10 = 0;
		...
		if (func_23(Local_132[0 /*20*/]))
		{
			...
			func_533(Local_132[0 /*20*/], "BACKUP_", 0);
...
int func_534()
{
	...
	if (iLocal_468 > 0)
	{
		...
		{
			if (func_536(&(Local_254[iVar2 /*6*/]), Local_254[iVar2 /*6*/].f_5, Local_254[iVar2 /*6*/].f_1, Local_254[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_470 > 0)
	{
		...
		{
			if (func_535(&(Local_377[iVar2 /*7*/]), Local_377[iVar2 /*7*/].f_5, Local_377[iVar2 /*7*/].f_2, Local_377[iVar2 /*7*/].f_6, Local_377[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_535(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_536(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_538(struct<5> Param0, var uParam5, var uParam6, var uParam7)
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_539()
{
	...
	StringCopy(&Local_665, "", 24);
	Local_385.f_6 = func_550(62);
	Local_385.f_1 = { func_549() };
	Local_385.f_4 = func_548();
	Local_393.f_5 = func_547();
	Local_393.f_1 = { func_546() };
	Local_393.f_4 = func_545();
	Local_399.f_5 = func_544();
	Local_399.f_1 = { func_543() };
	Local_399.f_4 = func_542();
	Local_405.f_5 = func_48();
	Local_405.f_1 = { func_47() };
	Local_405.f_4 = func_46();
	Local_411.f_5 = func_45();
	Local_411.f_1 = { func_541() };
	Local_411.f_4 = func_540();
...
int func_565(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_576())
	{
		...
		{
			iVar33 = func_566(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
void func_568(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_573(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
