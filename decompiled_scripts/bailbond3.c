...
void __EntryFunction__()
{
	...
	if (func_534())
	{
		...
		{
			case 0:
				func_446(&iLocal_707, 509.6743f, 5532.435f, 776.0009f, 153.1431f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_445(Local_692, fLocal_457, 1, 0);
				iLocal_101 = 2;
				func_434(1, 0);
				break;
			
			case 1:
				func_446(&iLocal_707, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_445(Local_677, 254.9762f, 0, 0);
				func_434(4, 0);
				break;
	...
	else if (func_433(0))
	{
		...
		{
			func_431(PLAYER::PLAYER_PED_ID(), Local_692, fLocal_457, 0, 0);
		...
		switch (iLocal_98)
		{
			...
			case 2:
				...
				if (iLocal_100 == 1)
				{
					...
					func_431(Local_112.f_9, Local_686, 153.53f, 0, 0);
					if (!func_71())
					{
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
						func_431(PLAYER::PLAYER_PED_ID(), Local_686 + Vector(0f, -2f, -1f), -27.29f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_444 == 0)
						{
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					func_431(Local_112.f_9, Local_677, 0f, 0, 0);
					if (!func_71())
					{
						func_431(PLAYER::PLAYER_PED_ID(), Local_677, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_444 == 0)
						{
...
void func_27(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_32(PLAYER::PLAYER_ID())) && !func_29(PLAYER::PLAYER_ID(), 0)) && !func_28()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_385.f_0))
				{
					...
					{
						if (func_116(Local_385.f_0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
			...
			else
			{
				if (!iLocal_434)
				{
					...
					if (iLocal_102 == 4)
					{
						if (func_23(Local_385.f_0))
						{
							if (func_116(Local_385.f_0, Local_680, 35f, 1))
							{
				...
				if (iLocal_102 == 4)
				{
					...
					{
						if (!func_64(Local_385.f_0, joaat("script_task_smart_flee_ped")))
						{
...
void func_88()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_91(Global_113648.f_2365.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_90(PLAYER::PLAYER_PED_ID());
			if (func_89(iVar0) && (!func_93(14) || Global_112599))
			{
				if (Global_113648.f_2365.f_539.f_4321 != iVar0 && func_89(Global_113648.f_2365.f_539.f_4321))
				{
...
{
	func_105(&(Global_107196.f_2890), Param0, fParam3);
}
...
{
	if (func_107(Global_78799, 0f, 0f, 0f, 0))
	{
		Global_78799 = { Param0 };
...
bool func_116(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104212.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104212.f_4, false))
		{
			if (func_188(24) != Global_104212.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_185(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_136(Global_104212.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}
...
int func_169(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_107(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_107(Global_113648.f_2365.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_107(Global_113648.f_2365.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
{
	return func_197(Global_104212.f_2890.f_12.f_66, Param0, iParam3);
}
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_78341[1 /*14*/] = { func_254(iVar10, iParam1, iParam2, -1) };
		if (!func_253(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_78341[1 /*14*/] = { func_254(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_78341[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78341[1 /*14*/] = { func_254(iVar10, 14, uVar28[iVar1], -1) };
							func_223(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
							func_246(14);
							if (Global_78339 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_213(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
						}
						func_246(iVar0);
						if (Global_78339 == 1)
						{
			...
			{
				Global_78341[1 /*14*/] = { func_254(iVar10, iVar0, func_212(iParam0, iVar0, -1), -1) };
		...
		if (iParam7 == 1)
		{
			Var55 = { func_254(iVar10, 8, iVar5, -1) };
			if (iVar5 != -99)
			{
			...
			Var55 = { func_254(iVar10, 9, iVar6, -1) };
			if (iVar6 != -99)
			{
			...
			Var55 = { func_254(iVar10, 14, iVar7, -1) };
			if (iVar7 != -99)
			{
			...
			Var55 = { func_254(iVar10, 14, iVar8, -1) };
			if (iVar8 != -99)
			{
			...
			Var55 = { func_254(iVar10, 14, iVar9, -1) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78341[1 /*14*/] = { func_254(iVar10, 14, uVar69[iVar1], -1) };
			func_223(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
			func_246(14);
			if (Global_78339 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_213(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_213(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
		}
		if (Global_78339 == 1)
		{
			iVar2 = 0;
...
int func_204(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_318(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63))
		{
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_318(iParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_239(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[0], Global_113648.f_2365.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_239(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[1], Global_113648.f_2365.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_239(&Var1, -99, -99, Global_113648.f_2365.f_539.f_196[2], Global_113648.f_2365.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_247(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_251(iParam0, iParam1, &iVar2, &bVar1, bParam2, bParam3))
	{
...
void func_248(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2805029[iParam0 /*3*/][func_249(iParam2)];
	if (iVar0 != 0)
	{
...
int func_252(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_254(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_317();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_256(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_263(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_257(&(Global_78341[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_257(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_250(func_260(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_250(func_259(iParam1, uParam0->f_2), Global_78338, 0);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_250(iVar1, Global_78338, 0);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_261(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_263(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_257(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_257(&(Global_78341[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_257(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_257(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_318(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_78341[1 /*14*/] = { func_254(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_78341[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_318(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_318(iParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_78341[2 /*14*/] = { func_254(iVar0, 14, iVar4, -1) };
									if (Global_78341[2 /*14*/].f_12 == iVar3)
									{
										if (func_318(iParam0, 14, iVar4))
										{
											if (!func_209(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_78341[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_78341[2 /*14*/] = { func_254(iVar0, iVar2, iVar1, -1) };
						if (!func_209(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_78341[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar32 <= 8)
		{
			if (!func_318(iParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_213(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_213(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_320()
{
	...
	if (func_23(Local_112.f_9))
	{
		...
		func_387(Local_112.f_9, &iLocal_472, 1126825984, 7);
		func_379(Local_112.f_9, &(Local_112.f_19), 1126825984, 7);
		func_367();
		switch (iLocal_100)
		{
			case 0:
				...
				func_366(&Local_704, Local_701);
				func_365(Local_112.f_9);
				...
				if (func_23(Local_112.f_9))
				{
					...
					{
						Local_112.f_8 = func_364(Local_112.f_9, 1, 0, 5);
					}
				...
				func_363(&(Local_112.f_8), "", "", &iLocal_465, iLocal_466, 0);
				iLocal_100 = 1;
				break;
			...
			case 1:
				...
				{
					func_363(&(Local_112.f_8), "", "", &iLocal_465, iLocal_466, 0);
					func_335(&uLocal_44, Local_112.f_9, 0, 0, 1, 1, 1);
					if (Local_112.f_10 == 22 || Local_112.f_10 == 23)
					{
						if (iLocal_474 == -1)
						{
						...
						if (func_332(Local_112.f_9, Local_680, bVar0, 0, 1, iLocal_476))
						{
						...
						else
						{
							if (!iLocal_417)
							{
								if (!func_124(iLocal_462, 2500))
								{
									if (!func_62())
									{
										if (func_116(Local_112.f_9, Local_680, 30f, 1))
										{
							...
							func_328(Local_112.f_9, Local_680, iLocal_474, 925353388);
						}
					}
					else
					{
				...
				{
					func_331();
					if (!func_116(Local_112.f_9, Local_680, 10f, 1))
					{
						if (!iLocal_437)
						{
							if (!func_326(sLocal_487, 1))
							{
								func_324(&(Local_112.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_465, &iLocal_466, 1, 1);
								iLocal_437 = 1;
							}
						}
						else
						{
							func_363(&(Local_112.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_465, iLocal_466, 1);
						}
					}
					else
					{
...
bool func_323(char* sParam0, int iParam1, char* sParam2)
{
...
void func_324(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
...
void func_328(int iParam0, struct<3> Param1, int iParam4, float fParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_332(int iParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7)
{
	int iVar0;
...
int func_333(int iParam0, struct<3> Param1, float fParam4, float fParam5)
{
	if (func_116(iParam0, Param1, fParam4, 1))
	{
...
int func_334(int iParam0, struct<3> Param1)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
...
void func_336(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
...
int func_345(int iParam0)
{
	if (iParam0 != func_82())
	{
		...
		else if ((Global_1575060 && iParam0 == PLAYER::PLAYER_ID()) && func_346(iParam0, 1, 0))
		{
			return Global_2657589[iParam0 /*466*/].f_321.f_7 != -1;
		}
	}
...
void func_363(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_364(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_366(var* uParam0, struct<3> Param1)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_367()
{
	...
	if (func_23(Local_112.f_9))
	{
		if (iLocal_253 == 0)
		{
			func_378(&(Local_112.f_9), &bLocal_454);
			if (func_377())
			{
				if (iLocal_448 || iLocal_98 == 7)
				{
					if (bLocal_454)
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_112.f_9, func_376(), 0.25f);
						iLocal_253 = 2;
					}
					else
					{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_116(Local_112.f_9, Local_680, 20f, 1))
					{
				...
				case 4:
					if (!func_64(Local_112.f_9, joaat("script_task_turn_ped_to_face_entity")))
					{
				...
				case 6:
					if (!func_116(Local_112.f_9, Local_680, 3.5f, 1))
					{
						if (!func_64(Local_112.f_9, joaat("script_task_go_to_entity")))
						{
							Local_112.f_10 = 5;
						}
						else
					...
					else if (!func_64(Local_112.f_9, joaat("script_task_turn_ped_to_face_entity")))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
					}
					break;
				...
				case 8:
					if (!func_64(Local_112.f_9, joaat("script_task_combat")))
					{
						Local_112.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_112.f_10 = 7;
					}
				...
				case 10:
					if (!PED::IS_PED_RAGDOLL(Local_112.f_9))
					{
						if (!func_64(Local_112.f_9, joaat("script_task_cower")) && !func_64(Local_112.f_9, joaat("script_task_hands_up")))
						{
				...
				case 39:
					if (!func_64(Local_112.f_9, joaat("script_task_perform_sequence")))
					{
				...
				case 13:
					if ((!PED::IS_PED_FALLING(Local_112.f_9) && !PED::IS_PED_RAGDOLL(Local_112.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0))
					{
						if (func_124(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
						{
							...
							TASK::OPEN_SEQUENCE_TASK(&iLocal_484);
							if (!func_116(Local_112.f_9, Local_112.f_13, 0.5f, 1))
							{
				...
				case 18:
					if (!func_116(Local_112.f_9, Local_103, 50f, 1))
					{
					...
					if ((!PED::IS_PED_FALLING(Local_112.f_9) && !PED::IS_PED_RAGDOLL(Local_112.f_9)) && !PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0))
					{
						if (!TASK::IS_PED_GETTING_UP(Local_112.f_9))
						{
							...
							{
								if (!func_116(Local_112.f_9, Local_103, 25f, 1))
								{
									ENTITY::SET_ENTITY_HEALTH(Local_112.f_9, 0, 0);
								}
								else
				...
				case 20:
					...
					else if (PED::GET_PED_PARACHUTE_STATE(Local_112.f_9) == 2)
					{
						if (!iLocal_445)
						{
							if (!func_116(Local_112.f_9, Local_103, 220f, 1))
							{
				...
				case 23:
					if (!func_64(Local_112.f_9, joaat("script_task_smart_flee_ped")) && !PED::IS_PED_FLEEING(Local_112.f_9))
					{
						Local_112.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_112.f_10 = 22;
					}
				...
				case 24:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], false) && func_116(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f, 1)) && func_374(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
				...
				case 25:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_116(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f, 1)) || !func_374(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 22;
					}
					...
					else if (!func_64(Local_112.f_9, joaat("script_task_enter_vehicle")))
					{
						Local_112.f_10 = 24;
					}
				...
				case 27:
					if (!func_64(Local_112.f_9, joaat("script_task_vehicle_mission")))
					{
						Local_112.f_10 = 26;
					}
					break;
				...
				case 29:
					if (!PED::IS_PED_RAGDOLL(Local_112.f_9))
					{
						if (!func_64(Local_112.f_9, joaat("script_task_cower")))
						{
							Local_112.f_10 = 28;
						}
					}
				...
				case 30:
					if (func_372(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_371())
					{
						Local_112.f_10 = 32;
					}
					else if (PED::DOES_GROUP_EXIST(func_370()))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(Local_112.f_9, joaat("script_task_hands_up")) == 1)
						{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_112.f_9, func_370()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_112.f_9, func_370());
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_369())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_112.f_9, iVar1, false))
								{
									...
									if (fVar8 < 1.75f && func_116(Local_112.f_9, Local_680, 8f, 1))
									{
										if (!func_64(Local_112.f_9, joaat("script_task_enter_vehicle")))
										{
											iVar2 = -1;
				...
				case 32:
					if (func_372(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_371())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_112.f_9) && !PED::IS_PED_BEING_STUNNED(Local_112.f_9, 0)) && !PED::IS_PED_BEING_JACKED(Local_112.f_9)) && !func_64(Local_112.f_9, joaat("script_task_leave_any_vehicle")))
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_368(Local_112.f_19, 10) && func_116(Local_112.f_9, Local_680, 50f, 1)) || !func_124(iLocal_481, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, false))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_112.f_9, 0, 0);
								}
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_112.f_9)) && !func_371()) || ENTITY::IS_ENTITY_IN_WATER(Local_112.f_9))
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
								else if (TASK::GET_SCRIPT_TASK_STATUS(Local_112.f_9, joaat("script_task_hands_up")) == 1)
								{
									TASK::UPDATE_TASK_HANDS_UP_DURATION(Local_112.f_9, -1);
								}
								else
								{
									TASK::TASK_HANDS_UP(Local_112.f_9, -1, PLAYER::PLAYER_PED_ID(), -1, 0);
								}
							}
				...
				case 33:
					if (func_372(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_371())
					{
						if (!func_64(Local_112.f_9, joaat("script_task_hands_up")))
						{
							if (!func_64(Local_112.f_9, joaat("script_task_turn_ped_to_face_entity")))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, false))
								{
									if (!func_368(Local_112.f_19, 10) && func_116(Local_112.f_9, Local_680, 50f, 1))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_112.f_9, 0, 0);
										Local_112.f_10 = 32;
									}
							...
							else if (!func_368(Local_112.f_19, 10) && func_116(Local_112.f_9, Local_680, 50f, 1))
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_112.f_9)) || func_371())
								{
									Local_112.f_10 = 32;
								}
							}
				...
				case 34:
					if (func_372(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0))
					{
						Local_112.f_10 = 32;
					}
					else
...
int func_372(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (func_23(iParam0))
	{
		...
		if (func_116(iParam0, Local_680, fParam2, 1))
		{
...
int func_374(float fParam0, float fParam1, float fParam2)
{
...
void func_379(int iParam0, var uParam1, float fParam2, int iParam3)
{
	if (func_432(iParam0))
	{
...
bool func_380(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	...
	uVar0 = func_381(&(Local_56[iVar4 /*4*/]), Var1, iParam1, &(Local_56[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_56[iVar4 /*4*/].f_3) < iParam4);
}

int func_381(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_384(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_385(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
void func_387(int iParam0, int iParam1, float fParam2, int iParam3)
{
	if (func_432(iParam0))
	{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					func_121(&(Local_112.f_8));
					if (!func_116(Local_112.f_9, Local_680, 25f, 1))
					{
					...
					{
						func_393();
						func_391(&Local_385, Local_680, &iLocal_464, 5000, 1101004800);
					}
				}
				else if (func_116(Local_112.f_9, Local_680, 8f, 1))
				{
				...
				else
				{
					...
					if (!HUD::DOES_BLIP_EXIST(Local_112.f_8))
					{
						Local_112.f_8 = func_364(Local_112.f_9, 1, 1, 5);
					}
					if (!iLocal_440)
					{
...
int func_391(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
		...
		if (!func_62())
		{
			...
			if (SYSTEM::VDIST2(Param1, Var0) < (fParam6 * fParam6))
			{
				if (MISC::GET_GAME_TIMER() - *iParam4) > (iParam5 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar168 = "BBCAUD";
					sVar169 = "BBC_loiter";
					func_392(&uVar3, cVar168, sVar169, 4, 0, 0);
					*iParam4 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
...
void func_392(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	MISC::SET_BIT(&Global_20591, false);
	...
	if (func_23(Local_112.f_9))
	{
		...
		else
		{
			...
			else
			{
				...
				else if (Local_112.f_10 == 33 && func_64(Local_112.f_9, joaat("script_task_hands_up")))
				{
					if (func_116(Local_112.f_9, Local_680, 25f, 1))
					{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_455))
						{
							if (iLocal_436)
							{
								iLocal_455 = func_400(Local_677, 5, 1);
							}
						}
						if (!iLocal_419)
						{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_116(PLAYER::PLAYER_PED_ID(), Local_677, 6.5f, 1))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_116(PLAYER::PLAYER_PED_ID(), Local_677, 2.5f, 1))
						{
							iLocal_100 = 2;
						}
					}
				...
				else
				{
					...
					if (func_116(Local_112.f_9, Local_680, 8f, 1))
					{
						if (Local_112.f_10 == 34 || Local_112.f_10 == 35)
						{
							Local_112.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_446)
				{
					bLocal_446 = func_398(Local_680, Local_103, 180f);
				}
				if (func_321(&(Local_112.f_9)))
				{
					iLocal_453 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_446)
					{
						bLocal_446 = func_398(Local_680, Local_103, 0f);
					}
					func_134(4);
				}
				break;
...
int func_400(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					if (!iLocal_417)
					{
						...
						if (!func_62() && func_116(Local_112.f_9, Local_680, 35f, 1))
						{
					...
					else if (Local_112.f_10 == 22 || Local_112.f_10 == 23)
					{
						...
						if (func_332(Local_112.f_9, Local_680, bVar0, 0, 1, 170))
						{
							func_331();
							Local_112.f_17 = MISC::GET_GAME_TIMER();
							func_329(&uLocal_44, 0, 0);
						...
						{
							func_328(Local_112.f_9, Local_680, iLocal_473, 925353388);
						}
					}
					if (!func_62())
					{
...
void func_402(bool bParam0, var uParam1)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_403()
{
	if (func_23(Local_132[0 /*20*/]))
	{
		...
		{
			func_379(Local_132[0 /*20*/], &(Local_132[0 /*20*/].f_17), 160f, 7);
			if (func_372(Local_132[0 /*20*/], Local_132[0 /*20*/].f_17, 1101004800, 0, 1090519040, 1097859072, 0))
			{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(Local_340[0 /*9*/]))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(Local_340[0 /*9*/]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_340[0 /*9*/], Local_132[0 /*20*/], PED::GET_PED_BONE_INDEX(Local_132[0 /*20*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
				}
				else
				{
					...
					if (!func_64(Local_132[0 /*20*/], joaat("script_task_turn_ped_to_face_entity")))
					{
						if (func_432(Local_112.f_9))
						{
		...
		{
			if (!func_64(Local_132[0 /*20*/], joaat("script_task_smart_flee_ped")))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_340[0 /*9*/]))
				{
					if (ENTITY::IS_ENTITY_ATTACHED(Local_340[0 /*9*/]))
...
void func_404()
{
	if (func_23(Local_112.f_9))
	{
		func_387(Local_112.f_9, &iLocal_472, 1126825984, 1);
		func_379(Local_112.f_9, &(Local_112.f_19), 1126825984, 7);
		func_367();
		func_403();
		switch (iLocal_100)
		{
			case 0:
				...
				func_324(&(Local_112.f_8), "", "", &iLocal_465, &iLocal_466, 1, 0);
				iLocal_100 = 1;
				break;
				...
				switch (iLocal_101)
				{
					case 2:
						...
						else if (!iLocal_438)
						{
							...
							{
								func_324(&(Local_112.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_465, &iLocal_466, 1, 1);
								iLocal_438 = 1;
							}
						}
						else
						{
							func_363(&(Local_112.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_465, iLocal_466, 1);
							if (func_116(Local_112.f_9, Local_680, 25f, 1) && func_411(Local_112.f_9, Local_680, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false))
								{
									if (func_410(&(Local_112.f_19)))
									{
										iLocal_101 = 1;
										iLocal_430 = 0;
								...
								else if (func_409(Local_112.f_9, iLocal_472, 0, 1103626240, 1086324736))
								{
									iLocal_101 = 0;
								}
								else if (func_116(Local_112.f_9, Local_680, 5f, 1))
								{
									iLocal_101 = 0;
								}
								else if (func_410(&(Local_112.f_19)))
								{
									if (func_116(Local_112.f_9, Local_680, (25f - 1.5f), 1))
									{
										iLocal_101 = 1;
										iLocal_430 = 0;
										if (Local_112.f_10 != 3 && Local_112.f_10 != 4)
						...
						if (func_372(Local_112.f_9, Local_112.f_19, 20f, 0, 1090519040, 1097859072, 0) || Local_132[0 /*20*/].f_14 != 0)
						{
							iLocal_100 = 2;
						}
						break;
...
void func_408()
{
	if (iLocal_478 < 10)
	{
		if (!iLocal_431)
		{
			if (!func_62())
			{
				if (func_116(Local_112.f_9, Local_680, (25f + 5f), 1))
				{
					iLocal_456 = 0;
					if (HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
...
int func_409(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_432(iParam0))
	{
		if (!func_368(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_116(Local_112.f_9, Local_680, fParam3, 1))
				{
					return 0;
				}
				if (!func_411(iParam0, Local_680, fParam4))
				{
					return 0;
				}
			}
...
int func_411(int iParam0, struct<3> Param1, float fParam4)
{
	struct<3> Var0;
	float fVar3;
	...
	switch (iLocal_100)
	{
		...
		case 1:
			...
			if (func_23(Local_112.f_9))
			{
				...
				if (func_372(Local_112.f_9, Local_112.f_19, 25f, 0, 1090519040, 1097859072, 0) || Local_132[0 /*20*/].f_14 != 0)
				{
					iLocal_101 = 3;
					iLocal_100 = 2;
				}
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_112.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_112.f_9, false) && !PED::IS_PED_INJURED(Local_112.f_9))
		{
			if ((iLocal_98 == 2 || iLocal_98 == 1) || iLocal_98 == 7)
			{
				...
				if (!func_116(Local_112.f_9, Local_680, fVar0, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_112.f_9))
					{
						iLocal_102 = 2;
				...
				{
					if (!func_116(Local_112.f_9, Local_680, 1000f, 1))
					{
						iLocal_102 = 2;
						return;
					}
			...
			{
				if (!func_116(Local_112.f_9, Local_680, 80f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_112.f_9))
					{
						iLocal_102 = 2;
...
int func_422(bool bParam0)
{
	if (func_23(Local_385.f_0))
	{
		...
		if (func_428(Local_385.f_0, 1126825984))
		{
			return 1;
		}
		if (func_423(Local_385.f_0, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_423(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_424(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_426(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_427(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_431(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
...
void func_446(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_495(iParam12, 0);
			while (!func_447(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_447(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_487(iParam0, &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_487(iParam0, &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_448(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_181(iParam1, &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_113648.f_20120[iParam0 /*43*/].f_31 = func_451(*iParam1);
				...
				func_449(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113648.f_20120[iParam0 /*43*/].f_1));
				...
				func_449(Global_113648.f_2365.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113648.f_20120[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_449(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_450(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_450(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_452(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_482(iVar0, bParam1, uParam2) && !func_481(PLAYER::PLAYER_ID())) && !func_462(iParam0))
	{
		return 0;
	}
...
int func_453(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			...
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 11;
			}
		}
	}
	return 0;
...
int func_457(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 26;
			}
		}
	}
	return 0;
...
int func_458(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 13;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 7;
			}
		}
	}
	return 0;
...
int func_460(int iParam0)
{
	...
	if ((!func_461(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger"))
	{
		return 0;
	}
	return 1;
...
int func_463(int iParam0)
{
	...
	if (func_466(PLAYER::PLAYER_ID()) && (!func_460(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_464(int iParam0)
{
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_456(iParam0)) || func_465(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_466(int iParam0)
{
	...
	if (func_481(iParam0) && Global_2657589[iParam0 /*466*/].f_321.f_10 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_479(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			...
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 5;
			}
		}
	}
	return 0;
...
int func_480(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1 && Global_2657589[iParam0 /*466*/].f_321.f_10 != func_82())
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 8;
			}
		}
	}
	return 0;
...
int func_481(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_346(iParam0, 1, 1))
		{
			if (Global_2657589[iParam0 /*466*/].f_321.f_7 != -1)
			{
				return func_454(Global_2657589[iParam0 /*466*/].f_321.f_7) == 9;
			}
		}
	}
	return 0;
...
int func_490(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		iVar0 = func_491(iParam0, 38) + 1;
		iVar1 = func_491(iParam0, 24) + 1;
...
int func_491(int iParam0, int iParam1)
{
	...
	while (iVar0 >= 0 && func_492(iParam0, iParam1, iVar0))
	{
		iVar0 = (iVar0 - 1);
	}
	return iVar0;
...
void func_495(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0]) == func_170(iParam0, iParam1))
				{
...
void func_496(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_169(&(Global_77348.f_555[0 /*21*/]), iVar0))
		{
...
int func_498(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_499(&(Global_113648.f_32751.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_141(Global_113648.f_32751.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
{
	return func_501(&(Global_107196.f_2890), Param0, fParam3, 0);
}
...
{
	return func_511(&(Global_2672505.f_184), iParam0);
}
...
void func_535()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_664, joaat("player"));
	Var0 = { func_542(Local_103) };
	Var3 = { func_541(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var3);
...
void func_536()
{
	if (func_23(Local_112.f_9))
	{
		...
		func_365(Local_112.f_9);
		func_537(Local_112.f_9, "TARGET_", 0);
		Local_112.f_10 = 0;
...
int func_538()
{
	...
	if (iLocal_468 > 0)
	{
		...
		{
			if (func_540(&(Local_254[iVar2 /*6*/]), Local_254[iVar2 /*6*/].f_5, Local_254[iVar2 /*6*/].f_1, Local_254[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_470 > 0)
	{
		...
		{
			if (func_539(&(Local_377[iVar2 /*7*/]), Local_377[iVar2 /*7*/].f_5, Local_377[iVar2 /*7*/].f_2, Local_377[iVar2 /*7*/].f_6, Local_377[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_539(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_540(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_541(struct<5> Param0, var uParam5, var uParam6, var uParam7)
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_542(struct<5> Param0, var uParam5, var uParam6, var uParam7)
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_543()
{
	...
	StringCopy(&Local_665, "", 24);
	Local_385.f_6 = func_554(62);
	Local_385.f_1 = { func_553() };
	Local_385.f_4 = func_552();
	Local_393.f_5 = func_551();
	Local_393.f_1 = { func_550() };
	Local_393.f_4 = func_549();
	Local_399.f_5 = func_548();
	Local_399.f_1 = { func_547() };
	Local_399.f_4 = func_546();
	Local_405.f_5 = func_48();
	Local_405.f_1 = { func_47() };
	Local_405.f_4 = func_46();
	Local_411.f_5 = func_45();
	Local_411.f_1 = { func_545() };
	Local_411.f_4 = func_544();
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_558()) || Global_112695) || Global_32166) || func_564()) || func_95(8, -1)) || func_563()) || func_562()) || func_556()) || func_557()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_558()) || Global_32166) || func_564()) || func_95(8, -1)) || func_556()) || func_563()) || func_562()) || func_557()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_558()) || Global_112695) || Global_32166) || func_564()) || func_95(8, -1)) || func_556()) || func_563()) || func_562()) || func_557()) || Global_113648.f_7690.f_919[iVar0] == 5) || Global_43804 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_558()) || Global_112695) || Global_32166) || func_564()) || func_95(8, -1)) || func_563()) || func_562()) || func_557()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_558() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_557()) || func_561()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_558()) || Global_32166) || func_564()) || func_95(8, -1)) || func_562()) || func_556()) || func_557()) || Global_113648.f_7690.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_558()) || func_562()) || Global_112695) || Global_32166) || func_564()) || Global_44446) || func_95(8, -1)) || func_556()) || func_561()) || func_557()) || Global_113648.f_7690.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_558()) || Global_112695) || Global_32166) || func_564()) || func_95(8, -1)) || func_556()) || func_561()) || func_563()) || func_562()) || func_557())
						{
							return 0;
						}
						break;
...
void func_567(int iParam0)
{
	...
	if (!func_591())
	{
		...
		{
			Global_113648.f_24988.f_4[iParam0]++;
		}
...
int func_569(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_580())
	{
		...
		{
			iVar33 = func_570(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
void func_572(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_576()
{
	...
	iVar0 = func_577(&(Global_100681.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
