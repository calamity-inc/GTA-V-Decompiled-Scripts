...
void func_71(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_78(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_91(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)
{
...
void func_97(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_144(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
...
int func_148()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (func_163(func_54()) < Local_81.f_3)
		{
			if (Local_81.f_1 == 3)
			{
				func_160("SEA_NA_CASH", Local_81.f_3);
			}
			else
			{
				func_160("STREET_NA_CASH", Local_81.f_3);
			}
			iLocal_90 = 1;
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else
			{
				...
				{
					case 1:
						func_160("STREET_PLAY_B", Local_81.f_3);
						break;
					
					case 2:
						func_160("STREET_PLAY_C", Local_81.f_3);
						break;
...
void func_149()
{
	...
	else if (!func_151("STREET_NA_CAR"))
	{
...
bool func_169(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
int func_173(char* sParam0, char* sParam1, int iParam2)
{
...
int func_204(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_208()
{
	...
	if (Local_81.f_0 == 1)
	{
		iLocal_213 = func_209(374.0083f, 279.5919f, 102.3306f, 40f);
