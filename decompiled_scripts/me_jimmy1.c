	...
	else if (func_42(iLocal_392) && func_42(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			if (((PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && func_40(PLAYER::PLAYER_PED_ID(), iLocal_392, 50f, 1)) && func_39(iLocal_392, 1126825984)) && func_30(PLAYER::PLAYER_PED_ID(), iLocal_392, 90f, 1, 250, 7))
			{
				...
				{
					TASK::TASK_HANDS_UP(iLocal_392, -1, 0, -1, 0);
				}
			}
...
void func_60(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_62(Global_113386.f_18533[iVar0], &Var2, &fVar5))
			{
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_296, 1f, 20000, 0.25f, 0, 40000f);
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78130[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78130[1 /*14*/] = { func_142(iVar10, 14, uVar28[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78130[1 /*14*/] = { func_142(iVar10, 14, uVar69[iVar1], -1) };
			func_111(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
			func_134(14);
			if (Global_78128 == 1)
			{
...
void func_144(int iParam0)
{
	...
	func_145(&(Global_78130[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_151(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_145(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78300)
		{
			...
			func_145(&(Global_78130[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 0.25f, 0, 40000f);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_293, 1f, 20000, 0.25f, 0, 40000f);
					TASK::CLOSE_SEQUENCE_TASK(iVar1);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_392, iVar1);
					TASK::CLEAR_SEQUENCE_TASK(&iVar1);
				}
...
void func_222()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			func_235(&uLocal_459);
			if (func_42(iLocal_392) && !PED::IS_PED_GROUP_MEMBER(iLocal_392, func_234()))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_392, func_234());
		...
		case 1:
			if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
			{
				...
				if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) > 15f)
				{
					func_28();
					iLocal_389 = 0;
					iLocal_388 = 4;
...
void func_229()
{
	if ((iLocal_349 < 3 && MISC::GET_GAME_TIMER() > iLocal_343) && (func_232() || func_231()))
	{
...
void func_233()
{
	...
	if ((iLocal_332 < 6 && MISC::GET_GAME_TIMER() > iLocal_324) && func_232())
	{
...
void func_243()
{
	...
	switch (iLocal_389)
	{
		...
		case 1:
			...
			if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
			{
				if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) < 5f)
				{
...
void func_244()
{
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
		if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) > fLocal_386)
		{
...
void func_246()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if (func_337() == 1)
			{
				iLocal_391 = func_336(Local_383, 5, 1);
			...
			{
				iLocal_391 = func_336(Local_380, 5, 1);
			}
...
void func_250()
{
	...
	{
		if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 30f)
		{
			if (!func_27() && func_230())
			{
...
void func_251()
{
	...
	if ((iLocal_342 < 3 && MISC::GET_GAME_TIMER() > iLocal_333) && (func_232() || func_231()))
	{
...
void func_252()
{
	...
	{
		if (((!func_27() && func_230()) && func_232()) && MISC::GET_GAME_TIMER() > iLocal_319)
		{
...
void func_254(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_326(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_324(&(Global_100441.f_3));
				if (iVar10 > -1)
				{
...
int func_336(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if ((((func_49(iLocal_403) && func_42(iLocal_394[0])) && func_42(iLocal_394[1])) && func_42(iLocal_394[2])) && func_42(iLocal_392))
			{
				...
				iLocal_391 = func_392(iLocal_403, 0, 5);
			...
			iLocal_277 = 0;
			iLocal_317 = 1;
			func_390(&uLocal_454, &uLocal_456, &uLocal_453, &fLocal_455);
			fLocal_386 = 800f;
			fLocal_387 = 100f;
			PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		...
		case 1:
			...
			func_384();
			func_382();
			func_381(iLocal_391, iLocal_392, fLocal_386, 1061158912, 0);
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_403))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(iLocal_394[iVar2]))
						{
							...
							else if (((iVar2 == 1 && !func_42(iLocal_394[0])) || ((iVar2 == 2 && !func_42(iLocal_394[0])) && !func_42(iLocal_394[1]))) && !func_351())
							{
								func_349(&uLocal_107, 6, iLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_28();
					...
					{
						if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) > (5f + 1f))
						{
							iLocal_391 = func_245(iLocal_392, 1, 1, 5);
					...
					{
						iLocal_391 = func_392(iLocal_403, 1, 5);
		...
		case 3:
			...
			{
				if (iLocal_438 && func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) > fLocal_387)
				{
				...
				else if (func_227(PLAYER::PLAYER_PED_ID(), iLocal_403, 1) < (5f - 1f))
				{
					iLocal_277 = 1;
					func_342();
				}
...
void func_347(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
...
int func_350(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
void func_354(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_355(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_355(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	uParam0->f_6 = 0;
...
void func_381(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_382()
{
	if (iLocal_312 > 0 && MISC::GET_GAME_TIMER() > iLocal_312)
	{
		if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
		{
			if ((func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) < 50f && !func_27()) && !func_383("MEJ1_02", 0, 0))
			{
				if (iLocal_315)
				{
...
bool func_383(char* sParam0, int iParam1, char* sParam2)
{
...
void func_384()
{
	...
	if ((func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_394[0])) && func_49(iLocal_403))
	{
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			...
			else if (func_226(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403))
			{
		...
		else if (iLocal_316)
		{
			if (!func_27())
			{
				if (func_385(&uLocal_107, 14, "MEJ1AUD", "MEJ1_DAD", 7, 0, 0, 1))
				{
					iLocal_316 = 0;
				}
			}
		}
		else if (((iLocal_310 < 8 && func_226(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f) && !func_27()) && !func_383("MEJ1_02", 0, 0))
		{
...
bool func_385(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED("missfam3"))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_321)
		{
			...
			if (func_389(PLAYER::PLAYER_PED_ID(), Var0, 20f, 1))
			{
				...
				iVar4 *= 1000;
				func_387(iLocal_394[iVar3], iVar4, 0);
...
bool func_389(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_390(var uParam0, var uParam1, var uParam2, float fParam3)
{
	*uParam0 = 0;
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_391(char* sParam0, int iParam1)
{
...
void func_393()
{
	...
	switch (iLocal_389)
	{
		...
		case 2:
			...
			{
				if (func_389(PLAYER::PLAYER_PED_ID(), Local_377, 150f, 1) || func_385(&uLocal_107, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_389 = 3;
				}
			}
...
void func_395()
{
	...
	if (func_49(iLocal_403))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_42(iLocal_394[iVar0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_402))
				{
					...
					if (iVar0 == 0)
					{
						func_349(&uLocal_107, 5, iLocal_394[iVar0], "MEJimmyKidnapper", 1, 1);
					}
				}
			}
			iVar0++;
		...
		if (!func_42(iLocal_392))
		{
			...
			{
				func_396(&iLocal_392, Local_405, fLocal_408, 1);
				...
				func_349(&uLocal_107, 3, iLocal_392, "JIMMY", 1, 1);
...
void func_400(int* iParam0, struct<3> Param1, float fParam4)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_401()
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
			func_349(&uLocal_107, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		func_349(&uLocal_107, 4, 0, "JIMMY", 0, 1);
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
		...
		if (func_66(0) && func_42(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_439(&iVar0, Var1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_397())
		{
			iVar5 = func_438();
			...
			{
				case 0:
					func_420(&iVar6, 1, 1, 1, 1, iLocal_458, 0, 145);
					if (func_389(iVar6, -811.3438f, 187.4367f, 71.47861f, 6f, 1))
					{
...
void func_410(bool bParam0)
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
	{
		...
		else
		{
			Var2 = { func_412() };
			func_411(&Var2, &fVar5);
			func_439(&iVar1, Var2, fVar5, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
...
void func_418()
{
	...
	if (func_42(PLAYER::PLAYER_PED_ID()))
	{
		func_46(1, 0);
		func_398();
		func_439(&iVar0, -2086.913f, 951.6347f, 183.7526f, 75.8f, 1, 1, 0, 1, 1, iLocal_458, 0, 145, 1);
		if (func_49(iVar0))
		{
...
void func_420(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<3> Var0;
	float fVar3;
	...
	if (func_437() && func_421(iParam1, iParam2, iParam3, 1))
	{
		Var0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_439(iParam0, Var0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
void func_439(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_501(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_491(iParam12, 0);
			while (!func_440(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_440(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_442(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_443(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_443(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_445(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
...
int func_501(struct<3> Param0, float fParam3)
{
	return func_502(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_502(var uParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_504(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_505(iParam0, uVar1[iVar6], 1) && func_425(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_289(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
