...
int func_50(int iParam0)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_100403))
		{
			return 0;
		}
...
void func_73(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if ((((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_78(PLAYER::PLAYER_ID())) && !func_75(PLAYER::PLAYER_ID(), 0)) && !func_74()) && !bParam4) && !bParam5) && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
			{
...
void func_151(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_145(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_145(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_206(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_78341[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_101(iParam1)) && Global_78341[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_101(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_254(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_335(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_328(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
{
	func_256(&Global_107196, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_274(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2848280[iParam0 /*3*/][func_137(iParam1)];
...
int func_338(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_403))
				{
					...
					while (iVar2 < 3)
					{
						if (func_42(iLocal_394[iVar2]))
						{
							...
							else if (((iVar2 == 1 && !func_42(iLocal_394[0])) || ((iVar2 == 2 && !func_42(iLocal_394[0])) && !func_42(iLocal_394[1]))) && !func_353())
							{
								func_351(&uLocal_107, 6, iLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_28();
...
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_350(iParam3), false);
}
...
int func_362(char* sParam0)
{
	if (!func_363(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_347(sParam0)) || func_347("CMN_HINT"))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_363(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_370() || func_369(Global_4718592.f_166301)) || func_368())
	{
		...
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
			iVar1 = func_367(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::IS_TURRET_SEAT(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_366(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_364(int iParam0)
{
	if (iParam0 != func_10())
	{
		...
		else if ((Global_1575060 && iParam0 == PLAYER::PLAYER_ID()) && func_365(iParam0, 1, 0))
		{
			return Global_2657589[iParam0 /*466*/].f_321.f_7 != -1;
		}
	}
...
void func_384()
{
	if (iLocal_312 > 0 && MISC::GET_GAME_TIMER() > iLocal_312)
	{
		if (func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_392))
		{
			if ((func_226(PLAYER::PLAYER_PED_ID(), iLocal_392) < 50f && !func_27()) && !func_385("MEJ1_02", 0, 0))
			{
				if (iLocal_315)
				{
...
bool func_385(char* sParam0, int iParam1, char* sParam2)
{
...
void func_386()
{
	...
	if ((func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_394[0])) && func_49(iLocal_403))
	{
		...
		else if (((iLocal_310 < 8 && func_226(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f) && !func_27()) && !func_385("MEJ1_02", 0, 0))
		{
...
void func_388()
{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED("missfam3"))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_321)
		{
			...
			if (func_391(PLAYER::PLAYER_PED_ID(), Var0, 20f, 1))
			{
...
bool func_391(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
void func_395()
{
	...
	switch (iLocal_389)
	{
		...
		case 2:
			...
			{
				if (func_391(PLAYER::PLAYER_PED_ID(), Local_377, 150f, 1) || func_387(&uLocal_107, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_389 = 3;
				}
			}
...
void func_403()
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_42(PLAYER::PLAYER_PED_ID()))
		{
			func_351(&uLocal_107, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		...
		if (func_399())
		{
			...
			switch (iVar5)
			{
				...
				case 3:
					func_404(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
...
void func_404(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_447(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_478(iVar0, bParam1, uParam2) && !func_477(PLAYER::PLAYER_ID())) && !func_458(iParam0))
	{
		return 0;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_448(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_456(int iParam0)
{
	...
	if ((!func_457(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger"))
	{
		return 0;
	}
	return 1;
...
int func_459(int iParam0)
{
	...
	if (func_462(PLAYER::PLAYER_ID()) && (!func_456(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster"))))
	{
		return 0;
	}
...
int func_460(int iParam0)
{
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_452(iParam0)) || func_461(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_216(iParam0, 0, 0)) || func_216(iParam0, 1, 0)) || func_216(iParam0, 2, 0)) || func_263(iParam0) != 145) || func_485(iParam0)) || func_484(iParam0)) || func_448(iParam0)) || func_483(iParam0)) || !func_482(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_484(iParam0))
		{
		}
...
int func_489(int iParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*iParam0, iVar1) != ((*uParam1)[iVar0] - 1))
		{
			...
			if ((*uParam1)[iVar0] > 0)
			{
				...
				else if (func_494(*iParam0, iVar1, ((*uParam1)[iVar0] - 1)))
				{
				}
				else
				{
	...
	if (func_474(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_492(*iParam0, ((*uParam1)[38] - 1)))
	{
...
{
	if (!func_495() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(iParam0, iParam1, iParam2))
	{
		return 1;
	}
	return 0;
...
void func_497(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98012[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0]) == func_265(iParam0, iParam1))
				{
...
int func_510(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_511(iParam0, uVar1[iVar6], 1) && func_427(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			...
			while (iVar6 <= 2)
			{
				...
				{
					MISC::SET_BIT(&(uParam1->f_77), func_268(iVar6));
				}
				iVar6++;
			}
		}
		...
		if (((func_513() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger")))
		{
...
int func_523(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_529(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_525(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
