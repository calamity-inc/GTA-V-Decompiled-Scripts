...
struct<6> func_250(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
void func_253()
{
	...
	if (!iLocal_151 && func_258(3) == -1)
	{
		...
		func_255(iVar0, 3, 8, "EPS_EMAIL5K");
		iLocal_151 = 1;
	}
...
int func_255(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	int iVar0;
	int iVar1;
...
void func_291(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
...
bool func_313(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_324(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_321(68))
				{
					func_318("DI_HLP_STRY", 2, 0, 20000, 10000, 7, 0, 208, 0);
				}
			}
		}
	}
...
void func_318(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
